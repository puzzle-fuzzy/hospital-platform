...
const currentCandidateDocumentPath =
	"docs/release/candidate-341524a-local-build-2026-08-22.md";
...
export const currentBaselineDocuments = Object.freeze([
	...
	{
		path: "docs/release/002acc1b-production-acceptance-2026-08-22.md",
		label: "当前服务端生产切换记录",
	},
	...
	{
		path: "docs/release/miniprogram-real-device-evidence-template-341524a.md",
		label: "当前小程序真机证据模板",
	},
