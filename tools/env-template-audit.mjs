...
export const sharedTemplateKeys = [
	...
	"WECHAT_PAY_BASE_URL",
	"WECHAT_MEDICAL_INSURANCE_READY",
	"WECHAT_MEDICAL_INSURANCE_APP_ID",
	"WECHAT_MEDICAL_INSURANCE_CITY_ID",
	"WECHAT_MEDICAL_INSURANCE_INSTITUTION_NAME",
	"WECHAT_MEDICAL_INSURANCE_INSTITUTION_NO",
	"WECHAT_MEDICAL_INSURANCE_CALLBACK_URL",
	"WECHAT_MEDICAL_INSURANCE_GEO_LOCATION",
	"WECHAT_MEDICAL_INSURANCE_CHANNEL_NO",
	"WECHAT_MEDICAL_INSURANCE_TEST_ENVIRONMENT",
	"MEDICAL_INSURANCE_READY",
	"MBS_FORWARD_RELAY_URL",
	...
	"MBS_SM2_OWN_PUBLIC_B64",
	"MBS_SM2_PLATFORM_PUBLIC_B64",
	"MBS_SM2_USER_ID",
	"MBS_JAVA_SDK_DIR",
	"MBS_ENCRYPT_ENABLE",
	"MBS_SM2_VERIFY_STRICT",
	"MBS_USER_QUERY_BASE_URL",
	"MBS_USER_QUERY_PATH",
	"MBS_INSURANCE_ORG_CODE",
	"MBS_HOSPITAL_ID",
	"MBS_INSUTYPE",
	"MBS_INSU_CODE",
	"ZHONGYANG_PATIENT_DIRECTORY_READY",
	"ZHONGYANG_PATIENT_BINDING_READY",
	"ZHONGYANG_APPOINTMENT_DIRECTORY_READY",
	"ZHONGYANG_APPOINTMENT_RECORDS_READY",
	"ZHONGYANG_APPOINTMENT_WRITES_READY",
	"ZHONGYANG_MEDICAL_RECORDS_READY",
	"ZHONGYANG_INPATIENT_EPISODES_READY",
	...
	"ZHONGYANG_PEIS_HOSPITAL_ID",
	"ZHONGYANG_REPORT_ATTACHMENT_ORIGINS",
	"ZHONGYANG_BASE_URL",
	"ZHONGYANG_AUTHORIZATION_TOKEN",
	"LEGACY_PATIENT_AUTH_BASE_URL",
	"ADMIN_QUERY_TOKEN",
	"ADMIN_LOGS_TOKEN",
	"ADMIN_LOGS_INGEST_TOKEN",
	"YUNHEALTH_REGISTRATION_SETTLEMENT_READY",
	"YUNHEALTH_BASE_URL",
	...
	"YUNHEALTH_PLUGIN_PAYMENT_SOURCE",
	"YUNHEALTH_AUTH_SYS_CODE",
	"YUNHEALTH_PLUGIN_TRADE_TYPE_CODE",
	"PAYMENT_DATA_ENCRYPTION_KEY",
	"MEDICAL_INSURANCE_CREDENTIAL_ENCRYPTION_KEY",
];
...
const productionExactValues = {
	...
	WECHAT_MEDICAL_INSURANCE_READY: "false",
	WECHAT_MEDICAL_INSURANCE_TEST_ENVIRONMENT: "false",
	MEDICAL_INSURANCE_READY: "false",
	ZHONGYANG_PATIENT_DIRECTORY_READY: "false",
	ZHONGYANG_PATIENT_BINDING_READY: "false",
	ZHONGYANG_APPOINTMENT_DIRECTORY_READY: "false",
	ZHONGYANG_APPOINTMENT_RECORDS_READY: "false",
	ZHONGYANG_APPOINTMENT_WRITES_READY: "false",
	ZHONGYANG_MEDICAL_RECORDS_READY: "false",
	ZHONGYANG_INPATIENT_EPISODES_READY: "false",
	ZHONGYANG_OUTPATIENT_PAYMENT_READY: "false",
	ZHONGYANG_REPORT_DIRECTORY_READY: "false",
	ZHONGYANG_REPORT_DETAIL_READY: "false",
	YUNHEALTH_REGISTRATION_SETTLEMENT_READY: "false",
};
...
export function auditEnvironmentTemplates({
	...
	checkKeys(
		production,
		[...sharedTemplateKeys, ...productionOnlyKeys],
		"infra/systemd/api.env.example",
		failures,
	);
	checkExactValues(
