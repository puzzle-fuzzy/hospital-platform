...
export const CLIENT_ERROR_MESSAGES: Readonly<Record<string, string>> =
	Object.freeze({
		...
		"appointment-write-invalid": "预约请求参数不合法，请重新选择后再试",
		"appointment-write-patient-not-found": "当前就诊人暂不可预约，请更换就诊人",
		"appointment-hold-not-found": "预约占位已失效，请重新选择号源",
		"appointment-hold-expired": "号源占位已失效，请重新选择号源",
