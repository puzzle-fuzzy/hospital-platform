...
test("OpenAPI route inventory matches the current public application surface", async () => {
	...
	const expectedPaths = [
		...
		"/api/v1/appointments/registrations/{appointmentId}",
		...
		"/api/v1/payments/medical-insurance/outpatient-records/{recordId}/authorization-context",
		"/api/v1/payments/medical-insurance/outpatient/authorize",
