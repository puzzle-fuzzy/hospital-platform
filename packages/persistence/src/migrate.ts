...
export const PERSISTENCE_MIGRATIONS = [
	...
	{
		id: "0018_medical_insurance_orders",
		file: "../migrations/0018_medical_insurance_orders.sql",
		executionMode: "non_transactional_ddl",
	},
	{
		id: "0019_my_doctors",
		file: "../migrations/0019_my_doctors.sql",
		executionMode: "non_transactional_ddl",
	},
	{
		id: "0020_my_doctor_profile_fields",
		file: "../migrations/0020_my_doctor_profile_fields.sql",
		executionMode: "non_transactional_ddl",
	},
	{
		id: "0021_appointment_snapshot_profile_fields",
		file: "../migrations/0021_appointment_snapshot_profile_fields.sql",
		executionMode: "non_transactional_ddl",
	},
	{
		id: "0022_medical_insurance_query_task_version",
		file: "../migrations/0022_medical_insurance_query_task_version.sql",
		executionMode: "non_transactional_ddl",
	},
	{
		id: "0023_medical_insurance_credentials",
		file: "../migrations/0023_medical_insurance_credentials.sql",
		executionMode: "non_transactional_ddl",
	},
	{
		id: "0024_appointment_writes",
		file: "../migrations/0024_appointment_writes.sql",
		executionMode: "non_transactional_ddl",
	},
	{
		id: "0025_medical_insurance_registration_refs",
		file: "../migrations/0025_medical_insurance_registration_refs.sql",
		executionMode: "non_transactional_ddl",
	},
	{
		id: "0026_medical_insurance_fee_refs",
		file: "../migrations/0026_medical_insurance_fee_refs.sql",
		executionMode: "non_transactional_ddl",
	},
	{
		id: "0027_medical_insurance_authorizations",
		file: "../migrations/0027_medical_insurance_authorizations.sql",
		executionMode: "non_transactional_ddl",
	},
	{
		id: "0028_appointment_provider_ids",
		file: "../migrations/0028_appointment_provider_ids.sql",
		executionMode: "non_transactional_ddl",
	},
	{
		id: "0029_medical_insurance_settlement_context",
		file: "../migrations/0029_medical_insurance_settlement_context.sql",
		executionMode: "non_transactional_ddl",
	},
	{
		id: "0030_medical_insurance_owner_patient_fk",
		file: "../migrations/0030_medical_insurance_owner_patient_fk.sql",
		executionMode: "non_transactional_ddl",
	},
	{
		id: "0031_medical_insurance_settlement_context",
		file: "../migrations/0031_medical_insurance_settlement_context_ciphertext.sql",
		executionMode: "non_transactional_ddl",
	},
	{
		id: "0032_appointment_writes_owner_patient_fk",
...
export const PERSISTENCE_SCHEMA_TABLES = [
	...
	"hp_appointment_holds",
	"hp_appointment_registrations",
	"hp_my_doctors",
...
export const PERSISTENCE_SCHEMA_COLUMNS = [
	...
	{
		table: "hp_medical_insurance_credentials",
		columns: [
			"credential_id",
			"owner_user_id",
			"medical_order_id",
	...
	{
		table: "hp_medical_insurance_authorizations",
		columns: [
			"authorization_id",
			"owner_user_id",
			"medical_order_id",
	...
	{
		table: "hp_appointment_registrations",
		columns: [
			"appointment_id",
			"owner_user_id",
			"patient_id",
...
export const PERSISTENCE_SCHEMA_INDEXES = [
	...
	{
		table: "hp_medical_insurance_orders",
		name: "uq_hp_mi_orders_owner_idempotency",
		columns: ["owner_user_id", "idempotency_key"],
	},
	{
		table: "hp_medical_insurance_orders",
		name: "uq_hp_mi_orders_med_org_ord",
		columns: ["med_org_ord"],
	},
	{
		table: "hp_medical_insurance_orders",
	...
	{
		table: "hp_medical_insurance_query_tasks",
		name: "ix_hp_mi_query_available",
		columns: ["status", "next_attempt_at", "claimed_until"],
	},
	{
		table: "hp_medical_insurance_query_tasks",
		name: "ix_hp_mi_query_order",
	...
	{
		table: "hp_my_doctors",
		name: "uq_hp_my_doctors_owner_doctor",
		columns: ["owner_user_id", "doctor_id"],
	},
	{
		table: "hp_my_doctors",
		name: "ix_hp_my_doctors_owner_created",
...
export const PERSISTENCE_SCHEMA_FOREIGN_KEYS = [
	...
	{
		table: "hp_appointment_holds",
		name: "fk_hp_appointment_holds_owner_patient",
		columns: ["owner_user_id", "patient_id"],
		referencedTable: "hp_patients",
		referencedColumns: ["owner_user_id", "patient_id"],
	},
	{
		table: "hp_appointment_registrations",
		name: "fk_hp_appointment_registrations_owner_patient",
		columns: ["owner_user_id", "patient_id"],
		referencedTable: "hp_patients",
		referencedColumns: ["owner_user_id", "patient_id"],
	},
