...
`ba1dd23e0f40191745a60997939b31b4c47795cd`。SSH 已通过中转内网地址恢复；本次只重启新 API，旧 Python `8001` 继续共存。
...
> 当前候选：服务端已验证 release `0e2a366efcca8da25d7edd4a286781f2d3dfdbec`；小程序运行包来源 `ba1dd23e0f40191745a60997939b31b4c47795cd`（提交 `ba1dd23`）。生产运行层证据见 [`release/0e2a366e-production-acceptance-2026-08-22.md`](release/0e2a366e-production-acceptance-2026-08-22.md)，小程序候选证据见 [`release/candidate-ba1dd23-local-build-2026-08-22.md`](release/candidate-ba1dd23-local-build-2026-08-22.md)。
...
`ba1dd23e0f40191745a60997939b31b4c47795cd`；下方历史 release 不得作为本轮真机或业务证据。
...
3. 使用当前服务端 release `0e2a366efcca8da25d7edd4a286781f2d3dfdbec` 和最新小程序候选 `ba1dd23`（完整构建来源：`ba1dd23e0f40191745a60997939b31b4c47795cd`）重新同步真实账号的患者目录，先运行显式 `patient-sync` smoke，再补做 `his-patient` owner-scoped 记录查询验收；
...
14. 当前公网 runtime 与 P0 日志 bundle 只证明请求进入 `0e2a366e` Bun 进程；基础路由不再重复作为业务完成证据，下一步只补真实 session、owner 映射、Provider 状态和真机页面证据，并始终使用最新本地 `ba1dd23` 小程序候选（完整构建来源：`ba1dd23e0f40191745a60997939b31b4c47795cd`）。
