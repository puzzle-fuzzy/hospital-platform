...
> 当前候选：服务端已验证 release `1e58bb66bf24021d2b680eb5fd03abfec467989a`；小程序运行包来源 `7f09bbb2cf32d4753795bcbc91fe23ec05eeeee6`（提交 `7f09bbb`）。生产运行层证据见 [`release/1e58bb66-production-acceptance-2026-08-22.md`](release/1e58bb66-production-acceptance-2026-08-22.md)，小程序候选证据见 [`release/candidate-7f09bbb-local-build-2026-08-22.md`](release/candidate-7f09bbb-local-build-2026-08-22.md)。
...
3. 使用当前服务端 release `1e58bb66bf24021d2b680eb5fd03abfec467989a` 和最新小程序候选 `7f09bbb`（完整构建来源：`7f09bbb2cf32d4753795bcbc91fe23ec05eeeee6`）重新同步真实账号的患者目录，先运行显式 `patient-sync` smoke，再补做 `his-patient` owner-scoped 记录查询验收；
...
14. 当前公网 runtime 与 P0 日志 bundle 只证明请求进入 `1e58bb66` Bun 进程；基础路由不再重复作为业务完成证据，下一步只补真实 session、owner 映射、Provider 状态和真机页面证据，并始终使用最新本地 `7f09bbb` 小程序候选（完整构建来源：`7f09bbb2cf32d4753795bcbc91fe23ec05eeeee6`）。
