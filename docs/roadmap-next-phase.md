> 当前发布基线更新（2026-08-24 12:23 CST）：线上服务端 release 为 `13f597ea9ee3f65b9be858117826d948339d904a`；当前小程序运行包来源为 `13f597ea9ee3f65b9be858117826d948339d904a`（提交 `13f597e`）。服务端与小程序已完成同源配套切换，生产只读日志已观测到预约查询，真机业务三层证据仍待。
