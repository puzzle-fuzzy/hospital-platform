...
> 当前本地未发布小程序候选（2026-08-24）：`8863f09a62364b77701b255b30a92a8fa166d436`。它继承“我的挂号”卡片、爽约入口和查询状态稳定高度修正，并补齐预约目录科室/排班状态容器，未部署、未替换线上 `13f597e`，也未修改旧 Python、数据库或 Redis；本地构建和运行包验证见 [`release/candidate-8863f09-miniprogram-build-2026-08-24.md`](release/candidate-8863f09-miniprogram-build-2026-08-24.md)。
