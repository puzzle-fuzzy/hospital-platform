...
> 当前本地未发布小程序候选（2026-08-24）：`ae0cc11a4c4147436d8097b15ef00a3e54be8bda`。它继续收口“我的挂号”卡片、爽约入口和查询状态稳定高度，未部署、未替换线上 `13f597e`，也未修改旧 Python、数据库或 Redis；本地构建和运行包验证见 [`release/candidate-ae0cc11-miniprogram-build-2026-08-24.md`](release/candidate-ae0cc11-miniprogram-build-2026-08-24.md)。
