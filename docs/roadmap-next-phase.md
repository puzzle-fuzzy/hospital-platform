...
> 当前本地未发布小程序候选（2026-08-24）：`d32c5ce9653935e6f66bead9526bc8d0fa639b37`。它继续收口“我的挂号”卡片、爽约入口、查询状态稳定高度和报告目录患者加载占位，未部署、未替换线上 `13f597e`，也未修改旧 Python、数据库或 Redis；本地构建和运行包验证见 [`release/candidate-d32c5ce-miniprogram-build-2026-08-24.md`](release/candidate-d32c5ce-miniprogram-build-2026-08-24.md)。
