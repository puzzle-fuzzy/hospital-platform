...
> 当前本地未发布小程序候选（2026-08-24）：`ace48459407586aa2c0f8ef2a9ab7083793dc25f`。它继承“我的挂号”卡片、爽约入口和查询状态稳定高度修正，补齐预约目录科室/排班状态容器，并固定在线/全部标签的请求范围快照，未部署、未替换线上 `13f597e`，也未修改旧 Python、数据库或 Redis；本地构建和运行包验证见 [`release/candidate-ace4845-miniprogram-build-2026-08-24.md`](release/candidate-ace4845-miniprogram-build-2026-08-24.md)。
