...
旧端 64 个页面的逐页落点见
[`../发布/广度优先页面覆盖-2026-08-25.md`](../发布/广度优先页面覆盖-2026-08-25.md)。
本页继续按业务域管理后续 contract，不把 64 个入口都能打开误写为 64 个业务已经完成。
病历、住院、医生关系和问诊的材料入口统一见
[`../提供商接入/临床读模型-2026-08-25.md`](../提供商接入/临床读模型-2026-08-25.md)。
...
| 我的问诊 | `my_consultation.vue` | 首页/“我的”原生 `consultation` 历史摘要页 | 兼容版已迁移，待外部入口 contract | 真实问诊会话来源、患者归属、内容保留、脱敏和外部主体确认 |
| 电子导诊单 | `electronic_consultation.vue` | 首页/“我的”固定 `electronic-consultation` 状态页 | 待 provider contract | 导诊单来源、读取/提交权限、执行状态字段和撤回语义 |
| 我的医生 | `doctor.vue` | 新端已有列表/名片/关注/取消关注/未来排班静态链路；旧库有 21 条历史关系但新端未导入 | 代码已具备，待 Provider/存量/真机实证 | owner/医生目录映射、展示白名单、关系失效规则、旧端 channel=4 与新端 channel=3 对照、历史数据策略 |
...
- 门诊病历：[`medical-record-directory-contract-draft.md`](病案目录契约草案.md)
- 门诊/住院边界：[`medical-record-and-hospital-boundary.md`](病案与医院边界.md)
- 临床只读域并行准入：[`../提供商接入/临床读模型-2026-08-25.md`](../提供商接入/临床读模型-2026-08-25.md)
- 就诊与互联网医院：[`consult-and-internet-hospital-boundary-audit-2026-08-25.md`](问诊与互联网医院边界审计-2026-08-25.md)
- 健康内容与自测：[`health-content-and-self-test-audit-2026-08-24.md`](健康内容与自测审计-2026-08-24.md)
- 知识内容导入：[`health-knowledge-import-runbook.md`](健康知识导入手册.md)
- 旧知识源质量审计：[`health-knowledge-source-audit-2026-08-25.md`](健康知识来源审计-2026-08-25.md)
