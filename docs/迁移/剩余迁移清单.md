...
| 我的医生 | `pagesB/patient/doctor.vue` | 已迁移 | 新端 `pages/my-doctor/my-doctor` 与医生详情页已接通 `/api/v2/my/doctors*`；关注只提交 doctorId，服务端从未来排班确认医生快照，owner 隔离、唯一约束、幂等取消和 7 日排班已落地。 |
