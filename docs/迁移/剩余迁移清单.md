...
| `pages/consult/consult.vue` | 部分迁移 | 新端已具备患者栏、今日/未来/历史标签和稳定查询状态壳；智能陪诊/导诊仍需要独立会话、免责声明、内容审计和外部服务 contract，旧端实时消息、预约历史和叫号队列的拆分见 [`consult-and-internet-hospital-boundary-audit-2026-08-25.md`](问诊与互联网医院边界审计-2026-08-25.md) |
