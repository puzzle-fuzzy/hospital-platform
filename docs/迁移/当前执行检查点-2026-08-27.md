> **历史归档说明（2026-09-01）**：本文件记录 2026-08-27/28 执行窗口，文中的 `1bc5bf6` 运行包不再是当前候选。当前来源以 [`docs/发布/当前基线.json`](../发布/当前基线.json) 和最新全量交接单为准；本文件仅用于追溯，不能作为当前二维码、运行包或真机验收入口。
...
当前待采集清单见
``../release/device-evidence-1bc5bf6-pending.json``。
