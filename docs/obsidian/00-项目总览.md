...
| 入口 | 详细说明 |
| --- | --- |
| [[首页|首页]] | 当前源码统计 32 个视觉点击位；包括患者卡、预约、缴费、报告、挂号记录、服务栅格、底部导航。 |
| [[我的|我的]] | 当前源码统计 15 个视觉点击位；包括资料、家庭成员、挂号记录、爽约记录、意见反馈和底部导航。 |
| [[就诊人选择|就诊人选择]] | 选择已有患者或通过二维码同步患者，是患者范围业务的公共前置。 |
| [[预约目录|预约目录]] | 医院、科室、日期、排班的逐级浏览入口。 |
| [[报告目录|报告目录]] | 当前就诊人名下报告列表及报告详情入口。 |
