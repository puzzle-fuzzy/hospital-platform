...
截至 2026-08-18 22:57 CST，当前线上 API release 为 `c26e696`，并已应用
...
`65657a0bb289fb25f17f14c0b8fec22270f964b2`；当前客户端候选 commit 为 `65657a0`，完整服务端发布边界见
...
当前 release `c26e696` 包含微信身份边界收紧、患者目录空快照和报告/门诊费用空 Provider 患者引用的 fail-closed 保护：已有 HIS 就诊人时，外部目录“完成但为空”会返回
...
[`release/3ab0a6c-production-acceptance-2026-08-17.md`](release/3ab0a6c-production-acceptance-2026-08-17.md)。当前 `c26e696` 的发布和业务边界见
[`release/c26e696-production-acceptance-2026-08-18.md`](release/c26e696-production-acceptance-2026-08-18.md)。
