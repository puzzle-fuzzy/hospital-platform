...
> 当前完整小程序来源校验值：`ba1dd23e0f40191745a60997939b31b4c47795cd`。
...
当前小程序候选为 `ba1dd23`，运行包来源指纹为
`ba1dd23e0f40191745a60997939b31b4c47795cd`。本候选包含运行包 test/spec 文件边界和成功请求低敏 requestId 观测，
并保留认证命令会话代际边界，
...
全量小程序测试为 220 项通过、1634 个断言，当前运行包来源为 `ba1dd23e0f40191745a60997939b31b4c47795cd`，登录后患者初始化边界见
