...
当前线上新 API release 为 `002acc1b`，旧 Python `8001` 保持共存；生产切换和运行边界见
...
当前本地小程序候选为 `ec26f41`，运行包来源指纹为
`ec26f41f8575871972ac63a8074a9beaec1df55b`，尚未上传线上。本候选包含运行包 test/spec 文件边界，
并保留认证命令会话代际边界，
