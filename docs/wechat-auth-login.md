...
当前本地小程序候选为 `6ce1272`，运行包来源指纹为
`6ce12729c3e112a6cb8333c5132c23713d1cb1ec`，尚未上传线上。本候选包含运行包测试文件边界，
并保留认证命令会话代际边界，
...
1338 个断言；当前候选整体已推进到 `6ce1272`，完整运行包来源为
`6ce12729c3e112a6cb8333c5132c23713d1cb1ec`，登录后患者初始化边界见
