...
当前本地小程序候选为 `0dccf54`，运行包来源指纹为
`0dccf545ef65a905b58a27f38e787daea250fa54`，尚未上传线上。本候选包含认证命令会话代际边界，
...
1215 个断言；当前候选整体已推进到 `0dccf54`，完整运行包来源为
`0dccf545ef65a905b58a27f38e787daea250fa54`，登录后患者初始化边界见
