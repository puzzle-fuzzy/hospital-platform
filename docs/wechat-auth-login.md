...
当前本地小程序候选为 `3a89312`，运行包来源指纹为
`3a89312cd982ee2fc490b75515cdb6c7d58d513e`，尚未上传线上。本候选包含运行包测试文件边界，
并保留认证命令会话代际边界，
...
1215 个断言；当前候选整体已推进到 `3a89312`，完整运行包来源为
`3a89312cd982ee2fc490b75515cdb6c7d58d513e`，登录后患者初始化边界见
