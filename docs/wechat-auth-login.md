...
当前本地小程序候选为 `b629380`，运行包来源指纹为
`b629380162aa8275418b643e10a16e96a65d0b36`，尚未上传线上。本候选包含运行包 test/spec 文件边界，
并保留认证命令会话代际边界，
...
全量小程序测试为 174 项通过、1378 个断言，整体已推进到 `b629380`，完整运行包来源为
`b629380162aa8275418b643e10a16e96a65d0b36`，登录后患者初始化边界见
