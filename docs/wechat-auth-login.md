...
当前本地小程序候选为 `474b044`，运行包来源指纹为
`474b0444736599c848a4cef9f47fd930884e401d`，尚未上传线上。本候选包含认证命令会话代际边界，
...
1215 个断言；当前候选整体已推进到 `474b044`，完整运行包来源为
`474b0444736599c848a4cef9f47fd930884e401d`，登录后患者初始化边界见
