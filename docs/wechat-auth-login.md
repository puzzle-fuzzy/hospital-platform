...
当前本地小程序候选为 `8f80b3e`，运行包来源指纹为
`8f80b3e30385fe3655f871673d8616cd2d31faaa`，尚未上传线上。本候选包含运行包测试文件边界，
并保留认证命令会话代际边界，
...
1215 个断言；当前候选整体已推进到 `8f80b3e`，完整运行包来源为
`8f80b3e30385fe3655f871673d8616cd2d31faaa`，登录后患者初始化边界见
