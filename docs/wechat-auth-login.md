...
当前线上新 API release 为 `c8eef370`，旧 Python `8001` 保持共存；生产切换和运行边界见
...
当前本地小程序候选为 `f488c6f3`，运行包来源指纹为
`f488c6f3270514af10b19fdf3c45a47519e1736b`，尚未上传线上。本候选包含运行包 test/spec 文件边界，
并保留认证命令会话代际边界，
