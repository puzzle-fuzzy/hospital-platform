...
当前本地小程序候选为 `f66514d`，运行包来源指纹为
`f66514de81c051cb8ade1477f758700b2837b9b7`，尚未上传线上。本候选包含运行包 test/spec 文件边界，
并保留认证命令会话代际边界，
...
全量小程序测试为 176 项通过、1398 个断言，整体已推进到 `f66514d`，完整运行包来源为
`f66514de81c051cb8ade1477f758700b2837b9b7`，登录后患者初始化边界见
