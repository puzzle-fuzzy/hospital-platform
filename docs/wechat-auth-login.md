...
当前本地小程序候选为 `c86a788`，运行包来源指纹为
`c86a788c01760fd5a74ac8c2769871025297a4fc`，尚未上传线上。本候选包含运行包 test/spec 文件边界，
并保留认证命令会话代际边界，
...
全量小程序测试为 174 项通过、1378 个断言，整体已推进到 `c86a788`，完整运行包来源为
`c86a788c01760fd5a74ac8c2769871025297a4fc`，登录后患者初始化边界见
