...
当前本地小程序候选为 `6252ea4`，运行包来源指纹为
`6252ea41a40a22a6264276b6590750e4bf0ef5bc`，尚未上传线上。本候选包含运行包测试文件边界，
并保留认证命令会话代际边界，
...
1338 个断言；当前候选整体已推进到 `6252ea4`，完整运行包来源为
`6252ea41a40a22a6264276b6590750e4bf0ef5bc`，登录后患者初始化边界见
