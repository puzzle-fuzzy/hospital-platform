...
本地尚未发布的页面候选为 `d32c5ce9653935e6f66bead9526bc8d0fa639b37`；它只用于本地回归和后续真机验收准备，不能与线上 `13f597e` 的运行包证据混写。构建记录见 [`release/candidate-d32c5ce-miniprogram-build-2026-08-24.md`](release/candidate-d32c5ce-miniprogram-build-2026-08-24.md)。
