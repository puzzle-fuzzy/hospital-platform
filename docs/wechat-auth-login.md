...
当前本地小程序候选为 `02c18af`，运行包来源指纹为
`02c18af2e658507a0fa5182368235cf62cd348c7`，尚未上传线上。本候选包含运行包测试文件边界，
并保留认证命令会话代际边界，
...
1338 个断言；当前候选整体已推进到 `02c18af`，完整运行包来源为
`02c18af2e658507a0fa5182368235cf62cd348c7`，登录后患者初始化边界见
