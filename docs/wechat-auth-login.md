...
当前本地小程序候选为 `1d161b7`，运行包来源指纹为
`1d161b701384ad8073ed907fe14f611ab3166fcd`，尚未上传线上。本候选包含运行包测试文件边界，
并保留认证命令会话代际边界，
...
1338 个断言；当前候选整体已推进到 `1d161b7`，完整运行包来源为
`1d161b701384ad8073ed907fe14f611ab3166fcd`，登录后患者初始化边界见
