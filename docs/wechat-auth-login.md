...
当前本地小程序候选为 `ce8d68b`，运行包来源指纹为
`ce8d68b15fc0c6a813fbf7a95d36610167874b8e`，尚未上传线上。本候选包含认证命令会话代际边界，
...
1215 个断言；当前候选整体已推进到 `ce8d68b`，完整运行包来源为
`ce8d68b15fc0c6a813fbf7a95d36610167874b8e`，登录后患者初始化边界见
