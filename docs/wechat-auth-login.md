...
当前本地小程序候选为 `d4d65b7`，运行包来源指纹为
`d4d65b735da8630e9b6795d9e105192713297474`，尚未上传线上。本候选包含运行包 test/spec 文件边界，
并保留认证命令会话代际边界，
...
全量小程序测试为 177 项通过、1403 个断言，整体已推进到 `d4d65b7`，完整运行包来源为
`d4d65b735da8630e9b6795d9e105192713297474`，登录后患者初始化边界见
