...
当前本地小程序候选为 `ac238c6`，运行包来源指纹为
`ac238c6156f085fdb56f5806fefac3613e5f85be`，尚未上传线上。本候选包含运行包测试文件边界，
并保留认证命令会话代际边界，
...
1335 个断言；当前候选整体已推进到 `ac238c6`，完整运行包来源为
`ac238c6156f085fdb56f5806fefac3613e5f85be`，登录后患者初始化边界见
