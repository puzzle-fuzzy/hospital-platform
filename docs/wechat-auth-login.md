...
本地尚未发布的页面候选代码为 `ff931d7cbbc50e18649a38e14cd93f389d7487e3`；它只用于本地回归和后续真机验收准备，不能与线上 `13f597e` 的运行包证据混写。构建记录见 [`release/candidate-ff931d7c-miniprogram-build-2026-08-24.md`](release/candidate-ff931d7c-miniprogram-build-2026-08-24.md)。
