...
> 当前事实（2026-08-28）：线上服务端 release 仍为 `5738a71e0bcddaa8849106754baf5b296427bed7`；线上历史小程序运行包来源仍为 `13f597ea9ee3f65b9be858117826d948339d904a`，当前本地 live/pending 运行相关源码均为 `ce1c2179b57fe2783066b51f8621220224982928`，共 38 个页面、4 个原生 Tab。当前候选已通过小程序类型检查、356 项小程序测试和运行包校验，但尚未部署微信线上版本，真实微信业务三层证据仍待；候选检查点见 [`migration/current-execution-checkpoint-2026-08-28.md`](migration/current-execution-checkpoint-2026-08-28.md)。
