...
> `1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`，已通过 146 项定向回归和 pending 运行包校验；
...
当前本地 live 运行输入为 `1bc5bf6`，完整指纹为 `1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`；旧候选指纹记录如下：
...
全量小程序测试为 `356 pass / 0 fail / 3826 expect()`，当前 live 运行输入为 `1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`，登录后患者初始化边界见
