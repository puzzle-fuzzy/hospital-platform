...
> 当前事实（2026-08-28）：线上服务端 release 仍为 `5738a71e0bcddaa8849106754baf5b296427bed7`；线上历史小程序运行包来源仍为 `13f597ea9ee3f65b9be858117826d948339d904a`，当前本地 live/pending 运行相关源码均为 `1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`，共 38 个页面、4 个原生 Tab。当前候选已通过小程序类型检查、356 项小程序测试和运行包校验，但尚未部署微信线上版本，真实微信业务三层证据仍待；候选检查点见 [`migration/current-execution-checkpoint-2026-08-28.md`](migration/current-execution-checkpoint-2026-08-28.md)。
...
当前本地 live 运行输入为 `3f8274e`，完整指纹为 `3f8274ec5435779c0603ce8475a4f4e86d292cbd`；旧候选指纹记录如下：
