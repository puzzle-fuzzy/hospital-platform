...
当前本地小程序候选为 `acf5a85`，运行包来源指纹为
`acf5a8596e70e1fb2b8d220a0b41eb69418ae086`，尚未上传线上。本候选包含运行包测试文件边界，
并保留认证命令会话代际边界，
...
170 项小程序测试通过、1364 个断言；当前候选整体已推进到 `acf5a85`，完整运行包来源为
`acf5a8596e70e1fb2b8d220a0b41eb69418ae086`，登录后患者初始化边界见
