...
当前本地小程序候选为 `f085d06`，运行包来源指纹为
`f085d06d8e4b9695274f93b5a6b56f2af3faac91`，尚未上传线上。本候选包含运行包测试文件边界，
并保留认证命令会话代际边界，
...
171 项小程序测试通过、1370 个断言；当前候选整体已推进到 `f085d06`，完整运行包来源为
`f085d06d8e4b9695274f93b5a6b56f2af3faac91`，登录后患者初始化边界见
