...
当前本地小程序候选为 `3a6bf3e`，运行包来源指纹为
`3a6bf3ea3d2b8944e05ffcad254a37afdbca2aab`，尚未上传线上。本候选包含运行包测试文件边界，
并保留认证命令会话代际边界，
...
1338 个断言；当前候选整体已推进到 `3a6bf3e`，完整运行包来源为
`3a6bf3ea3d2b8944e05ffcad254a37afdbca2aab`，登录后患者初始化边界见
