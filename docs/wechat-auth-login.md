...
当前线上新 API release 为 `968af78`，旧 Python `8001` 保持共存；生产切换和运行边界见
...
当前本地小程序候选为 `48ba22f`，运行包来源指纹为
`48ba22f16cb0f1d1098895772e660a3ed96761bb`，尚未上传线上。本候选包含认证命令会话代际边界，
...
1215 个断言；当前候选整体已推进到 `48ba22f`，完整运行包来源为
`48ba22f16cb0f1d1098895772e660a3ed96761bb`，登录后患者初始化边界见
