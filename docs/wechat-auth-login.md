...
当前本地小程序候选为 `03d9d25`，运行包来源指纹为
`03d9d25d80d5a5d872a9137c7df0aa19a91ba38f`，尚未上传线上。本候选包含运行包 test/spec 文件边界，
并保留认证命令会话代际边界，
...
全量小程序测试为 186 项通过、1461 个断言，整体已推进到 `03d9d25`，完整运行包来源为
`03d9d25d80d5a5d872a9137c7df0aa19a91ba38f`，登录后患者初始化边界见
