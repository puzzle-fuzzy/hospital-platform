...
当前本地小程序候选为 `39e2caa`，运行包来源指纹为
`39e2caac27ec4bf569f5debc8edb47947bc398d2`，尚未上传线上。本候选包含运行包测试文件边界，
并保留认证命令会话代际边界，
...
1338 个断言；当前候选整体已推进到 `39e2caa`，完整运行包来源为
`39e2caac27ec4bf569f5debc8edb47947bc398d2`，登录后患者初始化边界见
