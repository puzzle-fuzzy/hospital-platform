...
当前线上 release 以 ``e5d941ae-production-acceptance-2026-08-26.md``
...
这部分规则与 [`../迁移/患者上下文读契约.md`](../迁移/患者上下文读契约.md)
和 [`../业务正确性.md`](../业务正确性.md) 保持一致。
...
``miniprogram-readonly-acceptance-candidate-2026-08-18.md``。
