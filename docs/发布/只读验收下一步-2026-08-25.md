...
如需执行服务端只读 smoke，必须使用 [`provider-directory-acceptance.md`](Provider目录验收.md) 中的受控环境变量和 bundle；
...
> 不能据此判断服务停止。当前运行层复核见 ``current-runtime-coexistence-readonly-2026-08-25-1452.md``。
