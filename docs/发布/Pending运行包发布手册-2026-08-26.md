...
> 当前配套小程序运行包（2026-08-28）：本地 live `dist` 的 sourceRevision 为 `ce1c2179b57fe2783066b51f8621220224982928`（`ce1c217`），共 38 个页面；当前没有运行中的微信开发者工具或真机会话，九个真机证据域仍为 `pending`。本文下方历史候选仅作追溯。
...
| 项目 | 当前事实 |
| --- | --- |
| live 运行包来源 | `ce1c2179b57fe2783066b51f8621220224982928`，38 个页面；`runtime:verify` 通过 |
...
发布只证明运行包切换，不证明业务完成。当前应从已切换的 `ce1c217` live `dist`
重新生成二维码，再按以下顺序逐域采证：
