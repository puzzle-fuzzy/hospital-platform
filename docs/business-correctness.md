...
> **当前本地源码候选纠正（2026-08-25）**：健康百科迁移后最新候选为 `99c7e8fd76bd7b38de50d1c5cfdbc7002cba4a15`，原生页面 20 个，小程序回归为 `259 pass / 0 fail / 2445 expect()`；运行包仍在 pending，线上配套小程序仍为 `13f597e`。本文下方 `485c0892` 等候选只作历史追溯。
