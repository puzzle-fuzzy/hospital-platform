...
> **当前本地源码候选（2026-08-26）**：当前业务代码候选与 live 运行输入均为 `731c95718d26bcf2826987b72f79295413b203d7`，原生页面 40 个，当前工作树复跑为 `312 pass / 0 fail / 3548 expect()`；运行包已完成本地原子发布，线上配套小程序仍是历史 `13f597e`。本文下方旧候选只作历史追溯。

> 当前生产配套基线（2026-08-26）：服务端 release 为 `8eb51b5ffe85b0b8f8a032783f893117d3df549d`，线上配套小程序运行包仍为历史 `13f597ea`；当前 live 运行输入与业务候选均为 `731c9571`，当前 live `dist` 已完成原子发布。线上上传、真机证据和业务完成仍是独立门禁。
...
> `13f597ea9ee3f65b9be858117826d948339d904a`（历史 `13f597e`）；当前本地 live 运行输入为 `731c9571`。本文中的历史候选只用于追溯，
