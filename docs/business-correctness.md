...
> **当前本地源码候选（2026-08-26）**：当前业务代码候选与 pending 运行输入均为 `adf536bff5b01a2cd27c664f05b7feae2be6ec3f`，原生页面 40 个，当前工作树复跑为 `312 pass / 0 fail / 3548 expect()`；运行包仍在 pending，线上配套小程序仍是历史 `13f597e`。本文下方旧候选只作历史追溯。
