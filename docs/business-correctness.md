...
> 当前生产配套基线（2026-08-27）：服务端 release 为 `e5d941aef3a8b0d1df24a518bea03f36f2ee505d`，线上配套小程序运行包仍为历史 `13f597ea`；当前本地 live 运行输入为 `0be59f96`。线上上传、真机证据和业务完成仍是独立门禁。
...
> `e5d941aef3a8b0d1df24a518bea03f36f2ee505d`（`e5d941ae`），线上小程序运行包来源为
