...
| [`release/current-public-readonly-smoke-2026-08-20.md`](release/current-public-readonly-smoke-2026-08-20.md) | 2026-08-20 公网 live/ready/ping 与未授权 `/me`、`/patients` 只读复核；不替代本地候选部署、微信、Provider 或真机验收 |
...
| [`release/miniprogram-device-session-lan-2026-08-19.md`](release/miniprogram-device-session-lan-2026-08-19.md) | 当前 `474b044` 候选的局域网二维码重试、传输层错误边界和扫码后的固定验收顺序 |
...
| [`release/miniprogram-readonly-acceptance-candidate-2026-08-18.md`](release/miniprogram-readonly-acceptance-candidate-2026-08-18.md) | 历史 `b451cc6` 小程序候选的只读验收组合和停止条件；当前候选请改读 [`candidate-474b044-local-build-2026-08-19.md`](release/candidate-474b044-local-build-2026-08-19.md) |
| [`release/miniprogram-readonly-business-acceptance-2026-08-19.md`](release/miniprogram-readonly-business-acceptance-2026-08-19.md) | 历史 `c26e696` 窗口的模拟器与服务端日志观察；不替代当前 `398be8e` + `474b044` 真机/Provider 验收 |
