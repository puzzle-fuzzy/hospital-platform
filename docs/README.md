...
`3a89312cd982ee2fc490b75515cdb6c7d58d513e`（提交 `3a89312`，尚未上传线上）、新 API `10.0.0.3:18081`、旧 Python `8001`。
...
| [`roadmap-next-phase.md`](roadmap-next-phase.md) | 业务、工程、运行和验收的下一阶段统一路线图；当前线上服务端 release 以 `0e360d3`、最新本地小程序候选来源以 `3a89312cd982ee2fc490b75515cdb6c7d58d513e` 为准 |
...
| [`release/candidate-3a89312-local-build-2026-08-20.md`](release/candidate-3a89312-local-build-2026-08-20.md) | 当前小程序本地构建来源、测试脚本隔离、运行包门禁和真机前置条件；小程序尚未上传线上，服务端基线为 `0e360d3` |
| [`release/miniprogram-device-qr-session-2026-08-20-2004.md`](release/miniprogram-device-qr-session-2026-08-20-2004.md) | 当前 `3a89312` 候选重新生成的 iOS 真机二维码会话；仅记录运行层和扫码前状态，不代表登录或业务验收成功 |
| [`release/candidate-767ed9c-local-build-2026-08-20.md`](release/candidate-767ed9c-local-build-2026-08-20.md) | 历史 `767ed9c` 小程序候选构建记录；不能替代当前 `3a89312` 候选 |
| [`release/candidate-d772f09-local-build-2026-08-20.md`](release/candidate-d772f09-local-build-2026-08-20.md) | 历史 `d772f09` 小程序候选构建记录；不能替代当前 `3a89312` 候选 |
| [`release/candidate-0dccf54-local-build-2026-08-20.md`](release/candidate-0dccf54-local-build-2026-08-20.md) | 历史 `0dccf54` 小程序候选构建记录；不能替代当前 `3a89312` 候选 |
...
| [`release/miniprogram-current-candidate-simulator-observation-2026-08-19.md`](release/miniprogram-current-candidate-simulator-observation-2026-08-19.md) | 历史模拟器只读页面观察（当时候选为 `b451cc6`）；当前验收候选请改读 `3a89312`，本记录不替代真机、Provider 或服务端日志证据 |
| [`release/miniprogram-real-device-acceptance-checklist-2026-08-19.md`](release/miniprogram-real-device-acceptance-checklist-2026-08-19.md) | 当前 `3a89312` 候选的扫码前门禁、真机操作顺序和三层证据清单 |
...
| [`release/miniprogram-device-session-lan-2026-08-19.md`](release/miniprogram-device-session-lan-2026-08-19.md) | 历史 `474b044` 候选的局域网二维码重试、传输层错误边界；新的扫码必须使用当前 `3a89312` 候选 |
...
| [`release/miniprogram-readonly-acceptance-candidate-2026-08-18.md`](release/miniprogram-readonly-acceptance-candidate-2026-08-18.md) | 历史 `b451cc6` 小程序候选的只读验收组合和停止条件；当前候选请改读 [`candidate-3a89312-local-build-2026-08-20.md`](release/candidate-3a89312-local-build-2026-08-20.md) |
| [`release/miniprogram-readonly-business-acceptance-2026-08-19.md`](release/miniprogram-readonly-business-acceptance-2026-08-19.md) | 历史 `c26e696` 窗口的模拟器与服务端日志观察；不替代当前 `0e360d3` + `3a89312` 真机/Provider 验收 |
