...
`39ad2c5937af2fdc735ffb223c0648464af3a48c`（提交 `39ad2c5`，尚未上传线上）、新 API `10.0.0.3:18081`、旧 Python `8001`。
...
| [`roadmap-next-phase.md`](roadmap-next-phase.md) | 业务、工程、运行和验收的下一阶段统一路线图；当前线上服务端 release 以 `5a31427`、最新本地小程序候选来源以 `39ad2c5937af2fdc735ffb223c0648464af3a48c` 为准 |
...
| [`release/candidate-39ad2c5-local-build-2026-08-21.md`](release/candidate-39ad2c5-local-build-2026-08-21.md) | 当前小程序本地构建来源、Unicode 资料 contract 修正、运行包测试文件隔离和真机前置条件；小程序尚未上传线上，服务端基线为 `5a31427` |
...
| [`release/miniprogram-real-device-evidence-template-39ad2c5.md`](release/miniprogram-real-device-evidence-template-39ad2c5.md) | 当前 `39ad2c5` 候选的真机页面、客户端 trace 和服务端低敏日志记录模板；空白模板不代表验收通过 |
