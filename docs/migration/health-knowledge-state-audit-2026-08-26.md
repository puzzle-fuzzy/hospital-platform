...
> **当前候选事实（2026-08-27）**：线上服务端 release 为 `1107a78a47ac2fbe0557958251d66da9effc66de`；本文的状态判断已绑定本地 live `6f47c64` 运行包；该运行包来源为
> `6f47c6408fe5b62025bd74fa66893f306eb7b9aa`，运行包校验和 `runtime:verify` 均通过，包含 40 个页面。历史候选的运行包数字不作为当前真机证据。
