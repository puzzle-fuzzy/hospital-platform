...
> **当前候选事实（2026-08-27）**：线上服务端 release 为 `1bc8b0a85f21cb58205a99ce4de0de6afe9bf240`；本文的状态判断已绑定本地 live `90d8910b` 运行包；该运行包来源为
> `90d8910bdc54d48dde66c4ff03a7434c182ebd92`，运行包校验和 `runtime:verify` 均通过，包含 40 个页面。历史候选的运行包数字不作为当前真机证据。
