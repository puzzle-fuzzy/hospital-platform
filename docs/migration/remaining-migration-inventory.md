...
## 当前 release 基线（2026-08-18 14:26 CST）
...
- 下一步固定使用服务端 `38bc553` + 小程序客户端 `d6b3d66` 的验收组合；当前 `dist/` 已强制重建并验证 14 个页面脚本存在，
  `dist/build-info.json` 已记录完整来源提交号 `d6b3d661e5864fffdccac14d72a58d4edaecc81d`。当前 `main` 的验收 harness
