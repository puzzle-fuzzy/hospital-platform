...
> **最新候选纠正（2026-08-26）**：当前小程序 pending 运行输入为 `5493659ead8a70fcc9a2ad6ad4619a155b8a362a`（提交 `5493659e`），20 个页面，`291 pass / 0 fail / 3233 expect()`。本轮修正健康百科分类加载状态；健康内容仍因审核 bundle 缺失保持 fail-closed。二维码、就诊页等前序候选只作历史交接，不能生成当前真机证据。
