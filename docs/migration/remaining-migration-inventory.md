...
> **最新候选纠正（2026-08-26）**：当前小程序 pending 运行输入为 `0d28b7241f40de95f4049d7d2a18e07f6f162268`（提交 `0d28b72`），20 个页面，`288 pass / 0 fail / 3225 expect()`。本轮修复就诊页跨零点业务日快照，并新增独立审计记录；`a6319d7` 及更早候选只作历史交接，不能生成当前二维码或真机证据。
