...
> 当前发布基线补充（2026-08-21）：服务端为 `5a31427`；小程序候选为 `968a587`，完整运行包来源为
> `968a587158289da6a482b3614907bde0a5ad9581`，尚未上传线上。
>
...
> 当前配套小程序候选构建来源为 `968a587158289da6a482b3614907bde0a5ad9581`（提交 `968a587`），尚未上传线上；用户已有的开发者工具配置修改不属于本次候选代码。
...
- 当前小程序运行输入来源为 `968a587`，本轮完整构建已生成并通过 `runtime:verify`；`dist/build-info.json` 的来源指纹为
  `968a587158289da6a482b3614907bde0a5ad9581`，注册页面和生成脚本均为 14 个；本轮患者上下文
