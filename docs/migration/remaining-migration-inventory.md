...
> 当前配套小程序候选构建来源为 `b629380162aa8275418b643e10a16e96a65d0b36`（提交 `b629380`），尚未上传线上；用户已有的开发者工具配置修改不属于本次候选代码。
...
> `b629380162aa8275418b643e10a16e96a65d0b36`。代码、架构、迁移清单、Provider intake、文档、类型、测试均通过；小程序构建门禁随后以当前候选重新执行，
