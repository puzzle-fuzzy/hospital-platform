...
> 当前服务端 release 为 `b44421cd321ff9ff23eeb49b12641d1772d2bdc1`（提交 `b44421cd`）；线上历史小程序运行包来源为 `13f597ea9ee3f65b9be858117826d948339d904a`（提交 `13f597e`）。本地最新业务源码和 live 运行输入均为 `413cbea`，完整来源为 `413cbea13f022831f63e9c750661eeabbffc68d5`，已完成运行包校验和原子发布。
...
`413cbea13f022831f63e9c750661eeabbffc68d5`。因此可以继续进行真机准入，但只有页面、客户端 HTTP 和 Pino 同链证据齐全时
...
> 本表的当前验收基线为服务端 `b44421cd321ff9ff23eeb49b12641d1772d2bdc1` 与小程序 `413cbea13f022831f63e9c750661eeabbffc68d5`（`413cbea`）的分层配套。表内更早提交或历史线上窗口只用于说明实现来源，
