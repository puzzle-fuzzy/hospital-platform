...
> 小程序 live 运行包来源为 `0be59f966de2c3a0861cb44e9a526a1ef557f6c7`，同源 pending 候选已在释放微信开发者工具锁后原子发布，pending 目录已清理；live 包包含 40 个页面。本地源码、live dist 和线上微信包仍必须分开记录。
...
> 当前本地 live 运行包来源校验值：`0be59f966de2c3a0861cb44e9a526a1ef557f6c7`，40 个页面，`runtime:verify` 已通过；此前因微信开发者工具占用 live `dist` 的同源 pending 候选已在锁释放后完成原子发布，pending 目录已清理。线上配套小程序仍为历史来源 `13f597ea9ee3f65b9be858117826d948339d904a`；线上服务端 release：`1107a78a47ac2fbe0557958251d66da9effc66de`。三者为有意分层发布，不要求同源。
