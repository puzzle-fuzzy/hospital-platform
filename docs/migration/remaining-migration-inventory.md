...
> 当前候选：服务端 release `7181e99e`（完整提交 `7181e99e3a352244102f5591279528b3b66332c9`）；小程序运行包来源为 `90fd7832e3ad1031c9c916f118f90cc0f2840aff`（提交 `90fd783`），真机前必须重新构建并核对来源。

> 当前基线更新：服务端 `7181e99e`；小程序候选 `90fd783`，必须在开发者工具重新编译后以 `build-info.json` 固定来源。下文更早候选只作历史追溯。
