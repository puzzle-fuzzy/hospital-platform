...
> 2026-08-21 当前候选代码门禁复核：`4f80bc2` 小程序测试 `182 pass`、`1445 expects`，构建、运行包来源和全仓门禁均通过；
...
> 当前发布基线补充（2026-08-21）：服务端为 `5a31427`；小程序候选为 `4f80bc2`，完整运行包来源为
> `4f80bc2f313fbcac9fc4e976006ae2c356ce2729`，尚未上传线上。
>
...
> 当前配套小程序候选构建来源为 `4f80bc2f313fbcac9fc4e976006ae2c356ce2729`（提交 `4f80bc2`），尚未上传线上；用户已有的开发者工具配置修改不属于本次候选代码。
