...
> 2026-08-21 当前候选代码门禁复核：`aafccf5` 小程序测试 `180 pass`、`1438 expects`，构建、运行包来源和全仓门禁均通过；
...
> 当前发布基线补充（2026-08-21）：服务端为 `5a31427`；小程序候选为 `aafccf5`，完整运行包来源为
> `aafccf53d1e0eaac5ddaf98b1d850b084e4f78ed`，尚未上传线上。
>
...
> 当前配套小程序候选构建来源为 `aafccf53d1e0eaac5ddaf98b1d850b084e4f78ed`（提交 `aafccf5`），尚未上传线上；用户已有的开发者工具配置修改不属于本次候选代码。
