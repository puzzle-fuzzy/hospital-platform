...
> 当前配套小程序候选构建来源为 `6ce12729c3e112a6cb8333c5132c23713d1cb1ec`（提交 `6ce1272`），尚未上传线上；用户已有的开发者工具配置修改不属于本次候选代码。
...
> `6ce12729c3e112a6cb8333c5132c23713d1cb1ec`。`pnpm check` 全部通过：架构 67 条、旧端页面/接口/客户端清单、Provider intake、
