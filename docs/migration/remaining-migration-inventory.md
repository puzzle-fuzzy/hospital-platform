...
> 2026-08-21 当前候选代码门禁复核：`f19e471` 小程序测试 `179 pass`、`1422 expects`，构建、运行包来源和全仓门禁均通过；
...
> 当前发布基线补充（2026-08-21）：服务端为 `5a31427`；小程序候选为 `f19e471`，完整运行包来源为
> `f19e4717c01948d12fdcc62040a0bd4ab0ac060f`，尚未上传线上。
>
...
> 当前配套小程序候选构建来源为 `7a6f4df34fac5975c6012a30d2c137953a892059`（提交 `7a6f4df`），尚未上传线上；用户已有的开发者工具配置修改不属于本次候选代码。
