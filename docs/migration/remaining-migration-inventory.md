...
> 当前配套小程序候选构建来源为 `7f157d4cca02fa857612daec0b6aa56e328e0083`（提交 `7f157d4`），尚未上传线上；用户已有的开发者工具配置修改不属于本次候选代码。
...
- 当前小程序运行输入来源为 `7f157d4`，本轮完整构建已生成并通过 `runtime:verify`；`dist/build-info.json` 的来源指纹为
  `7f157d4cca02fa857612daec0b6aa56e328e0083`，注册页面和生成脚本均为 14 个；本轮患者上下文
