...
> 2026-08-21 当前候选代码门禁复核：`7a6f4df` 小程序测试 `178 pass`、`1418 expects`，构建、运行包来源和全仓门禁均通过；
...
> 当前发布基线补充（2026-08-21）：服务端为 `5a31427`；小程序候选为 `7a6f4df`，完整运行包来源为
> `7a6f4df34fac5975c6012a30d2c137953a892059`，尚未上传线上。
>
