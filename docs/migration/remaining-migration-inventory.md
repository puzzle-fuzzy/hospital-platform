...
> **当前功能候选事实（2026-08-25）**：本轮功能候选代码基线为 `923074bc`；小程序代码来源为 `296516a5f255c563ec5eac40f2a3439632b143b8`，服务端本地候选按 `apps/api` 最新提交为 `b42922f4`；后续文档提交不改变这套功能候选，代码更新时再重新生成来源记录；
...
> **最新候选覆盖补充（2026-08-25）**：当前功能候选代码基线 `923074bc` 对应的小程序代码来源为 `296516a5`，原生页面注册数为 20 个，健康百科目录、搜索、疾病/药品详情三个只读落点以及客户端运行时响应校验均已纳入；pending 候选位于 `.local/hospital-miniprogram/pending/`，小程序回归为 261 项通过。页面接入不等于健康内容开放，正式审核 bundle、发布/撤回演练和真机证据仍待。

> 当前事实源（2026-08-25，优先于下方历史交接）：功能候选代码基线为 `923074bc128606b7f1504ad0e8e6ea354c4afa34`，小程序源码/运行包候选来源为 `296516a5f255c563ec5eac40f2a3439632b143b8`，位于 `.local/hospital-miniprogram/pending/`；
