...
> 当前发布基线（2026-08-22）：服务端 `2a2acd9bcc89c35988b75fc03304dbd48078c9d5`；小程序运行包来源
...
| P1 | 真机只读验收 | 新小程序运行包来源与已部署服务端配套；微信登录、患者同步/切换、预约历史、门诊费用分别取得页面、HTTP requestId/Provider requestId、Pino 日志三层证据 | 当前进行中：构建和工具缓存已恢复，但尚无当前 `2a2acd9` 的完整三层业务证据，不能宣称业务完成 |
...
> 当前候选：服务端 release `2a2acd9`（完整提交 `2a2acd9bcc89c35988b75fc03304dbd48078c9d5`）；小程序运行包来源为 `b0e093565493285e07fe549879f8b87eda649cc7`（提交 `b0e0935`），真机前必须重新普通编译并核对来源。
