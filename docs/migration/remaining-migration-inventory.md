...
> 2026-08-21 当前候选代码门禁复核：`8d33a27` 小程序测试 `182 pass`、`1445 expects`，构建、运行包来源和全仓门禁均通过；
...
> 当前发布基线补充（2026-08-21）：服务端为 `5a31427`；小程序候选为 `8d33a27`，完整运行包来源为
> `8d33a27e5aa4c5808449116bd3c3740d7a823e80`，尚未上传线上。
>
...
> 当前配套小程序候选构建来源为 `8d33a27e5aa4c5808449116bd3c3740d7a823e80`（提交 `8d33a27`），尚未上传线上；用户已有的开发者工具配置修改不属于本次候选代码。
