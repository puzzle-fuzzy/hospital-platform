...
> 当前配套小程序候选为 `3a66d12`，构建来源为 `3a66d125b0c1ca53879dd88a3661e3025fb7dd3d`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `3a66d125b0c1ca53879dd88a3661e3025fb7dd3d`（当前本地候选 `3a66d12`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
