...
> 当前配套小程序候选为 `d772f09`，构建来源为 `d772f0966bbb0e369c61646528e8205eaf73825f`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `d772f0966bbb0e369c61646528e8205eaf73825f`（当前本地候选 `d772f09`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
