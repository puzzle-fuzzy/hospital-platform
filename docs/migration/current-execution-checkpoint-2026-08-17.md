...
> 截至 2026-08-18 11:09 CST，本地仓库 `main` 已推进到 `9425e76`，当前线上 API release 为 `c63dba9`；新 Bun/Elysia API
...
| 项目 | 当前状态 | 证据 |
| --- | --- | --- |
| 仓库代码基线 | `9425e76`；包含 `c63dba9` 普通资料更新日志链路、患者上下文只读门禁、Provider 文本控制字符拒绝、P0 业务事件链工具和前序迁移改动；仓库 HEAD 仍不能替代线上 release | Git history；线上 bundle provenance 见最新发布记录 |
