...
> 当前配套小程序候选为 `ac238c6`，构建来源为 `ac238c6156f085fdb56f5806fefac3613e5f85be`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `ac238c6156f085fdb56f5806fefac3613e5f85be`（当前本地候选 `ac238c6`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
