...
> 当前配套小程序候选为 `acf5a85`，构建来源为 `acf5a8596e70e1fb2b8d220a0b41eb69418ae086`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `acf5a8596e70e1fb2b8d220a0b41eb69418ae086`（当前本地候选 `acf5a85`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
