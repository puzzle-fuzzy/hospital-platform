...
> 当前配套小程序候选为 `767ed9c`，构建来源为 `767ed9c225bf4d329761f6abed7668015a2626b2`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `767ed9c225bf4d329761f6abed7668015a2626b2`（当前本地候选 `767ed9c`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
