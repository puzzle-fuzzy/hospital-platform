...
> 当前配套小程序候选为 `4f6b341`，构建来源为 `4f6b341cee1525cb0d73bcdf152f630dd74f25f3`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `4f6b341cee1525cb0d73bcdf152f630dd74f25f3`（当前本地候选 `4f6b341`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
