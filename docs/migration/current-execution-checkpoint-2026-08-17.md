...
> 当前配套小程序候选为 `6252ea4`，构建来源为 `6252ea41a40a22a6264276b6590750e4bf0ef5bc`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `6252ea41a40a22a6264276b6590750e4bf0ef5bc`（当前本地候选 `6252ea4`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
