...
> 当前发布基线补充（2026-08-21）：服务端 `5a31427`；小程序候选 `03d9d25`；完整运行包来源 `03d9d25d80d5a5d872a9137c7df0aa19a91ba38f`，尚未上传线上。

> 当前配套小程序候选为 `03d9d25`，构建来源为 `03d9d25d80d5a5d872a9137c7df0aa19a91ba38f`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `03d9d25d80d5a5d872a9137c7df0aa19a91ba38f`（当前本地候选 `03d9d25`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
