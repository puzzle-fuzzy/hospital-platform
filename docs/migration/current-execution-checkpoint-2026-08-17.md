...
> 当前配套小程序候选为 `5348715`，构建来源为 `534871549517080807c7e5c1375247477f422750`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `534871549517080807c7e5c1375247477f422750`（当前本地候选 `5348715`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
