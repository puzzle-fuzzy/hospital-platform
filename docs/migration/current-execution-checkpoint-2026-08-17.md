...
> 当前配套小程序候选为 `474b044`，构建来源为 `474b0444736599c848a4cef9f47fd930884e401d`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `474b0444736599c848a4cef9f47fd930884e401d`（当前本地候选 `474b044`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
