...
> 当前配套小程序候选为 `8ff8831`，构建来源为 `8ff88317b0c1d70700f44d883b289385fad604ea`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `4d56496be950643e0628af482cd0aecc1c2d7348`（当前本地候选 `4d56496`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
