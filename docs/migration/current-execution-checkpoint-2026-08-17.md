...
> 当前配套小程序候选为 `3a89312`，构建来源为 `3a89312cd982ee2fc490b75515cdb6c7d58d513e`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `3a89312cd982ee2fc490b75515cdb6c7d58d513e`（当前本地候选 `3a89312`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
