...
> 当前配套小程序候选为 `0dccf54`，构建来源为 `0dccf545ef65a905b58a27f38e787daea250fa54`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `0dccf545ef65a905b58a27f38e787daea250fa54`（当前本地候选 `0dccf54`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
