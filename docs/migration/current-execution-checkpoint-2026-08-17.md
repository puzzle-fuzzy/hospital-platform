...
> 当前配套小程序候选为 `39e2caa`，构建来源为 `39e2caac27ec4bf569f5debc8edb47947bc398d2`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `39e2caac27ec4bf569f5debc8edb47947bc398d2`（当前本地候选 `39e2caa`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
