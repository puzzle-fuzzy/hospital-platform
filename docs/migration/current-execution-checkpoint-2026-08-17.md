...
> 当前配套小程序候选为 `457d9ae`，构建来源为 `457d9aee567bc77c33279a9b61db921e3011f1c1`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `457d9aee567bc77c33279a9b61db921e3011f1c1`（当前本地候选 `457d9ae`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
