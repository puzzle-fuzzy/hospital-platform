...
> 当前发布基线补充（2026-08-21 10:52 CST）：服务端 `5a31427`；小程序候选 `c86a788`；完整运行包来源 `c86a788c01760fd5a74ac8c2769871025297a4fc`，尚未上传线上。

> 当前配套小程序候选为 `39ad2c5`，构建来源为 `39ad2c5937af2fdc735ffb223c0648464af3a48c`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `39ad2c5937af2fdc735ffb223c0648464af3a48c`（当前本地候选 `39ad2c5`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
