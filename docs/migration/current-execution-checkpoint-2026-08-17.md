...
> 当前配套小程序候选为 `9340846`，构建来源为 `93408462f3eeadffed172f1ea3b10c043d461b1b`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `93408462f3eeadffed172f1ea3b10c043d461b1b`（当前本地候选 `9340846`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
