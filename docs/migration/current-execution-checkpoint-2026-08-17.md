...
> 当前配套小程序候选为 `6677671`，构建来源为 `667767123efdb5b3a0bedbe423ab1797f16b1247`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `667767123efdb5b3a0bedbe423ab1797f16b1247`（当前本地候选 `6677671`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
