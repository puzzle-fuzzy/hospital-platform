...
> 当前配套小程序候选为 `1b9b4b0`，构建来源为 `1b9b4b0d101dfcd5011845f7797c9523676cc987`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `1b9b4b0d101dfcd5011845f7797c9523676cc987`（当前本地候选 `1b9b4b0`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
...
以下时间段的 release、监听和日志描述保留原始事实，但不能覆盖上方的当前 `6038560` 运行基线。
