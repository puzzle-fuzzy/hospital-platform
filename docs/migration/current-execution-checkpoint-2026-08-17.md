...
> 当前配套小程序候选为 `501e3a7`，构建来源为 `501e3a77e3d6808d946cbe6c6122d942182709a9`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `501e3a77e3d6808d946cbe6c6122d942182709a9`（当前本地候选 `501e3a7`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
