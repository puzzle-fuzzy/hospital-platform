...
> 当前发布基线补充（2026-08-21）：服务端 `5a31427`；小程序候选 `cdb27e50`；完整运行包来源 `cdb27e5023a188ab36a340497cebe18f1e274013`，尚未上传线上。

> 当前配套小程序候选为 `cdb27e50`，构建来源为 `cdb27e5023a188ab36a340497cebe18f1e274013`；尚未上传线上，真实微信与真机证据仍需独立采集。
