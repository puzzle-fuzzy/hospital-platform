...
> 当前配套小程序候选为 `b451cc6`，构建来源为 `b451cc6df6959df3155e1ffaf1ef3c8dcd0c6df8`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `b451cc6df6959df3155e1ffaf1ef3c8dcd0c6df8`（当前本地候选 `b451cc6`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
