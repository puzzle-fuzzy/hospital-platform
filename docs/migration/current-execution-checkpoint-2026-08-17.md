...
> 当前配套小程序候选为 `07dde51`，构建来源为 `07dde51d84888a33a762bcdffa2d74bde62d1064`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `07dde51d84888a33a762bcdffa2d74bde62d1064`（当前本地候选 `07dde51`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
...
| 项目 | 当前状态 | 证据 |
| --- | --- | --- |
| 仓库代码基线 | `main` 当前 HEAD（以 Git history 为准）；生产运行 bundle 的代码来源为 `b7c9451`，仓库 HEAD 不能替代线上 release | Git history；线上 bundle provenance 见最新发布记录 |
| 线上新 API | `b7c9451`，监听 `10.0.0.3:18081`，由 `hospital-platform-api-v2.service` 托管 | [`../release/b7c9451-production-acceptance-2026-08-19.md`](../release/b7c9451-production-acceptance-2026-08-19.md) |
