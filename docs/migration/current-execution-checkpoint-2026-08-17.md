...
> 当前配套小程序候选为 `b55df37`，构建来源为 `b55df37b48bbe250e4ebefee3db7739d2fd554e2`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `b55df37b48bbe250e4ebefee3db7739d2fd554e2`（当前本地候选 `b55df37`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
...
| 依赖 | 线上远端 MySQL `hospital-dev` 共库、Redis DB3/DB1 隔离、schema `0016`；`0016_patient_directory_sync_owner_index` 已应用并通过生产 preflight | [`../release/b7c9451-production-acceptance-2026-08-19.md`](../release/b7c9451-production-acceptance-2026-08-19.md) |
| 运行前置 | 公网 live、ready、system ping 通过，隔离 smoke ready 连续 3/3，未登录受保护路由返回 `401/unauthorized`；切换后启动日志为 production 且依赖均为 `ok` | [`../release/b7c9451-production-acceptance-2026-08-19.md`](../release/b7c9451-production-acceptance-2026-08-19.md) |
