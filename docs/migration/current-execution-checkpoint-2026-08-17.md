...
> 当前发布基线补充（2026-08-21）：服务端 `5a31427`；小程序候选 `ec3e5f09`；完整运行包来源 `ec3e5f094ecd0a85bbf98d4fc6ff9f14b27bb9ac`，尚未上传线上。

> 当前配套小程序候选为 `ec3e5f09`，构建来源为 `ec3e5f094ecd0a85bbf98d4fc6ff9f14b27bb9ac`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `ec3e5f094ecd0a85bbf98d4fc6ff9f14b27bb9ac`（当前本地候选 `ec3e5f09`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
