...
> 当前发布基线补充（2026-08-21）：服务端 `5a31427`；小程序候选 `cde7bc9`；完整运行包来源 `cde7bc90a23698398e9474944adf42b36f37982c`，尚未上传线上。

> 当前配套小程序候选为 `cde7bc9`，构建来源为 `cde7bc90a23698398e9474944adf42b36f37982c`；尚未上传线上，真实微信与真机证据仍需独立采集。
...
> `cde7bc90a23698398e9474944adf42b36f37982c`（当前本地候选 `cde7bc9`，尚未上传线上）。真实微信、患者上下文和 P0 只读验收的操作顺序统一见
