...
| 当前小程序运行相关源码候选 | live `1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`；当前无 pending 目录 | 38 页；运行包校验通过；核心回归、App.onLaunch 初始化时序、共享患者会话边界、规则版本、关闭态布局和预约请求边界测试通过 |
| 当前 live 运行包 | `1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`（`1bc5bf6`） | 38 页，`runtime:verify` 通过；九个真机证据域仍为 pending，不能作为真机完成证据 |
