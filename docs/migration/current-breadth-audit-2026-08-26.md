...
> **当前候选覆盖（2026-08-26）**：小程序运行包已切换为 `0be59f96`（完整来源 `0be59f966de2c3a0861cb44e9a526a1ef557f6c7`），40 页，核心回归、共享患者会话边界和规则版本测试通过；就诊二维码安全壳已增加有效会话门禁，BMI/血压安全数值工具已固定规则版本。发布前 pending 校验通过，发布后 `runtime:verify` 通过；九个真机证据域仍为 pending。详情见 [`../release/candidate-0be59f96-miniprogram-runtime-2026-08-26.md`](../release/candidate-0be59f96-miniprogram-runtime-2026-08-26.md)。
