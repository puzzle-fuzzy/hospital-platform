...
| 当前小程序源码 | `de9c5b996c6735ced9684bce72e493834fe9325e`（全量页面覆盖 + 公共日期窗口边界） | 40 页，`309 pass / 0 fail / 3522 expect()` |
| 当前 pending 运行包 | `de9c5b996c6735ced9684bce72e493834fe9325e` | 40 页，`runtime:verify:pending` 通过；尚未发布到 live `dist`，不能作为真机完成证据 |
