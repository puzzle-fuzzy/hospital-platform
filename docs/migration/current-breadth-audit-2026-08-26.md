...
| 当前小程序源码 | `d204425420ddc8633260053e32ff042e2b0635c7`（今日预约摘要 + 健康自测安全数值子集 + 6 个临床内容外壳 + 3 个外部入口 + 2 个预约 Provider 页面外壳） | 40 页，`298 pass / 0 fail / 3394 expect()` |
| 当前 pending 运行包 | `d204425420ddc8633260053e32ff042e2b0635c7` | 40 页，`runtime:verify:pending` 通过；尚未发布到 live `dist`，不能作为真机完成证据 |
