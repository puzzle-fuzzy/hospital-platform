...
| 当前小程序运行相关源码候选 | live `34f0fd21aac33214e991de561d37dfd7071013bf`；当前无 pending 目录 | 40 页；运行包校验通过；核心回归、共享患者会话边界、规则版本和关闭态布局测试通过 |
| 当前 live 运行包 | `34f0fd21aac33214e991de561d37dfd7071013bf`（`34f0fd21`） | 40 页，`runtime:verify` 通过；九个真机证据域仍为 pending，不能作为真机完成证据 |
