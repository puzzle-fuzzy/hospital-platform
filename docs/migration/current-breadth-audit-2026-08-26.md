...
| 当前小程序运行相关源码候选 | `adf536bff5b01a2cd27c664f05b7feae2be6ec3f`（微信资料拒绝后的设置页重试） | 40 页，`312 pass / 0 fail / 3548 expect()` |
| 当前 pending 运行包 | `adf536bff5b01a2cd27c664f05b7feae2be6ec3f` | 40 页，`runtime:verify:pending` 通过；尚未发布到 live `dist`，不能作为真机完成证据 |
