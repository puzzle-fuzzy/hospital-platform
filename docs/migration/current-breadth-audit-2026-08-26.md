...
| 当前小程序运行相关源码候选 | `e3356e50f14f77bac9061dcdfa5c42e5d022c188`（患者展示边界审计后的运行输入） | 40 页，`309 pass / 0 fail / 3522 expect()` |
| 当前 pending 运行包 | `e3356e50f14f77bac9061dcdfa5c42e5d022c188` | 40 页，`runtime:verify:pending` 通过；尚未发布到 live `dist`，不能作为真机完成证据 |
