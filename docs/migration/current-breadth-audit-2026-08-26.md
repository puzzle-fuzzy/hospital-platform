...
| 当前小程序运行相关源码候选 | live `413cbea13f022831f63e9c750661eeabbffc68d5`；当前无 pending 目录 | 40 页；运行包校验通过；核心回归、共享患者会话边界、规则版本、关闭态布局和预约请求边界测试通过 |
| 当前 live 运行包 | `413cbea13f022831f63e9c750661eeabbffc68d5`（`413cbea`） | 40 页，`runtime:verify` 通过；九个真机证据域仍为 pending，不能作为真机完成证据 |
