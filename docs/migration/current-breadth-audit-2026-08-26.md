...
| 当前小程序运行相关源码候选 | `adf536bff5b01a2cd27c664f05b7feae2be6ec3f`（微信资料拒绝后的设置页重试） | 40 页，`311 pass / 0 fail / 3527 expect()` |
