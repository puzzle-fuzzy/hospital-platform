...
| 项目 | 当前事实 |
| --- | --- |
| 功能候选代码基线 | `3cf828ed`（修复普通资料暂时异常时的微信授权边界） |
| 当前功能基线 | `3cf828ed`（文档更新不改变 live `dist`） |
| 小程序业务代码候选 | `3cf828ed185f0e745138db04011d26c6db62fa8a` |
| 小程序 pending 运行包 | `.local/hospital-miniprogram/pending/`，`build-info.json.sourceRevision=3cf828ed185f0e745138db04011d26c6db62fa8a` |
| pending 页面数 | 20 个；每个页面具备 `.js/.json/.wxml/.wxss` |
| 小程序回归 | 当前源码 284 pass / 0 fail / 3129 expect()；pending 已包含当前运行输入；入口分发广度审计通过 |
