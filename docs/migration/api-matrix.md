...
| `GET /knowledge/*` | `/api/v1/knowledge/*` | 先迁移已审核健康百科只读内容；自测另行版本化 | ADR 0004、contract/domain port 和 fail-closed adapter 已完成；真实 schema、MySQL repository、内容审核和 API 待实现 |
