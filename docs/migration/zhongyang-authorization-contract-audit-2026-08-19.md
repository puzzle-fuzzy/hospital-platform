...
> 当前验收配套基线：服务端 `5a31427`；小程序候选 `f9833c1`；完整运行包来源
> `f9833c11ef0d49591fd14f99ce60ad92d800156a`。这只是统一证据来源，不代表 Provider 鉴权或真机业务已经完成。
...
当前下一步是先在服务端 `5a31427` 上用小程序候选 `7a6f4df` 取得新平台真机会话，再按患者同步 → 预约记录 → 门诊费用 → 报告
