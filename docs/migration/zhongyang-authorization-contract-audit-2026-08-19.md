...
> 当前验收配套基线：服务端 `398be8e`；小程序候选 `474b044`；完整运行包来源
> `474b0444736599c848a4cef9f47fd930884e401d`。这只是统一证据来源，不代表 Provider 鉴权或真机业务已经完成。
...
当前下一步是先用与服务端 `398be8e` 配套的小程序候选 `474b044` 取得新平台真机会话，再按患者同步 → 预约记录 → 门诊费用 → 报告
