...
> 当前验收配套基线：服务端 `398be8e`；小程序候选 `e050fa0`；完整运行包来源
> `e050fa026f2cb5b2de4af4de98024cfdb946229c`。这只是统一证据来源，不代表 Provider 鉴权或真机业务已经完成。
...
当前下一步是先用与服务端 `398be8e` 配套的小程序候选 `e050fa0` 取得新平台真机会话，再按患者同步 → 预约记录 → 门诊费用 → 报告
