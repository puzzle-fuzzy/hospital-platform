...
> 当前服务端 release 为 `28a5c0c131794ce9dcc5f94bd3809402188ac87a`；当前小程序运行包来源为 `13f597ea9ee3f65b9be858117826d948339d904a`（提交 `13f597e`）。两者为本轮服务端独立只读 adapter 发布后的有意分层，真实真机与 Provider 三层证据仍待。
