...
> 当前配套小程序候选构建来源为 `b02594a521cae2d12b991d2361c80224572c79b0`（提交 `b02594a`），尚未上传线上；历史候选只用于追溯。
...
- 2026-08-17 复核旧仓库时发现 `module_common` 从原台账的 34 个漂移到 38 个挂载路由，旧服务
  ...
  `b02594a521cae2d12b991d2361c80224572c79b0`（当前本地候选 `b02594a`，尚未上传线上）；旧 Python 服务继续监听 `8001`，旧服务、
