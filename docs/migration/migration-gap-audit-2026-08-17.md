...
> `41c708e12c71a2e83fac679939d31ed6bb3f0996`。当前 P0 运行层切换已完成，P1 真机与 Provider 三层证据仍未完成。
...
> 当前配套小程序候选构建来源为 `937bb2ad2c71a2e83fac679939d31ed6bb3f0996`（提交 `937bb2ad`），服务端已完成配套发布；历史候选只用于追溯。
