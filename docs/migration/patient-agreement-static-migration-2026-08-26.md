...
> 只用于追溯；当前小程序 live 运行包以 `02dbf10419740d96c4445493df019021ac22bcfa` 和
> [`release/candidate-02dbf10-miniprogram-runtime-2026-08-26.md`](../release/candidate-02dbf10-miniprogram-runtime-2026-08-26.md)
> 为准，协议同意、撤回和审计仍未开放。
