...
> 当前发布基线补充（2026-08-21）：服务端 `5a31427`；小程序候选 `b02594a`；完整运行包来源 `b02594a521cae2d12b991d2361c80224572c79b0`。本页业务结论仍以渠道契约为准。

## 审计范围

本次只核对原生小程序“我的挂号”页面的“在线挂号/全部挂号”两个标签、服务端当前
预约历史渠道和客户端筛选边界。当前审计基准为服务端 `5a31427` 与配套小程序候选
`b02594a`（来源 `b02594a521cae2d12b991d2361c80224572c79b0`）；本记录只描述只读合同边界，
