...
> 当前发布基线补充（2026-08-21）：服务端 `5a31427`；小程序候选 `cde7bc9`；完整运行包来源 `cde7bc90a23698398e9474944adf42b36f37982c`。本页业务结论仍以渠道契约为准。

## 审计范围

本次只核对原生小程序“我的挂号”页面的“在线挂号/全部挂号”两个标签、服务端当前
预约历史渠道和客户端筛选边界。当前审计基准为服务端 `5a31427` 与配套小程序候选
`cde7bc9`（来源 `cde7bc90a23698398e9474944adf42b36f37982c`）；本记录只描述只读合同边界，
