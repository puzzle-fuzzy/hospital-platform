# 小程序当前候选真机三层证据记录模板（`b02594a`）

> 当前服务端 release 为 `5a31427`；小程序完整运行包来源为 `b02594a521cae2d12b991d2361c80224572c79b0`。空白模板不代表真机或业务验收通过。

| 项目 | 值 |
| --- | --- |
| 服务端 release | `5a31427` |
| 小程序提交 | `b02594a` |
| 完整运行包来源 | `b02594a521cae2d12b991d2361c80224572c79b0` |
