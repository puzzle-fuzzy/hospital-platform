...
> 本记录的运行观察窗口早于小程序候选 `47be0bc`，其中的旧候选来源只作为历史运行层证据；当前真机必须使用
> [`candidate-47be0bc-local-build-2026-08-22.md`](candidate-47be0bc-local-build-2026-08-22.md) 和对应二维码。
...
本观察窗口使用的上一候选运行包来源为 `ec26f41f8575871972ac63a8074a9beaec1df55b`，
