# `737bc05f` 原生 Tab 运行包与开发者工具根目录候选记录（2026-08-24）
...
| 项目 | 值 |
| --- | --- |
| Git 提交 | `737bc05fa6b24b945a179b9131d063bfe85ee01c` |
...
- `dist/build-info.json.sourceRevision` 为 `737bc05fa6b24b945a179b9131d063bfe85ee01c`；
