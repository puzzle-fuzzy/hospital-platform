...
> `935410473e5a7c1be125a85834f957f53a833d8f`（`9354104`），38 个页面，当前无 pending 目录；
...
| 检查项 | 结果 |
| --- | --- |
| 当前小程序候选 | live 为 `9354104`（来源 `935410473e5a7c1be125a85834f957f53a833d8f`）；当前无 pending 目录 |
