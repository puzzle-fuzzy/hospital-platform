...
| 检查项 | 结果 |
| --- | --- |
| 当前小程序候选 | pending `317350e0`（来源 `317350e003d2243c48c38e17de11e45cc3cdada2`）；live `02dbf10` |
...
| 小程序核心测试 | `324 pass / 0 fail / 3608 expect()` |
...
当前 `docs/release/device-evidence-317350e0-pending.json` 的九个业务域仍为 `pending`。本地测试只能证明客户端状态机和响应校验，不足以证明微信真机、公网 HTTPS、Nginx、Elysia 日志和 Provider 请求号已经形成同一条证据链。
