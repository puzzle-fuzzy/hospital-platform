...
> `805c54ea9fa943385ad6feebed1401d521fbad3c`（`805c54e`），40 个页面，当前无 pending 目录；
...
| 检查项 | 结果 |
| --- | --- |
| 当前小程序候选 | live 为 `805c54e`（来源 `805c54ea9fa943385ad6feebed1401d521fbad3c`）；当前无 pending 目录 |
...
| 小程序核心测试 | 全量回归 `341 pass / 0 fail / 3728 expect()`；本候选新增 App.onLaunch 全局资料初始化时序回归，既有共享患者会话边界、二维码会话门禁、健康规则版本和关闭态布局测试均通过 |
