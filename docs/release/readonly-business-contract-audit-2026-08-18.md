...
`ec3e5f094ecd0a85bbf98d4fc6ff9f14b27bb9ac`（当前本地候选 `ec3e5f09`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`ec3e5f094ecd0a85bbf98d4fc6ff9f14b27bb9ac`（提交 `ec3e5f09`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`ec3e5f094ecd0a85bbf98d4fc6ff9f14b27bb9ac`（提交 `ec3e5f09`）为准。当前真机候选以
`5a31427` 配套的 `ec3e5f09` 和完整来源指纹 `ec3e5f094ecd0a85bbf98d4fc6ff9f14b27bb9ac` 为准。
