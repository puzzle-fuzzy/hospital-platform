...
`48ba22f16cb0f1d1098895772e660a3ed96761bb`（提交 `48ba22f`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。当前 `398be8e` release 的窄观察窗口没有新的
...
1. 使用与服务端 `398be8e` 配套、来源指纹为 `48ba22f16cb0f1d1098895772e660a3ed96761bb` 的小程序运行包，在有效微信会话下完成登录、患者刷新/显式切换、我的挂号、
   爽约记录和门诊待缴/已缴页面操作；
