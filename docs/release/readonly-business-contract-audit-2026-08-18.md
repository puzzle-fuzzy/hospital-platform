...
`c86a788c01760fd5a74ac8c2769871025297a4fc`（提交 `c86a788`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`c86a788c01760fd5a74ac8c2769871025297a4fc`（提交 `c86a788`）为准。当前真机候选以
`5a31427` 配套的 `c86a788` 和完整来源指纹 `c86a788c01760fd5a74ac8c2769871025297a4fc` 为准。
