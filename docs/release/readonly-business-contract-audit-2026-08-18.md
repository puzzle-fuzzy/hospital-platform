...
`1b9b4b0d101dfcd5011845f7797c9523676cc987`（当前本地候选 `1b9b4b0`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`1b9b4b0d101dfcd5011845f7797c9523676cc987`（提交 `1b9b4b0`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`5a31427` 配套的 `1b9b4b0` 和完整来源指纹 `1b9b4b0d101dfcd5011845f7797c9523676cc987` 为准。
...
1. 使用与服务端 `5a31427` 配套、来源指纹为 `1b9b4b0d101dfcd5011845f7797c9523676cc987` 的小程序运行包，在有效微信会话下完成登录、患者刷新/显式切换、我的挂号、
   爽约记录和门诊待缴/已缴页面操作；
