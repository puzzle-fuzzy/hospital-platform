...
`501e3a77e3d6808d946cbe6c6122d942182709a9`（当前本地候选 `501e3a7`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`501e3a77e3d6808d946cbe6c6122d942182709a9`（提交 `501e3a7`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。当前 `0e360d3` release 的窄观察窗口没有新的
