...
`4f80bc2f313fbcac9fc4e976006ae2c356ce2729`（当前本地候选 `4f80bc2`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`4f80bc2f313fbcac9fc4e976006ae2c356ce2729`（提交 `4f80bc2`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`4f80bc2f313fbcac9fc4e976006ae2c356ce2729`（提交 `4f80bc2`）为准。当前真机候选以
`5a31427` 配套的 `4f80bc2` 和完整来源指纹 `4f80bc2f313fbcac9fc4e976006ae2c356ce2729` 为准。
