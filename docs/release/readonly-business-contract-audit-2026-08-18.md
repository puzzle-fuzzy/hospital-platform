...
`f66514de81c051cb8ade1477f758700b2837b9b7`（提交 `f66514d`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`f66514de81c051cb8ade1477f758700b2837b9b7`（提交 `f66514d`）为准。当前真机候选以
`5a31427` 配套的 `f66514d` 和完整来源指纹 `f66514de81c051cb8ade1477f758700b2837b9b7` 为准。
