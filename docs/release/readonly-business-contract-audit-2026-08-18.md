...
`b02594a521cae2d12b991d2361c80224572c79b0`（当前本地候选 `b02594a`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`b02594a521cae2d12b991d2361c80224572c79b0`（提交 `b02594a`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`b02594a521cae2d12b991d2361c80224572c79b0`（提交 `b02594a`）为准。当前真机候选以
`5a31427` 配套的 `b02594a` 和完整来源指纹 `b02594a521cae2d12b991d2361c80224572c79b0` 为准。
