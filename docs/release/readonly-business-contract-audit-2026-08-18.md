...
`413cbea13f022831f63e9c750661eeabbffc68d5`（提交 `413cbea`），服务端为 `b44421cd321ff9ff23eeb49b12641d1772d2bdc1`。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。当前只读发布已完成，历史 release 的窄观察窗口没有新的
...
`413cbea13f022831f63e9c750661eeabbffc68d5`（提交 `413cbea`）为准。当前真机候选以
`413cbea` 小程序候选和服务端 `b44421cd` 的分层配套及完整来源指纹 `413cbea13f022831f63e9c750661eeabbffc68d5` 为准。
