...
`f085d06d8e4b9695274f93b5a6b56f2af3faac91`（当前本地候选 `f085d06`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`f085d06d8e4b9695274f93b5a6b56f2af3faac91`（提交 `f085d06`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`f085d06d8e4b9695274f93b5a6b56f2af3faac91`（提交 `f085d06`）为准。当前真机候选以
`5a31427` 配套的 `f085d06` 和完整来源指纹 `f085d06d8e4b9695274f93b5a6b56f2af3faac91` 为准。
