...
`4e823137b7180390209614ef677c5a71f9c465be`（当前本地候选 `4e82313`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`4e823137b7180390209614ef677c5a71f9c465be`（提交 `4e82313`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`4e823137b7180390209614ef677c5a71f9c465be`（提交 `4e82313`）为准。当前真机候选以
`5a31427` 配套的 `4e82313` 和完整来源指纹 `4e823137b7180390209614ef677c5a71f9c465be` 为准。
