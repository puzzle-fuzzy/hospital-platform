...
`667767123efdb5b3a0bedbe423ab1797f16b1247`（当前本地候选 `6677671`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`667767123efdb5b3a0bedbe423ab1797f16b1247`（提交 `6677671`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`667767123efdb5b3a0bedbe423ab1797f16b1247`（提交 `6677671`）为准。当前真机候选以
`5a31427` 配套的 `6677671` 和完整来源指纹 `667767123efdb5b3a0bedbe423ab1797f16b1247` 为准。
