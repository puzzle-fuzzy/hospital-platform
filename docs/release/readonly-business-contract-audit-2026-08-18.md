...
`d4d65b735da8630e9b6795d9e105192713297474`（当前本地候选 `d4d65b7`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`d4d65b735da8630e9b6795d9e105192713297474`（提交 `d4d65b7`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`d4d65b735da8630e9b6795d9e105192713297474`（提交 `d4d65b7`）为准。当前真机候选以
`5a31427` 配套的 `d4d65b7` 和完整来源指纹 `d4d65b735da8630e9b6795d9e105192713297474` 为准。
...
1. 使用与服务端 `5a31427` 配套、来源指纹为 `02c18af2e658507a0fa5182368235cf62cd348c7` 的小程序运行包，在有效微信会话下完成登录、患者刷新/显式切换、我的挂号、
   爽约记录和门诊待缴/已缴页面操作；
