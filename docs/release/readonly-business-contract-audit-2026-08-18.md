...
`76ca0137ea9a57b8b7ed9c8797bb718040535922`（提交 `76ca013`），服务端为 `b44421cd321ff9ff23eeb49b12641d1772d2bdc1`。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。当前只读发布已完成，历史 release 的窄观察窗口没有新的
...
`76ca0137ea9a57b8b7ed9c8797bb718040535922`（提交 `76ca013`）为准。当前真机候选以
`76ca013` 小程序候选和服务端 `b44421cd` 的分层配套及完整来源指纹 `76ca0137ea9a57b8b7ed9c8797bb718040535922` 为准。
