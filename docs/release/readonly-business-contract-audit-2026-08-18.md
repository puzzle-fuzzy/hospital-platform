...
`99d9f60f6291b7f8d08d779cec059892f054d80e`（提交 `99d9f60`），服务端为 `1bc8b0a85f21cb58205a99ce4de0de6afe9bf240`。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。当前只读发布已完成，历史 release 的窄观察窗口没有新的
...
`99d9f60f6291b7f8d08d779cec059892f054d80e`（提交 `99d9f60`）为准。当前真机候选以
`99d9f60` 小程序候选和服务端 `1bc8b0a8` 的分层配套及完整来源指纹 `99d9f60f6291b7f8d08d779cec059892f054d80e` 为准。
