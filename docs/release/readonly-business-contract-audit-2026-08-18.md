...
`1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`（提交 `1bc5bf6`），服务端为 `b44421cd321ff9ff23eeb49b12641d1772d2bdc1`。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。当前只读发布已完成，历史 release 的窄观察窗口没有新的
...
`1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`（提交 `1bc5bf6`）为准。当前真机候选以
`1bc5bf6` 小程序候选和服务端 `b44421cd` 的分层配套及完整来源指纹 `1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916` 为准。
