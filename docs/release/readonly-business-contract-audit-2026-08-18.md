...
`aafccf53d1e0eaac5ddaf98b1d850b084e4f78ed`（当前本地候选 `aafccf5`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`aafccf53d1e0eaac5ddaf98b1d850b084e4f78ed`（提交 `aafccf5`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`aafccf53d1e0eaac5ddaf98b1d850b084e4f78ed`（提交 `aafccf5`）为准。当前真机候选以
`5a31427` 配套的 `aafccf5` 和完整来源指纹 `aafccf53d1e0eaac5ddaf98b1d850b084e4f78ed` 为准。
