...
`341524ac345d9cfae3f6e0f8258aed3e9457f458`（当前本地候选 `341524a`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`341524ac345d9cfae3f6e0f8258aed3e9457f458`（提交 `341524a`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`341524ac345d9cfae3f6e0f8258aed3e9457f458`（提交 `341524a`）为准。当前真机候选以
`002acc1b` 配套的 `341524a` 和完整来源指纹 `341524ac345d9cfae3f6e0f8258aed3e9457f458` 为准。
