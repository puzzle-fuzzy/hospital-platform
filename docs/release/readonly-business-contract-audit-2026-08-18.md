...
当前线上服务端 release 为 `5a31427`，小程序构建来源为
`f9833c11ef0d49591fd14f99ce60ad92d800156a`（当前本地候选 `f9833c1`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`f9833c11ef0d49591fd14f99ce60ad92d800156a`（提交 `f9833c1`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`f9833c11ef0d49591fd14f99ce60ad92d800156a`（提交 `f9833c1`）为准。当前真机候选以
`5a31427` 配套的 `f9833c1` 和完整来源指纹 `f9833c11ef0d49591fd14f99ce60ad92d800156a` 为准。
