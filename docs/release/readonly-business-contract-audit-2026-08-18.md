...
`1d161b701384ad8073ed907fe14f611ab3166fcd`（当前本地候选 `1d161b7`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`1d161b701384ad8073ed907fe14f611ab3166fcd`（提交 `1d161b7`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`5a31427` 配套的 `1d161b7` 和完整来源指纹 `1d161b701384ad8073ed907fe14f611ab3166fcd` 为准。
