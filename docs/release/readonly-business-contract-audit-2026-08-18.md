...
`03d9d25d80d5a5d872a9137c7df0aa19a91ba38f`（当前本地候选 `03d9d25`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`03d9d25d80d5a5d872a9137c7df0aa19a91ba38f`（提交 `03d9d25`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`03d9d25d80d5a5d872a9137c7df0aa19a91ba38f`（提交 `03d9d25`）为准。当前真机候选以
`5a31427` 配套的 `03d9d25` 和完整来源指纹 `03d9d25d80d5a5d872a9137c7df0aa19a91ba38f` 为准。
