...
`cde7bc90a23698398e9474944adf42b36f37982c`（当前本地候选 `cde7bc9`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`cde7bc90a23698398e9474944adf42b36f37982c`（提交 `cde7bc9`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`cde7bc90a23698398e9474944adf42b36f37982c`（提交 `cde7bc9`）为准。当前真机候选以
`5a31427` 配套的 `cde7bc9` 和完整来源指纹 `cde7bc90a23698398e9474944adf42b36f37982c` 为准。
