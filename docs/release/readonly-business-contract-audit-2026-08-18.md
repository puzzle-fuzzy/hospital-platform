...
`39ad2c5937af2fdc735ffb223c0648464af3a48c`（当前本地候选 `39ad2c5`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`5c069290e8f26f1e4d22742a8c7a4b4ad18ca3d6`（提交 `5c06929`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`5c069290e8f26f1e4d22742a8c7a4b4ad18ca3d6`（提交 `5c06929`）为准。当前真机候选以
`5a31427` 配套的 `5c06929` 和完整来源指纹 `5c069290e8f26f1e4d22742a8c7a4b4ad18ca3d6` 为准。
