...
`62cdb8f82b4169dd1b9a6ed3403e3be2f7422328`（提交 `62cdb8f`），服务端为 `1bc8b0a85f21cb58205a99ce4de0de6afe9bf240`。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。当前只读发布已完成，历史 release 的窄观察窗口没有新的
...
`62cdb8f82b4169dd1b9a6ed3403e3be2f7422328`（提交 `62cdb8f`）为准。当前真机候选以
`62cdb8f` 小程序候选和服务端 `1bc8b0a8` 的分层配套及完整来源指纹 `62cdb8f82b4169dd1b9a6ed3403e3be2f7422328` 为准。
