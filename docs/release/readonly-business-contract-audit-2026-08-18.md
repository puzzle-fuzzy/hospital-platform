...
`f1b8b61609e0560d3da3fe176f62ab3585b6ee98`（提交 `f1b8b61`），服务端为 `1bc8b0a85f21cb58205a99ce4de0de6afe9bf240`。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。当前只读发布已完成，历史 release 的窄观察窗口没有新的
...
`f1b8b61609e0560d3da3fe176f62ab3585b6ee98`（提交 `f1b8b61`）为准。当前真机候选以
`f1b8b61` 小程序候选和服务端 `1bc8b0a8` 的分层配套及完整来源指纹 `f1b8b61609e0560d3da3fe176f62ab3585b6ee98` 为准。
