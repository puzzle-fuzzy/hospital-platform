...
`93408462f3eeadffed172f1ea3b10c043d461b1b`（当前本地候选 `9340846`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`93408462f3eeadffed172f1ea3b10c043d461b1b`（提交 `9340846`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`5a31427` 配套的 `9340846` 和完整来源指纹 `93408462f3eeadffed172f1ea3b10c043d461b1b` 为准。
