...
> `e9ffd8276a33bd69d850618b37ed041ecc4b65cd`。历史 contract 审计仍保留，但业务证据必须重新绑定当前候选。

> 历史候选：服务端 release `7181e99e3a352244102f5591279528b3b66332c9`；小程序运行包来源 `4e1b2e224964797c103eba832323ee7074c7ad2b`（提交 `4e1b2e2`）。

> 当前基线更新：服务端 `9f479c9a`；小程序候选 `e9ffd827`；完整运行包来源 `e9ffd8276a33bd69d850618b37ed041ecc4b65cd`。下文更早候选只作历史追溯。
...
`e9ffd8276a33bd69d850618b37ed041ecc4b65cd`（当前本地候选 `e9ffd827`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`e9ffd8276a33bd69d850618b37ed041ecc4b65cd`（提交 `e9ffd827`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。当前 `9f479c9a` 只读发布已完成，历史 `0e360d3` release 的窄观察窗口没有新的
...
`e9ffd8276a33bd69d850618b37ed041ecc4b65cd`（提交 `e9ffd827`）为准。当前真机候选以
`9f479c9a` 配套的 `e9ffd827` 和完整来源指纹 `e9ffd8276a33bd69d850618b37ed041ecc4b65cd` 为准。
