...
`5a31427` 配套的 `6e6604f` 和完整来源指纹 `6e6604f8089e45ceeaaf4bcbbd57065174a59a31` 为准。
...
1. 使用与服务端 `5a31427` 配套、来源指纹为 `6e6604f8089e45ceeaaf4bcbbd57065174a59a31` 的小程序运行包，在有效微信会话下完成登录、患者刷新/显式切换、我的挂号、
   爽约记录和门诊待缴/已缴页面操作；
