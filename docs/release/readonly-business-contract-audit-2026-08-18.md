...
为准；配套小程序构建来源为 `9b88cf105314965837260b2d77671939ac22c828`：新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。当前 release 的窄观察窗口没有新的
...
1. 使用与服务端 `1b94c46` 配套、来源指纹为 `9b88cf105314965837260b2d77671939ac22c828` 的小程序运行包，在有效微信会话下完成登录、患者刷新/显式切换、我的挂号、
   爽约记录和门诊待缴/已缴页面操作；
