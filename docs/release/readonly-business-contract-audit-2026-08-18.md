...
`b451cc6df6959df3155e1ffaf1ef3c8dcd0c6df8`（当前本地候选 `b451cc6`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
1. 使用与服务端 `65219e2` 配套、来源指纹为 `b451cc6df6959df3155e1ffaf1ef3c8dcd0c6df8` 的小程序运行包，在有效微信会话下完成登录、患者刷新/显式切换、我的挂号、
   爽约记录和门诊待缴/已缴页面操作；
