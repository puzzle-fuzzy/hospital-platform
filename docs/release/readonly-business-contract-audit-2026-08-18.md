...
`7a6f4df34fac5975c6012a30d2c137953a892059`（当前本地候选 `7a6f4df`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`7a6f4df34fac5975c6012a30d2c137953a892059`（提交 `7a6f4df`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`7a6f4df34fac5975c6012a30d2c137953a892059`（提交 `7a6f4df`）为准。当前真机候选以
`5a31427` 配套的 `7a6f4df` 和完整来源指纹 `7a6f4df34fac5975c6012a30d2c137953a892059` 为准。
