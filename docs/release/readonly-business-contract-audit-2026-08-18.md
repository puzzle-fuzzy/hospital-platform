...
当前线上服务端 release 为 `002acc1b`，小程序构建来源为
`ec26f41f8575871972ac63a8074a9beaec1df55b`（当前本地候选 `ec26f41`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`ec26f41f8575871972ac63a8074a9beaec1df55b`（提交 `ec26f41`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`ec26f41f8575871972ac63a8074a9beaec1df55b`（提交 `ec26f41`）为准。当前真机候选以
`002acc1b` 配套的 `ec26f41` 和完整来源指纹 `ec26f41f8575871972ac63a8074a9beaec1df55b` 为准。
