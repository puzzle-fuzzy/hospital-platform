...
`cdb27e5023a188ab36a340497cebe18f1e274013`（当前本地候选 `cdb27e50`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`cdb27e5023a188ab36a340497cebe18f1e274013`（提交 `cdb27e50`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`cdb27e5023a188ab36a340497cebe18f1e274013`（提交 `cdb27e50`）为准。当前真机候选以
`5a31427` 配套的 `cdb27e50` 和完整来源指纹 `cdb27e5023a188ab36a340497cebe18f1e274013` 为准。
