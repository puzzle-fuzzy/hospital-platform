...
`acf5a8596e70e1fb2b8d220a0b41eb69418ae086`（当前本地候选 `acf5a85`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`acf5a8596e70e1fb2b8d220a0b41eb69418ae086`（提交 `acf5a85`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`acf5a8596e70e1fb2b8d220a0b41eb69418ae086`（提交 `acf5a85`）为准。当前真机候选以
`5a31427` 配套的 `acf5a85` 和完整来源指纹 `acf5a8596e70e1fb2b8d220a0b41eb69418ae086` 为准。
