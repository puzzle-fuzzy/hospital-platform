...
`f3074243e136621d64f296a687c0fb2ca8230991`（当前本地候选 `f307424`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`f3074243e136621d64f296a687c0fb2ca8230991`（提交 `f307424`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`f3074243e136621d64f296a687c0fb2ca8230991`（提交 `f307424`）为准。当前真机候选以
`002acc1b` 配套的 `f307424` 和完整来源指纹 `f3074243e136621d64f296a687c0fb2ca8230991` 为准。
