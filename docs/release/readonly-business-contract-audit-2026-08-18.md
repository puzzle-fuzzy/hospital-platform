...
`f19e4717c01948d12fdcc62040a0bd4ab0ac060f`（当前本地候选 `f19e471`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`f19e4717c01948d12fdcc62040a0bd4ab0ac060f`（提交 `f19e471`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`f19e4717c01948d12fdcc62040a0bd4ab0ac060f`（提交 `f19e471`）为准。当前真机候选以
`5a31427` 配套的 `f19e471` 和完整来源指纹 `f19e4717c01948d12fdcc62040a0bd4ab0ac060f` 为准。
...
1. 使用与服务端 `5a31427` 配套、来源指纹为 `7a6f4df34fac5975c6012a30d2c137953a892059` 的小程序运行包，在有效微信会话下完成登录、患者刷新/显式切换、我的挂号、
   爽约记录和门诊待缴/已缴页面操作；
