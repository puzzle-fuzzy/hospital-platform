...
`968a587158289da6a482b3614907bde0a5ad9581`（当前本地候选 `968a587`，尚未上传线上）；线上只证明运行层和认证边界，域级 Provider/真机证据仍需独立闭环。
...
`968a587158289da6a482b3614907bde0a5ad9581`（提交 `968a587`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`968a587158289da6a482b3614907bde0a5ad9581`（提交 `968a587`）为准。当前真机候选以
`5a31427` 配套的 `968a587` 和完整来源指纹 `968a587158289da6a482b3614907bde0a5ad9581` 为准。
