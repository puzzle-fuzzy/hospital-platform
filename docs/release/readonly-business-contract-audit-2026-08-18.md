...
`3f8274ec5435779c0603ce8475a4f4e86d292cbd`（提交 `3f8274e`），服务端为 `b44421cd321ff9ff23eeb49b12641d1772d2bdc1`。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。当前只读发布已完成，历史 release 的窄观察窗口没有新的
...
`3f8274ec5435779c0603ce8475a4f4e86d292cbd`（提交 `3f8274e`）为准。当前真机候选以
`3f8274e` 小程序候选和服务端 `b44421cd` 的分层配套及完整来源指纹 `3f8274ec5435779c0603ce8475a4f4e86d292cbd` 为准。
