...
当前线上服务端 release 为 `6038560`，小程序构建来源为
...
当前线上 release 以 [`6038560-production-acceptance-2026-08-21.md`](6038560-production-acceptance-2026-08-21.md)
为准；本文记录的 2026-08-18 历史审计使用小程序来源
`d2086d819b3e393da2e8c5c39d7704012854214b`，不作为当前真机候选。当前配套候选为
`6e6604f8089e45ceeaaf4bcbbd57065174a59a31`（提交 `6e6604f`）。新 Bun/Elysia API 与旧 Python API 共存，旧服务没有被停止。历史 `0e360d3` release 的窄观察窗口没有新的
...
`6038560` 配套的 `6e6604f` 和完整来源指纹 `6e6604f8089e45ceeaaf4bcbbd57065174a59a31` 为准。

本节对应的当前服务端生产候选为 `6038560`；下方保留的 `398be8e`、`687690e`、`c26e696` 和 `1b94c46` 说明仅用于追溯当时的代码摘要，不能覆盖当前发布基线。
...
1. 使用与服务端 `6038560` 配套、来源指纹为 `6e6604f8089e45ceeaaf4bcbbd57065174a59a31` 的小程序运行包，在有效微信会话下完成登录、患者刷新/显式切换、我的挂号、
   爽约记录和门诊待缴/已缴页面操作；
