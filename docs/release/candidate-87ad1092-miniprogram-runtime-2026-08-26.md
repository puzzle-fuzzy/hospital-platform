...
> 本候选已被 `dee4803f` 替代；当前真机验收只认 [`candidate-dee4803f-miniprogram-runtime-2026-08-26.md`](candidate-dee4803f-miniprogram-runtime-2026-08-26.md)。本文仅保留上一批电子锦旗、表扬信安全页面迁移证据。
