...
> 本文记录的 `6e6604f`、`02c18af`、`1d161b7` 及更早候选均为历史窗口。当前真机入口是 [`candidate-6677671-local-build-2026-08-21.md`](candidate-6677671-local-build-2026-08-21.md)，ENOENT 修复原则不变，但二维码必须从当前候选重新生成。
