...
> 本文记录的 `6e6604f`、`02c18af`、`1d161b7` 及更早候选均为历史窗口。当前真机入口是 [`candidate-4e82313-local-build-2026-08-21.md`](candidate-4e82313-local-build-2026-08-21.md)，ENOENT 修复原则不变，但二维码必须从当前候选重新生成。
...
## 当前工作树复核（2026-08-21，`4e82313`）

当前小程序运行输入已推进到 `4e82313`，完整来源为
`4e823137b7180390209614ef677c5a71f9c465be`。重新检查后，`dist/services/single-flight.js`
