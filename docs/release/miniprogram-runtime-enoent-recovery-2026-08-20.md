...
> 本文记录的 `6e6604f`、`02c18af`、`1d161b7` 及更早候选均为历史窗口。当前真机入口是 [`candidate-f66514d-local-build-2026-08-21.md`](candidate-f66514d-local-build-2026-08-21.md)，ENOENT 修复原则不变，但二维码必须从当前候选重新生成。
...
## 当前工作树复核（2026-08-21，`f66514d`）

当前小程序运行输入已推进到 `f66514d`，完整来源为
`f66514de81c051cb8ade1477f758700b2837b9b7`。重新检查后，`dist/services/single-flight.js`
