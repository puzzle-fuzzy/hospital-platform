...
> 本文记录的 `6e6604f`、`02c18af`、`1d161b7` 及更早候选均为历史窗口。当前真机入口是 [`candidate-9340846-local-build-2026-08-21.md`](candidate-9340846-local-build-2026-08-21.md)，ENOENT 修复原则不变，但二维码必须从当前候选重新生成。
...
因此，当前只能使用 `9340846` 重新生成的新二维码进行真机验收，必须从“微信登录 → `/me` → 患者同步”开始；
