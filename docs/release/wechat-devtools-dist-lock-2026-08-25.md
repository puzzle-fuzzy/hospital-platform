...
> **当前候选事实（2026-08-26）**：本文下方如果出现 `f97f9f0`、`7f7a7a18` 或 `3b42b86`，均仅表示历史候选；当前待发布运行包是 `d204425`，完整来源为 `d204425420ddc8633260053e32ff042e2b0635c7`，共 40 个页面。发布和真机取证只能使用当前候选，不能使用历史候选的证据清单。
