...
> **当前候选事实（2026-08-26）**：本文下方如果出现 `f97f9f0`、`7f7a7a18` 或 `3b42b86`，均仅表示历史候选；当前待发布运行包是 `ed20c52`，完整来源为 `ed20c525de0f0ae0ed3b047b95b7365b39c4dec9`，共 40 个页面。发布和真机取证只能使用当前候选，不能使用历史候选的证据清单。
