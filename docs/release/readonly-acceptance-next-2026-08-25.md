...
> **当前执行事实（2026-08-27）**：线上服务端 release 为 `5738a71e0bcddaa8849106754baf5b296427bed7`；小程序当前 live 运行包来源为 `ce1c2179b57fe2783066b51f8621220224982928`，包含 38 个页面；公网 HTTPS 已通过无 `-k` TLS 校验。当前没有运行中的微信开发者工具或真机会话，九个真机证据域仍为 `pending`，本手册不能据此宣称真实微信、Provider 或业务完成。当前候选已经原子发布到 live `dist`，不再存在待发布目录。
...
> 当前小程序运行相关源码和 live 运行包来源为 `ce1c2179b57fe2783066b51f8621220224982928`，包含 38 个页面；服务端线上 release 为 `5738a71e0bcddaa8849106754baf5b296427bed7`。
