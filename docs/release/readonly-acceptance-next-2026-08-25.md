...
> `410447b4ee7f19413fb3b3c790c52d51f5806ccb` 已构建到 `.local/hospital-miniprogram/pending/`，待关闭开发者工具后发布。开发者工具必须直接打开
...
4. 只有发布 pending 候选并重新执行 `runtime:verify` 后才生成新的预览/真机二维码；记录运行包候选
   `410447b4` 和微信开发者工具显示的项目根，不能使用旧 `fcc6630e` 二维码验证本次修复。
