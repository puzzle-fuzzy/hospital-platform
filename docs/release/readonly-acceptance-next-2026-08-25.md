...
> 当前本地小程序运行候选：`00924a4a83e41066756d979b7273dc491df1e686`（提交 `00924a4`）。开发者工具必须直接打开
...
4. 预览/真机扫码时记录运行包候选 `00924a4` 和微信开发者工具显示的项目根；本轮二维码位于
   `E:\__Super_Core__\hospital-platform\.local\device-acceptance\00924a4-preview.png`，不能把旧二维码或历史运行包证据归入本候选。
