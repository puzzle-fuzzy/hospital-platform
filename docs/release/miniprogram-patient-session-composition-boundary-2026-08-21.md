...
> 当前配套服务端 release 为 `5a31427`；当前小程序候选为 `f9833c1`，完整运行包来源为 `f9833c11ef0d49591fd14f99ce60ad92d800156a`。本轮只修改本地新项目代码和文档，未部署、未重启旧 Python 服务或新 API，未调用 Provider、医保、支付或 HIS。
