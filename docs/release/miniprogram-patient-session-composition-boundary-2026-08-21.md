...
> 当前配套服务端 release 为 `5a31427`；当前小程序候选为 `d4d65b7`，完整运行包来源为 `d4d65b735da8630e9b6795d9e105192713297474`。本轮只修改本地新项目代码和文档，未部署、未重启旧 Python 服务或新 API，未调用 Provider、医保、支付或 HIS。
...
| `runtime:verify` | 通过；来源 `d4d65b735da8630e9b6795d9e105192713297474`，不含测试脚本 |
