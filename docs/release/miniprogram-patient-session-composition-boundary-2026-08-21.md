...
> 当前配套服务端 release 为 `5a31427`；当前小程序候选为 `8d33a27`，完整运行包来源为 `8d33a27e5aa4c5808449116bd3c3740d7a823e80`。本轮只修改本地新项目代码和文档，未部署、未重启旧 Python 服务或新 API，未调用 Provider、医保、支付或 HIS。
