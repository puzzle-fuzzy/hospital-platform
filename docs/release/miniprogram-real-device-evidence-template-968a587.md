# 小程序当前候选真机三层证据记录模板（`968a587`）

> 当前服务端 release 为 `5a31427`；小程序完整运行包来源为 `968a587158289da6a482b3614907bde0a5ad9581`。空白模板不代表真机或业务验收通过。

| 项目 | 值 |
| --- | --- |
| 服务端 release | `5a31427` |
| 小程序提交 | `968a587` |
| 完整运行包来源 | `968a587158289da6a482b3614907bde0a5ad9581` |
