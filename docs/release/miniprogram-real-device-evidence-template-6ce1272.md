# 历史小程序候选真机三层证据记录模板（`6ce1272`）

> 本模板已被当前候选 `9340846` 替代，不得用于当前真机验收。

> 本文件是空白记录模板，不代表任何业务已验收。每条 `passed` 必须同时具备真机页面、客户端 HTTP 和服务端低敏日志三层证据。
>
> 服务端 release：`5a31427`
> 小程序候选：`6ce1272`
> 运行包来源：必须现场核对 `6ce12729c3e112a6cb8333c5132c23713d1cb1ec`
...
| 微信基础库 | `版本` |
| 开发者工具真机窗口 | `新窗口/窗口标识` |
| `dist/build-info.json.sourceRevision` | 必须等于 `6ce12729c3e112a6cb8333c5132c23713d1cb1ec` |
