# `90d8910b` 新 API 生产共存发布验收记录（2026-08-27）
...
切换前 `current` 为 `1107a78a47ac2fbe0557958251d66da9effc66de`，随后只执行：
...
- `current` 指向 `90d8910bdc54d48dde66c4ff03a7434c182ebd92`，新 API active 并监听 `10.0.0.3:18081`；
...
使用同一 `90d8910b` bundle 对 `https://test-hp.meiyi.pro/api/v2` 验证：
