# 小程序当前候选真机三层证据记录模板（`cdb27e50`）

> 当前服务端 release 为 `5a31427`；小程序完整运行包来源为 `cdb27e5023a188ab36a340497cebe18f1e274013`。空白模板不代表真机或业务验收通过。

| 项目 | 值 |
| --- | --- |
| 服务端 release | `5a31427` |
| 小程序提交 | `cdb27e50` |
| 完整运行包来源 | `cdb27e5023a188ab36a340497cebe18f1e274013` |
