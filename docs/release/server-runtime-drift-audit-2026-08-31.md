...
当前线上候选仍是服务端 release `5738a71e0bcddaa8849106754baf5b296427bed7`。仓库 `main` 已推进到
`7e38827365f352e7f3843989dbfd709c3ab53fc0`，在该线上 release 之后包含 Provider 失败阶段和传输错误码观测、支付/outbox
