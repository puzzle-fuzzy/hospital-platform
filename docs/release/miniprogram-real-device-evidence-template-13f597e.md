...
> 当前小程序配套运行包来源（2026-08-28）：`935410473e5a7c1be125a85834f957f53a833d8f`（`9354104`）；当前无真机/开发者工具会话，九个真机证据域仍为 `pending`。
...
> 当前验收必须使用上方 `5738a71e` / `9354104` 基线。
