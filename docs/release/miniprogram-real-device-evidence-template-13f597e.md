...
> 当前小程序配套运行包来源（2026-08-27）：`76ca0137ea9a57b8b7ed9c8797bb718040535922`（`76ca013`）；当前无真机/开发者工具会话，九个真机证据域仍为 `pending`。
...
> 当前验收必须使用上方 `b44421cd` / `76ca013` 基线。
