...
> 当前小程序配套运行包来源（2026-08-27）：`02865d385a9c09876dc51da1ffb71183139a559b`（`02865d3`）；当前无真机/开发者工具会话，九个真机证据域仍为 `pending`。
...
> 当前验收必须使用上方 `0aaa13b5` / `02865d3` 基线。
