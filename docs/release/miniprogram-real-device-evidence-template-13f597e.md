...
> 当前小程序配套运行包来源（2026-08-27）：`cac6561b3f4ebbae2de8c632b052837fe7bc28b6`（`cac6561`）；当前无真机/开发者工具会话，九个真机证据域仍为 `pending`。
...
> 当前验收必须使用上方 `5738a71e` / `cac6561` 基线。
