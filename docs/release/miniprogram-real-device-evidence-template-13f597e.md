...
> 当前小程序配套运行包来源（2026-08-27）：`d4f67485a34195a2e1e392071502cf2a7006dd27`（`d4f6748`）；当前无真机/开发者工具会话，九个真机证据域仍为 `pending`。
...
> 当前验收必须使用上方 `b44421cd` / `d4f6748` 基线。
