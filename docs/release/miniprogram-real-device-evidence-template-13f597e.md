...
> 当前小程序配套运行包来源（2026-08-28）：`ce1c2179b57fe2783066b51f8621220224982928`（`ce1c217`）；当前无真机/开发者工具会话，九个真机证据域仍为 `pending`。
...
> 当前验收必须使用上方 `5738a71e` / `ce1c217` 基线。
