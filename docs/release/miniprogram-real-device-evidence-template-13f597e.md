...
> 当前小程序配套运行包来源（2026-08-27）：`805c54ea9fa943385ad6feebed1401d521fbad3c`（`805c54e`）；当前无真机/开发者工具会话，九个真机证据域仍为 `pending`。
...
> 当前验收必须使用上方 `b44421cd` / `413cbea` 基线。
