...
> 当前服务端 release 为 `5738a71e0bcddaa8849106754baf5b296427bed7`（`5738a71e`），本地 live 小程序运行输入为 `ce1c2179b57fe2783066b51f8621220224982928`（`ce1c217`）。旧 Python `8001`、旧数据库、旧 Redis 和另一会话负责的众阳预约适配器不在本次审计范围内。
