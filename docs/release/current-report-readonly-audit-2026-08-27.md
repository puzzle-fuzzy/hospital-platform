...
> 当前服务端 release 为 `90d8910bdc54d48dde66c4ff03a7434c182ebd92`（`90d8910b`），本地 live 小程序运行输入为 `90d8910bdc54d48dde66c4ff03a7434c182ebd92`（`90d8910b`）。旧 Python `8001`、旧数据库、旧 Redis 和另一会话负责的众阳预约适配器不在本次审计范围内。
