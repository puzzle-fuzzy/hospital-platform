...
> 当前服务端 release 为 `1107a78a47ac2fbe0557958251d66da9effc66de`（`1107a78a`），本地 live 小程序运行输入为 `6f47c6408fe5b62025bd74fa66893f306eb7b9aa`（`6f47c64`）。旧 Python `8001`、旧数据库、旧 Redis 和另一会话负责的众阳预约适配器不在本次审计范围内。
