...
> 当前服务端 release 为 `1bc8b0a85f21cb58205a99ce4de0de6afe9bf240`（`1bc8b0a8`），本地 live 小程序运行输入为 `90d8910bdc54d48dde66c4ff03a7434c182ebd92`（`90d8910b`）。旧 Python `8001`、旧数据库、旧 Redis 和另一会话负责的众阳预约适配器不在本次审计范围内。
...
| 小程序 | 报告列表首批展示 10 条，后续只扩展已取得的本地窗口 | 切换患者/账号/会话代际后不回写旧报告 |
