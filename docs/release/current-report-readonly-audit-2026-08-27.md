...
> 当前服务端 release 为 `b44421cd321ff9ff23eeb49b12641d1772d2bdc1`（`b44421cd`），本地 live 小程序运行输入为 `d4f67485a34195a2e1e392071502cf2a7006dd27`（`d4f6748`）。旧 Python `8001`、旧数据库、旧 Redis 和另一会话负责的众阳预约适配器不在本次审计范围内。
