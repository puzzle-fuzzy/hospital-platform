...
> 当前服务端 release 为 `1bc8b0a85f21cb58205a99ce4de0de6afe9bf240`（`1bc8b0a8`），本地 live 小程序运行输入为 `99d9f60f6291b7f8d08d779cec059892f054d80e`（`99d9f60`）。旧 Python `8001`、旧数据库、旧 Redis 和另一会话负责的众阳预约适配器不在本次审计范围内。
