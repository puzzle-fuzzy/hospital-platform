...
> 当前服务端 release 为 `5738a71e0bcddaa8849106754baf5b296427bed7`（`5738a71e`），本地 live 小程序运行输入为 `cac6561b3f4ebbae2de8c632b052837fe7bc28b6`（`cac6561`）。旧 Python `8001`、旧数据库、旧 Redis 和另一会话负责的众阳预约适配器不在本次审计范围内。
