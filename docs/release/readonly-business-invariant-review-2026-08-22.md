...
- 服务端当前已验证 release：`8eb51b5ffe85b0b8f8a032783f893117d3df549d`。
- 小程序运行包来源：`6f47c6408fe5b62025bd74fa66893f306eb7b9aa`，40 个页面入口完整，`dist/` 不含 `*.test.js` 或 `*.spec.js`。
...
`6f47c6408fe5b62025bd74fa66893f306eb7b9aa`；真实微信、患者切换和只读业务三层证据仍未产生。
...
- 文档链接审计：Markdown 文档无断链；发布基线指向服务端 `1107a78a47ac2fbe0557958251d66da9effc66de` 和小程序 `6f47c64`（完整来源 `6f47c6408fe5b62025bd74fa66893f306eb7b9aa`）。
...
- `pnpm release:baseline:audit` 与 `pnpm docs:audit`：均通过，当前来源为服务端 `1107a78a` 与小程序 `6f47c64`；本轮无开发者工具或真机业务会话。
...
1. 在微信开发者工具关闭旧真机调试，切换到已打开的 `apps/miniprogram/` 新项目窗口，普通编译并确认 `dist/build-info.json` 来源为 `6f47c6408fe5b62025bd74fa66893f306eb7b9aa`。
