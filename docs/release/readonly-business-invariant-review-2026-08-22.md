...
- 小程序运行包来源：`805c54ea9fa943385ad6feebed1401d521fbad3c`，40 个页面入口完整，`dist/` 不含 `*.test.js` 或 `*.spec.js`。
...
- 文档链接审计：Markdown 文档无断链；发布基线指向服务端 `b44421cd321ff9ff23eeb49b12641d1772d2bdc1` 和小程序 `805c54e`（完整来源 `805c54ea9fa943385ad6feebed1401d521fbad3c`）。
...
1. 在微信开发者工具打开 `apps/miniprogram/` 新项目窗口，普通编译并确认 `dist/build-info.json` 来源为 `805c54ea9fa943385ad6feebed1401d521fbad3c`。
