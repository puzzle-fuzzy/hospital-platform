...
> 当前完整小程序来源校验值：`1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`；当前服务端 release：`5738a71e0bcddaa8849106754baf5b296427bed7`。
...
- 小程序运行包来源：`1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`，38 个页面入口完整，`dist/` 不含 `*.test.js` 或 `*.spec.js`。
...
`1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`；真实微信、患者切换和只读业务三层证据仍未产生。
...
- 文档链接审计：Markdown 文档无断链；发布基线指向服务端 `5738a71e0bcddaa8849106754baf5b296427bed7` 和小程序 `1bc5bf6`（完整来源 `1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`）。
...
- `pnpm release:baseline:audit` 与 `pnpm docs:audit`：均通过，当前来源为服务端 `5738a71e` 与小程序 `1bc5bf6`；本轮无开发者工具或真机业务会话。
...
1. 在微信开发者工具打开 `apps/miniprogram/` 新项目窗口，普通编译并确认 `dist/build-info.json` 来源为 `1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`。
