...
> 当前发布基线：服务端 `49f74e0209778836db41bef6249758b4f590792a`；小程序运行包来源
> `b0e093565493285e07fe549879f8b87eda649cc7`。本次不把历史 journald 窗口升级为当前业务证据。

> 本记录只覆盖新项目 `hospital-platform`。旧 Python 项目、旧 API、旧数据库表和旧服务进程均未修改。

## 1. 当前版本与运行边界

- 服务端当前 release：`49f74e0209778836db41bef6249758b4f590792a`。
