...
> 当前完整小程序来源校验值：`ce1c2179b57fe2783066b51f8621220224982928`；当前服务端 release：`5738a71e0bcddaa8849106754baf5b296427bed7`。
...
- 小程序运行包来源：`ce1c2179b57fe2783066b51f8621220224982928`，38 个页面入口完整，`dist/` 不含 `*.test.js` 或 `*.spec.js`。
...
`ce1c2179b57fe2783066b51f8621220224982928`；真实微信、患者切换和只读业务三层证据仍未产生。
...
- 文档链接审计：Markdown 文档无断链；发布基线指向服务端 `5738a71e0bcddaa8849106754baf5b296427bed7` 和小程序 `ce1c217`（完整来源 `ce1c2179b57fe2783066b51f8621220224982928`）。
...
- `pnpm release:baseline:audit` 与 `pnpm docs:audit`：均通过，当前来源为服务端 `5738a71e` 与小程序 `ce1c217`；本轮无开发者工具或真机业务会话。
...
1. 在微信开发者工具打开 `apps/miniprogram/` 新项目窗口，普通编译并确认 `dist/build-info.json` 来源为 `ce1c2179b57fe2783066b51f8621220224982928`。
