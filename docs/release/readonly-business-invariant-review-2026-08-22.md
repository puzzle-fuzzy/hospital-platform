...
> 当前完整小程序来源校验值：`02865d385a9c09876dc51da1ffb71183139a559b`；当前服务端 release：`0aaa13b53cb6e21b59b332dbd4e2b982a5aba1e7`。
...
- 服务端当前已验证 release：`0aaa13b53cb6e21b59b332dbd4e2b982a5aba1e7`。
- 小程序运行包来源：`02865d385a9c09876dc51da1ffb71183139a559b`，40 个页面入口完整，`dist/` 不含 `*.test.js` 或 `*.spec.js`。
...
`02865d385a9c09876dc51da1ffb71183139a559b`；真实微信、患者切换和只读业务三层证据仍未产生。
...
- 文档链接审计：Markdown 文档无断链；发布基线指向服务端 `0aaa13b53cb6e21b59b332dbd4e2b982a5aba1e7` 和小程序 `02865d3`（完整来源 `02865d385a9c09876dc51da1ffb71183139a559b`）。
...
- `pnpm release:baseline:audit` 与 `pnpm docs:audit`：均通过，当前来源为服务端 `0aaa13b5` 与小程序 `02865d3`；本轮无开发者工具或真机业务会话。
...
1. 在微信开发者工具打开 `apps/miniprogram/` 新项目窗口，普通编译并确认 `dist/build-info.json` 来源为 `02865d385a9c09876dc51da1ffb71183139a559b`。
