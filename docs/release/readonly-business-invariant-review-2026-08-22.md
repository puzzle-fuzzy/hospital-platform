...
> 当前完整小程序来源校验值：`413cbea13f022831f63e9c750661eeabbffc68d5`；当前服务端 release：`b44421cd321ff9ff23eeb49b12641d1772d2bdc1`。
...
- 小程序运行包来源：`413cbea13f022831f63e9c750661eeabbffc68d5`，40 个页面入口完整，`dist/` 不含 `*.test.js` 或 `*.spec.js`。
...
`413cbea13f022831f63e9c750661eeabbffc68d5`；真实微信、患者切换和只读业务三层证据仍未产生。
...
- 文档链接审计：Markdown 文档无断链；发布基线指向服务端 `b44421cd321ff9ff23eeb49b12641d1772d2bdc1` 和小程序 `413cbea`（完整来源 `413cbea13f022831f63e9c750661eeabbffc68d5`）。
...
- `pnpm release:baseline:audit` 与 `pnpm docs:audit`：均通过，当前来源为服务端 `b44421cd` 与小程序 `413cbea`；本轮无开发者工具或真机业务会话。
...
1. 在微信开发者工具打开 `apps/miniprogram/` 新项目窗口，普通编译并确认 `dist/build-info.json` 来源为 `413cbea13f022831f63e9c750661eeabbffc68d5`。
