...
`90fd7832e3ad1031c9c916f118f90cc0f2840aff`；真实微信、患者切换和只读业务三层证据仍未产生。
...
1. 在微信开发者工具关闭旧真机调试，切换到已打开的 `apps/miniprogram/` 新项目窗口，普通编译并确认 `dist/build-info.json` 来源为 `90fd7832e3ad1031c9c916f118f90cc0f2840aff`。
