...
> 当前完整小程序来源校验值：`935410473e5a7c1be125a85834f957f53a833d8f`；当前服务端 release：`5738a71e0bcddaa8849106754baf5b296427bed7`。
...
- 小程序运行包来源：`935410473e5a7c1be125a85834f957f53a833d8f`，38 个页面入口完整，`dist/` 不含 `*.test.js` 或 `*.spec.js`。
...
`3f8274ec5435779c0603ce8475a4f4e86d292cbd`；真实微信、患者切换和只读业务三层证据仍未产生。
...
- 文档链接审计：Markdown 文档无断链；发布基线指向服务端 `5738a71e0bcddaa8849106754baf5b296427bed7` 和小程序 `9354104`（完整来源 `935410473e5a7c1be125a85834f957f53a833d8f`）。
...
1. 在微信开发者工具打开 `apps/miniprogram/` 新项目窗口，普通编译并确认 `dist/build-info.json` 来源为 `935410473e5a7c1be125a85834f957f53a833d8f`。
