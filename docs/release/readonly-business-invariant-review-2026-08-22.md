...
- 文档链接审计：Markdown 文档无断链；发布基线指向服务端 `1e58bb66bf24021d2b680eb5fd03abfec467989a` 和小程序 `41c708e1`。
...
- `pnpm release:baseline:audit` 与 `pnpm docs:audit`：均通过，当前来源为服务端 `1e58bb66`、小程序 `41c708e1`。
