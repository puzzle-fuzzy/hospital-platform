...
>
> 本文第 1-6 节是历史核对与 `b186098` 切换结果；当前 release 已进一步切换为 `131fb5a`，请以
> [`131fb5a-production-acceptance-2026-08-17.md`](131fb5a-production-acceptance-2026-08-17.md) 的当前运行证据为准。
