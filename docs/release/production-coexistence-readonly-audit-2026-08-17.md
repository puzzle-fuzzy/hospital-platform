...
>
> 本文第 1-6 节是历史核对与 `b186098` 切换结果；当前 release 已进一步切换为 `9833a01`，请以
> [`9833a01-production-acceptance-2026-08-17.md`](9833a01-production-acceptance-2026-08-17.md) 的当前运行证据为准。
...
- 该历史快照中的 release 指针为 `41c9c18`，不等于当前线上版本；当前线上 release 已切换为 `9833a01`，以对应的当前生产验收文档为准。
