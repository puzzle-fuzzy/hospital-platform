# 小程序当前候选真机三层证据记录模板（`acf5a85`）

> 当前服务端 release 为 `5a31427`；小程序完整运行包来源为 `acf5a8596e70e1fb2b8d220a0b41eb69418ae086`。空白模板不代表真机或业务验收通过。
...
| 服务端 release | `5a31427` |
| 小程序提交 | `acf5a85` |
| 完整运行包来源 | `acf5a8596e70e1fb2b8d220a0b41eb69418ae086` |
