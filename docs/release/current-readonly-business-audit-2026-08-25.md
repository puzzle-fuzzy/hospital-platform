...
> **当前事实纠正（2026-08-25）**：本文主体记录的是早期 `eef55001/b587c7ea` 审计窗口，不能作为当前运行包证据。当前功能候选代码基线为 `923074bc`，小程序 pending 来源为 `296516a5`，服务端本地候选为 `b42922f4`；当前 9 个只读业务域的证据状态以 [`device-evidence-296516a5-pending.json`](device-evidence-296516a5-pending.json) 和 [`../migration/full-migration-handoff-2026-08-25.md`](../migration/full-migration-handoff-2026-08-25.md) 为准。

> **当前本地源码候选纠正（2026-08-25）**：功能候选为 `eef550012e071d2891f990035a9b40041f314e5d`，最新 pending 运行包来源同为 `eef550012e071d2891f990035a9b40041f314e5d`，原生页面 20 个，当前工作树复跑为 `259 pass / 0 fail / 2525 expect()`；当前 live `dist` 仍为 `fcc6630ebfa7b0697cbd03a5e376ce6765d1643b`，线上配套小程序仍为 `13f597e`。下方旧候选内容只作历史交接。

> `eef55001` 本轮只补齐报告详情的显式重试和会话/患者边界复核，不改变报告真实 Provider、附件、支付或医保的关闭状态；全量迁移仍按 64 个旧入口台账和四条批次队列推进。
