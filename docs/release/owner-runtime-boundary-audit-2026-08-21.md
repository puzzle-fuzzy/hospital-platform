...
> 当前发布基线：服务端 `5a31427`；小程序候选 `4e82313`；完整运行包来源
> `4e823137b7180390209614ef677c5a71f9c465be`。本轮代码尚未部署，不代表真实 Provider 或真机验收完成。
...
先完成 API 全量测试、运行包来源和文档基线复核，再提交本轮代码。随后仍需使用当前 `4e82313` 候选采集真实微信会话、
