...
> 当前发布基线：服务端 `5a31427`；小程序候选 `5c06929`；完整运行包来源
> `5c069290e8f26f1e4d22742a8c7a4b4ad18ca3d6`。本轮代码尚未部署，不代表真实 Provider 或真机验收完成。
...
先完成 API 全量测试、运行包来源和文档基线复核，再提交本轮代码。随后仍需使用当前 `5c06929` 候选采集真实微信会话、
