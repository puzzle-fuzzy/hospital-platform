...
> 当前发布基线：服务端 `5a31427`；小程序候选 `cde7bc9`；完整运行包来源
> `cde7bc90a23698398e9474944adf42b36f37982c`。本轮代码尚未部署，不代表真实 Provider 或真机验收完成。
...
| Biome 定向检查 | 通过 |
| 当前 release baseline / 文档断链审计 | 通过；分别为 `5a31427 + cde7bc9`、395 个文档无断链 |
...
先完成 API 全量测试、运行包来源和文档基线复核，再提交本轮代码。随后仍需使用当前 `cde7bc9` 候选采集真实微信会话、
