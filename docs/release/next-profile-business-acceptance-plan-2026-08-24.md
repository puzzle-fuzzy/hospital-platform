...
| 小程序候选 | `21af93b4d398e3d424aba9506c7bfbef9a3cfbd8` | 使用微信原生 `tabBar`，直接打开 `apps/miniprogram/dist/` 独立工程；自定义底栏已移除，仍需真机验收 |
...
```text
   [医院小程序] 运行包来源：微信原生 tabBar；revision=21af93b4d398e3d424aba9506c7bfbef9a3cfbd8
```
