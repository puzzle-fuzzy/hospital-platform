...
| 小程序候选 | `f18e411e50ed360b5c74ab3e6d86bf1fafd02fd4` | 项目最终固定使用微信原生 `tabBar`，直接打开 `apps/miniprogram/dist/` 独立工程；自定义底栏不再引入，仍需真机验收 |
...
```text
   [医院小程序] 运行包来源：微信原生 tabBar；revision=f18e411e50ed360b5c74ab3e6d86bf1fafd02fd4
```
