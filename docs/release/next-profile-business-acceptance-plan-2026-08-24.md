...
| 小程序候选 | `cb4027e3f889c2378f17b321f26fd4156f4d3231` | 项目最终固定使用微信原生 `tabBar`，直接打开 `apps/miniprogram/dist/` 独立工程；自定义底栏不再引入，仍需真机验收 |
...
```text
   [医院小程序] 运行包来源：微信原生 tabBar；revision=cb4027e3f889c2378f17b321f26fd4156f4d3231
```
