...
| 小程序候选 | `7fc22fae975d207d66cd248de01ac0287492f800` | 使用微信原生 `tabBar`，直接打开 `apps/miniprogram/dist/` 独立工程；不含页面级底栏或 `custom-tab-bar/`，构建与运行包校验已通过 |
...
```text
[医院小程序] 运行包来源：微信原生 TabBar；revision=7fc22fae975d207d66cd248de01ac0287492f800
```
