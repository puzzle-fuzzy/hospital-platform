...
>
> 证据窗口截止于 `b186098` 切换后的历史日志。当前线上 release 已进一步切换为 `131fb5a`，其发布和切换后
> smoke 结果以 [`131fb5a-production-acceptance-2026-08-17.md`](131fb5a-production-acceptance-2026-08-17.md)
