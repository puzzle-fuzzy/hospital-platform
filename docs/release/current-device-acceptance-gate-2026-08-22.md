...
> 当前尚无与 `171a874` 配套的有效二维码现场记录；必须从当前运行包重新普通编译并生成二维码，在手机扫码前仍不得宣称真机业务完成。
...
后续真机验收只接受小程序源码/运行包来源 `171a8743185fb4ecc1696851662659c1a0ee7ebf`，服务端配套基线为
`0e2a366efcca8da25d7edd4a286781f2d3dfdbec`。前文 `b0e0935`、`4e1b2e2`、`1b621f07` 和 `7181e99e` 的具体时间段均为历史证据，
不覆盖本节当前事实。

当前 `dist/build-info.json` 已验证为 `171a8743185fb4ecc1696851662659c1a0ee7ebf`，14 个页面齐全，运行包没有
...
| 小程序运行包来源 | `171a8743185fb4ecc1696851662659c1a0ee7ebf` |
| 小程序短提交 | `171a874` |
