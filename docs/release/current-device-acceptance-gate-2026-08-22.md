...
后续真机验收只接受小程序源码/运行包来源 `a64fe023bc34fe6e44f93846c39e202fe02d64a5`，服务端配套基线为
`84370077024762d92050cf077c27f3c60302e8f8`。前文 `b0e0935`、`4e1b2e2`、`1b621f07` 和 `7181e99e` 的具体时间段均为历史证据，
不覆盖本节当前事实。

当前 `dist/build-info.json` 已验证为 `a64fe023bc34fe6e44f93846c39e202fe02d64a5`，14 个页面齐全，运行包没有
...
| 小程序运行包来源 | `a64fe023bc34fe6e44f93846c39e202fe02d64a5` |
| 小程序短提交 | `a64fe023` |
