...
后续真机验收只接受小程序源码/运行包来源 `e9ffd8276a33bd69d850618b37ed041ecc4b65cd`，服务端配套基线为
`9f479c9a`。前文 `b0e0935`、`4e1b2e2`、`1b621f07` 和 `7181e99e` 的具体时间段均为历史证据，
不覆盖本节当前事实。

当前 `dist/build-info.json` 已验证为 `e9ffd8276a33bd69d850618b37ed041ecc4b65cd`，14 个页面齐全，运行包没有
