...
后续真机验收只接受小程序源码/运行包来源 `5e43aed0e026cd48d980d58c468223b9a5ee8744`，服务端配套基线为
`1e58bb66bf24021d2b680eb5fd03abfec467989a`。前文 `b0e0935`、`4e1b2e2`、`1b621f07` 和 `7181e99e` 的具体时间段均为历史证据，
不覆盖本节当前事实。

当前 `dist/build-info.json` 已验证为 `5e43aed0e026cd48d980d58c468223b9a5ee8744`，14 个页面齐全，运行包没有
...
| 小程序运行包来源 | `5e43aed0e026cd48d980d58c468223b9a5ee8744` |
| 小程序短提交 | `5e43aed` |
