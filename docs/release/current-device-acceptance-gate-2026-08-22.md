...
后续真机验收只接受小程序源码/运行包来源 `9eb672b1296f282fc536f72bb897631683e4532f`，服务端配套基线为
`9f479c9a`。前文 `b0e0935`、`4e1b2e2` 和 `7181e99e` 的具体时间段均为历史证据，
不覆盖本节当前事实。

当前 `dist/build-info.json` 已验证为 `9eb672b1296f282fc536f72bb897631683e4532f`，14 个页面齐全，运行包没有
