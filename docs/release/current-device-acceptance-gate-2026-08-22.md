...
后续真机验收只接受小程序源码/运行包来源 `1b621f07ab8cec04f76fc8b682d0b3114ef6e3a1`，服务端配套基线为
`9f479c9a`。前文 `b0e0935`、`4e1b2e2` 和 `7181e99e` 的具体时间段均为历史证据，
不覆盖本节当前事实。

当前 `dist/build-info.json` 已验证为 `1b621f07ab8cec04f76fc8b682d0b3114ef6e3a1`，14 个页面齐全，运行包没有
