...
> 当前服务端发布基线（2026-08-22）：`0e2a366efcca8da25d7edd4a286781f2d3dfdbec`；小程序来源为 `ba1dd23e0f40191745a60997939b31b4c47795cd`。报告 Provider 仍保持 fail-closed。
...
`ba1dd23e0f40191745a60997939b31b4c47795cd` 重新执行报告相关回归，并复核了报告目录、详情、附件和页面
