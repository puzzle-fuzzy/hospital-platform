...
> 当前服务端发布基线（2026-08-22 18:55 CST）：`0e2a366efcca8da25d7edd4a286781f2d3dfdbec`；小程序来源为 `a64fe023bc34fe6e44f93846c39e202fe02d64a5`。本记录只保留运行层发布已完成、真机业务证据待补的边界。
...
| 小程序提交 | `a64fe023` |
| 运行包来源 | `a64fe023bc34fe6e44f93846c39e202fe02d64a5` |
| 页面数量 | 14 |
...
- 重新执行 `pnpm --filter @hospital/miniprogram build` 和 `runtime:verify`，运行包来源为 `a64fe023`，14 个页面入口齐全；
...
1. 人工确认正确项目并扫描 `a64fe023` 当前候选调试二维码；
2. 扫码确认微信会话建立；
