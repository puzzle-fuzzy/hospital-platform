...
> 当前候选更新（2026-08-24）：服务端 release 为 `13f597ea9ee3f65b9be858117826d948339d904a`，小程序运行包来源为同一完整 SHA（提交 `13f597e`）。本文下方的 `171a874`、`0e2a366e` 和历史测试数字保留为 2026-08-22 追溯证据，不作为当前验收依据；当前报告 Provider 目录/详情 gate 仍关闭，当前候选尚无 Provider 或真机三层业务证据。

本文本轮仅补充当前候选边界，不修改旧 Python 项目、旧服务、线上反向代理、MySQL、Redis 或众阳 Provider 自动化采集。

## 审计范围

本次以当前候选小程序源码 `171a8743185fb4ecc1696851662659c1a0ee7ebf` 和服务端 release
`0e2a366efcca8da25d7edd4a286781f2d3dfdbec` 为准，复核旧端报告查询页的真实请求链、新端报告目录/详情
