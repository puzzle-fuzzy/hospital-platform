...
> 当前线上 release 已在后续窗口切换为 `527d163`；本文件保留早期只读观察，最新发布、认证边界和
> 新旧服务共存证据见 [`527d163-production-acceptance-2026-08-17.md`](527d163-production-acceptance-2026-08-17.md)。
