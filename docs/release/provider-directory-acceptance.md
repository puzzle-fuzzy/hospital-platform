...
认证边界和旧服务共存证据，统一见 [`687690e-production-acceptance-2026-08-18.md`](687690e-production-acceptance-2026-08-18.md)。
...
- 迁移阶段 release：`b1b84d7`、`ca3a877`；当日历史生产 release：`b186098`。该段记录用于解释
  ...
  [`687690e-production-acceptance-2026-08-18.md`](687690e-production-acceptance-2026-08-18.md)为准。
