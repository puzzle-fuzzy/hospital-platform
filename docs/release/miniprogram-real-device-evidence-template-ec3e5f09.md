# 小程序当前候选真机三层证据记录模板（`ec3e5f09`）

> 当前服务端 release 为 `5a31427`；小程序完整运行包来源为 `ec3e5f094ecd0a85bbf98d4fc6ff9f14b27bb9ac`。空白模板不代表真机或业务验收通过。

| 项目 | 值 |
| --- | --- |
| 服务端 release | `5a31427` |
| 小程序提交 | `ec3e5f09` |
| 完整运行包来源 | `ec3e5f094ecd0a85bbf98d4fc6ff9f14b27bb9ac` |
