...
- 当前线上服务端 release 为 `b7c9451`，配套小程序构建来源为
  `534871549517080807c7e5c1375247477f422750`（当前本地候选，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`534871549517080807c7e5c1375247477f422750`（当前本地候选，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
