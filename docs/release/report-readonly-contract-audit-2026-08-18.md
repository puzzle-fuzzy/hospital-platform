...
- 当前线上服务端 release 为 `b44421cd`，配套小程序构建来源为
  `76ca0137ea9a57b8b7ed9c8797bb718040535922`（当前候选 `76ca013`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
当前服务端 release 为 `b44421cd`，配套小程序构建来源为
`76ca0137ea9a57b8b7ed9c8797bb718040535922`（当前候选 `76ca013`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
