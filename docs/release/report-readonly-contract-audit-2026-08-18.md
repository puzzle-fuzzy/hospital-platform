...
> `7f09bbb2cf32d4753795bcbc91fe23ec05eeeee6`。报告目录/详情 gate 仍关闭，本次不进行真实报告数据验收。
...
- 当前线上服务端 release 为 `84370077`，配套小程序构建来源为
  `7f09bbb2cf32d4753795bcbc91fe23ec05eeeee6`（当前候选 `7f09bbb`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`7f09bbb2cf32d4753795bcbc91fe23ec05eeeee6`（当前候选 `7f09bbb`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
