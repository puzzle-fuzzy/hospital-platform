...
- 当前线上服务端 release 为 `9f479c9a`，配套小程序构建来源为
  `937bb2ad2c71a2e83fac679939d31ed6bb3f0996`（当前候选 `937bb2ad`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`937bb2ad2c71a2e83fac679939d31ed6bb3f0996`（当前候选 `937bb2ad`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
