...
- 当前线上服务端 release 为 `1bc8b0a8`，配套小程序构建来源为
  `99d9f60f6291b7f8d08d779cec059892f054d80e`（当前候选 `99d9f60`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
当前服务端 release 为 `1bc8b0a8`，配套小程序构建来源为
`99d9f60f6291b7f8d08d779cec059892f054d80e`（当前候选 `99d9f60`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
