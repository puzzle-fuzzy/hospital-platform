...
- 当前线上服务端 release 为 `968af78`，配套小程序构建来源为
  `48ba22f16cb0f1d1098895772e660a3ed96761bb`（当前本地候选 `48ba22f`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
当前服务端 release 为 `968af78`，配套小程序构建来源为
