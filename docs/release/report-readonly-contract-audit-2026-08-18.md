...
- 当前线上服务端 release 为 `b44421cd`，配套小程序构建来源为
  `d4f67485a34195a2e1e392071502cf2a7006dd27`（当前候选 `d4f6748`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`d4f67485a34195a2e1e392071502cf2a7006dd27`（当前候选 `d4f6748`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
