...
- 当前线上服务端 release 为 `002acc1b`，配套小程序构建来源为
  `ec26f41f8575871972ac63a8074a9beaec1df55b`（当前本地候选 `ec26f41`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
当前服务端 release 为 `002acc1b`，配套小程序构建来源为
`ec26f41f8575871972ac63a8074a9beaec1df55b`（当前本地候选 `ec26f41`，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
