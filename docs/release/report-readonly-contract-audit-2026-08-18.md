...
- 当前线上服务端 release 为 `0e2a366e`，配套小程序构建来源为
  `4ba492a3fdae8283409bd2ab4a0a45247c46600c`（当前候选 `4ba492a`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`4ba492a3fdae8283409bd2ab4a0a45247c46600c`（当前候选 `4ba492a`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
