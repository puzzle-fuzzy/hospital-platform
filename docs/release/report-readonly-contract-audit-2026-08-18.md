...
- 当前线上服务端 release 为 `5a31427`，配套小程序构建来源为
  `03d9d25d80d5a5d872a9137c7df0aa19a91ba38f`（当前本地候选 `03d9d25`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`03d9d25d80d5a5d872a9137c7df0aa19a91ba38f`（当前本地候选 `03d9d25`，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
