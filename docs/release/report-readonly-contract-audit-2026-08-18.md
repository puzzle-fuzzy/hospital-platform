...
- 当前线上服务端 release 为 `5738a71e`，配套小程序构建来源为
  `1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`（当前候选 `1bc5bf6`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`（当前候选 `1bc5bf6`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
...
配套小程序构建来源为 `1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`。
