...
> `b0e093565493285e07fe549879f8b87eda649cc7`。报告目录/详情 gate 仍关闭，本次不进行真实报告数据验收。
...
- 当前线上服务端 release 为 `49f74e0`，配套小程序构建来源为
  `b0e093565493285e07fe549879f8b87eda649cc7`（当前候选 `b0e0935`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
当前服务端 release 为 `49f74e0`，配套小程序构建来源为
`b0e093565493285e07fe549879f8b87eda649cc7`（当前候选 `b0e0935`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
