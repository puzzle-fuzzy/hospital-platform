...
- 当前线上服务端 release 为 `7181e99e`，配套小程序构建来源为
  `4e1b2e224964797c103eba832323ee7074c7ad2b`（当前本地候选 `4e1b2e2`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
当前服务端 release 为 `7181e99e`，配套小程序构建来源为
`4e1b2e224964797c103eba832323ee7074c7ad2b`（当前本地候选 `4e1b2e2`，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
