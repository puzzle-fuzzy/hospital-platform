...
- 当前线上服务端 release 为 `0e360d3`，配套小程序构建来源为
  `3a6bf3ea3d2b8944e05ffcad254a37afdbca2aab`（当前本地候选 `3a6bf3e`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`3a6bf3ea3d2b8944e05ffcad254a37afdbca2aab`（当前本地候选 `3a6bf3e`，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
