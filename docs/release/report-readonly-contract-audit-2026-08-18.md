...
> `41c708e1adf864ef6fef1f788e97aa8fb4371227`。报告目录/详情 gate 仍关闭，本次不进行真实报告数据验收。
...
- 当前线上服务端 release 为 `1e58bb66`，配套小程序构建来源为
  `41c708e1adf864ef6fef1f788e97aa8fb4371227`（当前候选 `41c708e1`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
当前服务端 release 为 `1e58bb66`，配套小程序构建来源为
`41c708e1adf864ef6fef1f788e97aa8fb4371227`（当前候选 `41c708e1`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
