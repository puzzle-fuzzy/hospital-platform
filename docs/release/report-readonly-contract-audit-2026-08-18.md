...
- 当前线上服务端 release 为 `0aaa13b5`，配套小程序构建来源为
  `02865d385a9c09876dc51da1ffb71183139a559b`（当前候选 `02865d3`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
当前服务端 release 为 `0aaa13b5`，配套小程序构建来源为
`02865d385a9c09876dc51da1ffb71183139a559b`（当前候选 `02865d3`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
...
配套小程序构建来源为 `02865d385a9c09876dc51da1ffb71183139a559b`。
