...
- 当前线上服务端 release 为 `b44421cd`，配套小程序构建来源为
  `413cbea13f022831f63e9c750661eeabbffc68d5`（当前候选 `413cbea`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`413cbea13f022831f63e9c750661eeabbffc68d5`（当前候选 `413cbea`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
