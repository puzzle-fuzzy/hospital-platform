...
> `5b4b0667d76ce443290116352d27f5eb94eba49c`。报告目录/详情 gate 仍关闭，本次不进行真实报告数据验收。
...
- 当前线上服务端 release 为 `9f479c9a`，配套小程序构建来源为
  `5b4b0667d76ce443290116352d27f5eb94eba49c`（当前候选 `5b4b066`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`5b4b0667d76ce443290116352d27f5eb94eba49c`（当前候选 `5b4b066`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
