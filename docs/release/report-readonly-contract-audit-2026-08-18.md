...
- 当前线上服务端 release 为 `1bc8b0a8`，配套小程序构建来源为
  `62cdb8f82b4169dd1b9a6ed3403e3be2f7422328`（当前候选 `62cdb8f`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`62cdb8f82b4169dd1b9a6ed3403e3be2f7422328`（当前候选 `62cdb8f`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
