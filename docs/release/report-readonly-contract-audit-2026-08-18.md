...
- 当前线上服务端 release 为 `5738a71e`，配套小程序构建来源为
  `3f8274ec5435779c0603ce8475a4f4e86d292cbd`（当前候选 `3f8274e`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`3f8274ec5435779c0603ce8475a4f4e86d292cbd`（当前候选 `3f8274e`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
...
配套小程序构建来源为 `3f8274ec5435779c0603ce8475a4f4e86d292cbd`。
