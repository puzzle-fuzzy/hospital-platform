...
- 当前线上服务端 release 为 `0e360d3`，配套小程序构建来源为
  `457d9aee567bc77c33279a9b61db921e3011f1c1`（当前本地候选 `457d9ae`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`457d9aee567bc77c33279a9b61db921e3011f1c1`（当前本地候选 `457d9ae`，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
