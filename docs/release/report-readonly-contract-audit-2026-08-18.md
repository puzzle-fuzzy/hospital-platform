...
- 当前线上服务端 release 为 `968af78`，配套小程序构建来源为
  `482288496c6de90ff86fb2f2eb54db3b9ae0bae5`（当前本地候选 `4822884`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`482288496c6de90ff86fb2f2eb54db3b9ae0bae5`（当前本地候选 `4822884`，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
