...
- 当前线上服务端 release 为 `e5d941ae`，配套小程序构建来源为
  `1691f2db1399419d81a1febff59cffd0369130ea`（当前候选 `1691f2d`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`1691f2db1399419d81a1febff59cffd0369130ea`（当前候选 `1691f2d`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
