...
> `5e43aed0e026cd48d980d58c468223b9a5ee8744`。报告目录/详情 gate 仍关闭，本次不进行真实报告数据验收。
...
- 当前线上服务端 release 为 `1e58bb66`，配套小程序构建来源为
  `5e43aed0e026cd48d980d58c468223b9a5ee8744`（当前候选 `5e43aed`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`5e43aed0e026cd48d980d58c468223b9a5ee8744`（当前候选 `5e43aed`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
