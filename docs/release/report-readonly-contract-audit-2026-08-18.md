...
- 当前线上服务端 release 为 `5a31427`，配套小程序构建来源为
  `f9833c11ef0d49591fd14f99ce60ad92d800156a`（当前本地候选 `f9833c1`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`f9833c11ef0d49591fd14f99ce60ad92d800156a`（当前本地候选 `f9833c1`，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
