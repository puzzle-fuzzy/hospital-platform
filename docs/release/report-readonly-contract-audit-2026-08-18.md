...
- 当前线上服务端 release 为 `0e2a366e`，配套小程序构建来源为
  `171a8743185fb4ecc1696851662659c1a0ee7ebf`（当前候选 `171a874`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`171a8743185fb4ecc1696851662659c1a0ee7ebf`（当前候选 `171a874`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
