...
- 当前线上服务端 release 为 `28a5c0c1`，配套小程序构建来源为
  `13f597ea9ee3f65b9be858117826d948339d904a`（当前候选 `13f597e`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
当前服务端 release 为 `28a5c0c1`，配套小程序构建来源为
`13f597ea9ee3f65b9be858117826d948339d904a`（当前候选 `13f597e`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
