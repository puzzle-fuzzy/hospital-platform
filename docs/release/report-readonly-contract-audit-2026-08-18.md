...
- 当前线上服务端 release 为 `e5d941ae`，配套小程序构建来源为
  `0be59f966de2c3a0861cb44e9a526a1ef557f6c7`（当前候选 `0be59f96`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`0be59f966de2c3a0861cb44e9a526a1ef557f6c7`（当前候选 `0be59f96`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
