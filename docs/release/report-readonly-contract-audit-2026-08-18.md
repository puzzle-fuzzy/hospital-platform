...
- 当前线上服务端 release 为 `c8eef370`，配套小程序构建来源为
  `f488c6f3270514af10b19fdf3c45a47519e1736b`（当前本地候选 `f488c6f3`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
当前服务端 release 为 `c8eef370`，配套小程序构建来源为
`f488c6f3270514af10b19fdf3c45a47519e1736b`（当前本地候选 `f488c6f3`，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
