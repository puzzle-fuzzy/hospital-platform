...
- 当前线上服务端 release 为 `002acc1b`，配套小程序构建来源为
  `90fd7832e3ad1031c9c916f118f90cc0f2840aff`（当前本地候选 `90fd783`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
当前服务端 release 为 `84fac75c`，配套小程序构建来源为
`90fd7832e3ad1031c9c916f118f90cc0f2840aff`（当前本地候选 `90fd783`，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
