...
- 当前线上服务端 release 为 `398be8e`，配套小程序构建来源为
  `474b0444736599c848a4cef9f47fd930884e401d`（当前本地候选 `474b044`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
当前服务端 release 为 `398be8e`，配套小程序构建来源为
`48ba22f16cb0f1d1098895772e660a3ed96761bb`（当前本地候选 `48ba22f`，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
