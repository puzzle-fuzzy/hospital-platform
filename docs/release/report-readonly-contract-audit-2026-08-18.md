...
- 当前线上服务端 release 为 `1bc8b0a8`，配套小程序构建来源为
  `f1b8b61609e0560d3da3fe176f62ab3585b6ee98`（当前候选 `f1b8b61`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`f1b8b61609e0560d3da3fe176f62ab3585b6ee98`（当前候选 `f1b8b61`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
