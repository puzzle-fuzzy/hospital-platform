...
> `ba1dd23e0f40191745a60997939b31b4c47795cd`。报告目录/详情 gate 仍关闭，本次不进行真实报告数据验收。
...
- 当前线上服务端 release 为 `0e2a366e`，配套小程序构建来源为
  `ba1dd23e0f40191745a60997939b31b4c47795cd`（当前候选 `ba1dd23`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
当前服务端 release 为 `0e2a366e`，配套小程序构建来源为
`ba1dd23e0f40191745a60997939b31b4c47795cd`（当前候选 `ba1dd23`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
