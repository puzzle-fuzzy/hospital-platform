...
> `a33416d8417661fa5256deb22df55a97456cc608`。报告目录/详情 gate 仍关闭，本次不进行真实报告数据验收。
...
- 当前线上服务端 release 为 `9f479c9a`，配套小程序构建来源为
  `a33416d8417661fa5256deb22df55a97456cc608`（当前候选 `a33416d8`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`a33416d8417661fa5256deb22df55a97456cc608`（当前候选 `a33416d8`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
