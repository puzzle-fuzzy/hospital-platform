...
- 当前线上服务端 release 为 `002acc1b`，配套小程序构建来源为
  `341524ac345d9cfae3f6e0f8258aed3e9457f458`（当前本地候选 `341524a`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`341524ac345d9cfae3f6e0f8258aed3e9457f458`（当前本地候选 `341524a`，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
