...
- 当前线上服务端 release 为 `b7c9451`，配套小程序构建来源为
  `379eae2a528265df900030cea6e8dc45a82902c1`（当前本地候选，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`379eae2a528265df900030cea6e8dc45a82902c1`（当前本地候选，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
