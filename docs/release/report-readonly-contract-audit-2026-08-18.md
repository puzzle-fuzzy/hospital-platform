...
- 当前线上服务端 release 为 `5738a71e`，配套小程序构建来源为
  `ce1c2179b57fe2783066b51f8621220224982928`（当前候选 `ce1c217`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`ce1c2179b57fe2783066b51f8621220224982928`（当前候选 `ce1c217`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
...
配套小程序构建来源为 `ce1c2179b57fe2783066b51f8621220224982928`。
