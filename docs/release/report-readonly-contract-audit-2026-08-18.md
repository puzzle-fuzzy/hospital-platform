...
- 当前线上服务端 release 为 `5a31427`，配套小程序构建来源为
  `5c069290e8f26f1e4d22742a8c7a4b4ad18ca3d6`（当前本地候选 `5c06929`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`5c069290e8f26f1e4d22742a8c7a4b4ad18ca3d6`（当前本地候选 `5c06929`，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
