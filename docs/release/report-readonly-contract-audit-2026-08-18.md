...
- 当前线上服务端 release 为 `5a31427`，配套小程序构建来源为
  `ec3e5f094ecd0a85bbf98d4fc6ff9f14b27bb9ac`（当前本地候选 `ec3e5f09`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`ec3e5f094ecd0a85bbf98d4fc6ff9f14b27bb9ac`（当前本地候选 `ec3e5f09`，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
