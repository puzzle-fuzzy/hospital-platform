...
- 当前线上服务端 release 为 `b44421cd`，配套小程序构建来源为
  `805c54ea9fa943385ad6feebed1401d521fbad3c`（当前候选 `805c54e`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`805c54ea9fa943385ad6feebed1401d521fbad3c`（当前候选 `805c54e`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
