...
- 当前线上服务端 release 为 `b7c9451`，配套小程序构建来源为
  `a45d35edd91aab1a3a83c77301c9984402686145`；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`a45d35edd91aab1a3a83c77301c9984402686145`；本次只切换了新 API，报告 Provider gate 仍保持关闭。
