...
- 当前线上服务端 release 为 `5738a71e`，配套小程序构建来源为
  `935410473e5a7c1be125a85834f957f53a833d8f`（当前候选 `9354104`）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`935410473e5a7c1be125a85834f957f53a833d8f`（当前候选 `9354104`）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
...
配套小程序构建来源为 `935410473e5a7c1be125a85834f957f53a833d8f`。
