...
- 当前线上服务端 release 为 `b7c9451`，配套小程序构建来源为
  `31ce94a1df539f140d78ed1882ca15561634d8fd`（当前本地候选，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`31ce94a1df539f140d78ed1882ca15561634d8fd`（当前本地候选，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
...
| `pnpm --filter @hospital/miniprogram test` | 报告专属记录为 150 项通过、1195 个断言；当前整体候选为 154 项、1231 个断言 |
