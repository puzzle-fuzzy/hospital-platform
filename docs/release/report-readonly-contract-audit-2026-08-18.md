...
- 当前线上服务端 release 为 `5a31427`，配套小程序构建来源为
  `acf5a8596e70e1fb2b8d220a0b41eb69418ae086`（当前本地候选 `acf5a85`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`acf5a8596e70e1fb2b8d220a0b41eb69418ae086`（当前本地候选 `acf5a85`，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
