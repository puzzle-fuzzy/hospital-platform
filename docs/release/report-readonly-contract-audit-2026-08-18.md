...
- 当前线上服务端 release 为 `002acc1b`，配套小程序构建来源为
  `13b86a5a400ca0ccbee67abdfed726476a4749d4`（当前本地候选 `13b86a5`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
当前服务端 release 为 `9f491cb5`，配套小程序构建来源为
`13b86a5a400ca0ccbee67abdfed726476a4749d4`（当前本地候选 `13b86a5`，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
