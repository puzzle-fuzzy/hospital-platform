...
- 当前线上服务端 release 为 `5a31427`，配套小程序构建来源为
  `4e823137b7180390209614ef677c5a71f9c465be`（当前本地候选 `4e82313`，尚未上传线上）；本文件的 Provider 材料门禁不因 release 切换而放宽。
...
`4e823137b7180390209614ef677c5a71f9c465be`（当前本地候选 `4e82313`，尚未上传线上）；本次只切换了新 API，报告 Provider gate 仍保持关闭。
