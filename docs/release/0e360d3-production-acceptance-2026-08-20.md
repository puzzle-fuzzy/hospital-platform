...
后续真机验收应使用当前候选 `8f80b3e`（完整来源
`8f80b3e30385fe3655f871673d8616cd2d31faaa`），而不是本次切换时尚未包含患者同步会话证明修正的历史候选；候选记录见
[`candidate-8f80b3e-local-build-2026-08-20.md`](candidate-8f80b3e-local-build-2026-08-20.md)。在真实微信会话下继续取得患者目录、显式患者切换、
