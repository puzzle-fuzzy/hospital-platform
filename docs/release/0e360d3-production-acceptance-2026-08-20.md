...
后续真机验收应使用当前候选 `3a89312`（完整来源
`3a89312cd982ee2fc490b75515cdb6c7d58d513e`），而不是本次切换时尚未包含后续会话代际修正的历史候选；候选记录见
[`candidate-3a89312-local-build-2026-08-20.md`](candidate-3a89312-local-build-2026-08-20.md)。在真实微信会话下继续取得患者目录、显式患者切换、
