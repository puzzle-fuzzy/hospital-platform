...
后续真机验收应使用发布基线指定的当前候选 `39e2caa`（完整来源
`39e2caac27ec4bf569f5debc8edb47947bc398d2`），而不是本次切换时尚未包含后续小程序修正的历史候选；候选记录见
[`candidate-7f157d4-local-build-2026-08-20.md`](candidate-7f157d4-local-build-2026-08-20.md)。在真实微信会话下继续取得患者目录、显式患者切换、
