...
后续真机验收应使用当前候选 `ac238c6`（完整来源
`ac238c6156f085fdb56f5806fefac3613e5f85be`），而不是本次切换时尚未包含门诊金额精度修正的历史候选；候选记录见
[`candidate-ac238c6-local-build-2026-08-20.md`](candidate-ac238c6-local-build-2026-08-20.md)。在真实微信会话下继续取得患者目录、显式患者切换、
