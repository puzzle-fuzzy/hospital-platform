...
后续真机验收应使用当前候选 `767ed9c`（完整来源
`767ed9c225bf4d329761f6abed7668015a2626b2`），而不是本次切换时尚未包含后续会话代际修正的历史候选；候选记录见
[`candidate-767ed9c-local-build-2026-08-20.md`](candidate-767ed9c-local-build-2026-08-20.md)。在真实微信会话下继续取得患者目录、显式患者切换、
