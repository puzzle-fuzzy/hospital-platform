# 小程序当前候选真机三层证据记录模板（`b629380`）

> 当前服务端 release 为 `5a31427`；小程序完整运行包来源为 `b629380162aa8275418b643e10a16e96a65d0b36`。空白模板不代表真机或业务验收通过。
...
| 服务端 release | `5a31427` |
| 小程序提交 | `b629380` |
| 完整运行包来源 | `b629380162aa8275418b643e10a16e96a65d0b36` |
