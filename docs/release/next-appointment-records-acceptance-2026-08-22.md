...
> 当前执行候选为服务端 `1e58bb66` 与小程序来源 `41c708e1`（完整来源
> `41c708e1adf864ef6fef1f788e97aa8fb4371227`）。文中更早的服务端和小程序提交只作历史追溯。
> 本清单只验收预约历史/爽约只读链路，
...
当前小程序候选 `41c708e1adf864ef6fef1f788e97aa8fb4371227` 已完成预约历史/爽约只读逻辑复核；
当前服务端已验证 release 为 `1e58bb66bf24021d2b680eb5fd03abfec467989a`。本节下方的定向测试数字保留为代码审查时的历史证据，不能替代当前真机三层验收。
