...
> 当前服务端发布基线（2026-08-22 18:55 CST）：`0e2a366efcca8da25d7edd4a286781f2d3dfdbec`；小程序来源为 `a64fe023bc34fe6e44f93846c39e202fe02d64a5`。本清单仍要求真实 Provider/真机三层证据。

> 当前执行候选为服务端 `84370077` 与小程序来源 `a64fe023`（完整来源
> `a64fe023bc34fe6e44f93846c39e202fe02d64a5`）。文中更早的服务端和小程序提交只作历史追溯。
> 本清单只验收预约历史/爽约只读链路，
...
当前小程序候选 `a64fe023bc34fe6e44f93846c39e202fe02d64a5` 已完成预约历史/爽约只读逻辑复核；
当前服务端已验证 release 为 `84370077024762d92050cf077c27f3c60302e8f8`。本节下方的定向测试数字保留为代码审查时的历史证据，不能替代当前真机三层验收。
