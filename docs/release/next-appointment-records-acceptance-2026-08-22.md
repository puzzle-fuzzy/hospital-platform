...
> 当前执行候选为服务端 `84370077` 与小程序来源 `7f09bbb`（完整来源
> `7f09bbb2cf32d4753795bcbc91fe23ec05eeeee6`）。文中更早的服务端和小程序提交只作历史追溯。
> 本清单只验收预约历史/爽约只读链路，
...
当前小程序候选 `7f09bbb2cf32d4753795bcbc91fe23ec05eeeee6` 已完成预约历史/爽约只读逻辑复核；
