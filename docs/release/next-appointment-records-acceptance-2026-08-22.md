...
> 当前执行候选为服务端 `9f479c9a` 与小程序来源 `41c708e1`（完整来源
...
当前小程序候选 `dc8cd5b8bbf99411831cc5112bc39683108cd990` 已完成预约历史/爽约只读逻辑复核；
服务端上一次已验证 release 为 `2a2acd9bcc89c35988b75fc03304dbd48078c9d5`。
