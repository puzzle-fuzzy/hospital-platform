...
> 当前服务端发布基线（2026-08-22）：`0e2a366efcca8da25d7edd4a286781f2d3dfdbec`；小程序来源为 `ba1dd23e0f40191745a60997939b31b4c47795cd`。本清单仍要求真实 Provider/真机三层证据。

> 当前执行候选为服务端 `0e2a366e` 与小程序来源 `ba1dd23`（完整来源
> `ba1dd23e0f40191745a60997939b31b4c47795cd`）。文中更早的服务端和小程序提交只作历史追溯。
> 本清单只验收预约历史/爽约只读链路，
...
当前小程序候选 `ba1dd23e0f40191745a60997939b31b4c47795cd` 已完成预约历史/爽约只读逻辑复核；
