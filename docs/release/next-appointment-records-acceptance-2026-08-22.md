...
> 当前服务端发布基线（2026-08-22）：`0e2a366efcca8da25d7edd4a286781f2d3dfdbec`；小程序来源为 `171a8743185fb4ecc1696851662659c1a0ee7ebf`。本清单仍要求真实 Provider/真机三层证据。

> 当前执行候选为服务端 `0e2a366e` 与小程序来源 `171a874`（完整来源
> `171a8743185fb4ecc1696851662659c1a0ee7ebf`）。文中更早的服务端和小程序提交只作历史追溯。
> 本清单只验收预约历史/爽约只读链路，
