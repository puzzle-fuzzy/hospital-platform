...
> 当前基线更新：服务端 `5a31427`；小程序候选 `f19e471`；完整运行包来源 `f19e4717c01948d12fdcc62040a0bd4ab0ac060f`。本文件的运行观察早于该客户端构建，仅作运行层历史观察。
...
> 当前发布基线补充（2026-08-21）：本地小程序候选为 `f19e471`，完整运行包来源为 `f19e4717c01948d12fdcc62040a0bd4ab0ac060f`；本文件的 10:38 运行观察早于该次本地构建，不能作为该候选的真机证据。
