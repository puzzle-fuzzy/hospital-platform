...
> 当前基线更新：服务端 `5a31427`；小程序候选 `f9833c1`；完整运行包来源 `f9833c11ef0d49591fd14f99ce60ad92d800156a`。本文件的运行观察早于该客户端构建，仅作运行层历史观察。
...
> 当前发布基线补充（2026-08-21）：本地小程序候选为 `f9833c1`，完整运行包来源为 `f9833c11ef0d49591fd14f99ce60ad92d800156a`；本文件的 10:38 运行观察早于该次本地构建，不能作为该候选的真机证据。
