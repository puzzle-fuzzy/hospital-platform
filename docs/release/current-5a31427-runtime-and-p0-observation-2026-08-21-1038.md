...
> 当前基线更新：服务端 `5a31427`；小程序候选 `aafccf5`；完整运行包来源 `aafccf53d1e0eaac5ddaf98b1d850b084e4f78ed`。本文件的运行观察早于该客户端构建，仅作运行层历史观察。
...
> 当前发布基线补充（2026-08-21）：本地小程序候选为 `aafccf5`，完整运行包来源为 `aafccf53d1e0eaac5ddaf98b1d850b084e4f78ed`；本文件的 10:38 运行观察早于该次本地构建，不能作为该候选的真机证据。
