...
本次是源码和测试审计，不是线上业务验收。该次审计窗口使用的本地小程序候选为 `d32c5ce9653935e6f66bead9526bc8d0fa639b37`；当前页面代码候选已更新为 `ff931d7cbbc50e18649a38e14cd93f389d7487e3`，线上配套运行包仍为 `13f597ea9ee3f65b9be858117826d948339d904a`；本地候选没有发布到线上。
