...
| 新 API 当前 release | `/home/ps/code/hospital-platform/current -> releases/c26e696` |
...
- Markdown 链接审计：176 个文档无断链；
- 发布基线：服务端 `c26e696`，小程序来源 `a45d35edd91aab1a3a83c77301c9984402686145`；
- Biome 格式检查 238 个文件、Lint 239 个文件通过；
- 工具测试 17 项通过；9 个 workspace 类型检查通过；
...
1. 使用当前已构建的 `dist/` 在真实微信设备上完成 P0 只读链路：登录、患者选择、预约历史和门诊费用；
