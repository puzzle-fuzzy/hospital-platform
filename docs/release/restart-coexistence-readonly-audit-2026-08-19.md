...
- 发布基线：服务端 `b7c9451`，小程序提交 `b2ce91e`，完整小程序来源
  `b2ce91e1892a5cddec6953e3812d6f0ec08af8a6`；
...
- 小程序运行包来源校验通过：`revision=b2ce91e`，14 个页面和根文件齐全。
...
1. 使用当前已构建的 `dist/`（来源 `b2ce91e`）在真实微信设备上完成 P0 只读链路：登录、患者选择、预约历史和门诊费用；
