...
| 新 API 当前 release | `/home/ps/code/hospital-platform/current -> releases/65219e2` |
...
- 发布基线：服务端 `65219e2`，小程序提交 `b451cc6`，完整小程序来源
...
- 小程序运行包来源校验通过：`revision=b451cc6`，14 个页面和根文件齐全。
...
1. 使用当前已构建的 `dist/`（来源 `b451cc6`）在真实微信设备上完成 P0 只读链路：登录、患者选择、预约历史和门诊费用；
