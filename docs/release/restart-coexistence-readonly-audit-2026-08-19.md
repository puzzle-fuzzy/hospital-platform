...
- 发布基线：服务端 `b7c9451`，小程序提交 `3a66d12`，完整小程序来源
  `3a66d125b0c1ca53879dd88a3661e3025fb7dd3d`；
...
- 小程序运行包来源校验通过：`revision=3a66d12`，14 个页面和根文件齐全。
...
1. 使用当前已构建的 `dist/`（来源 `3a66d12`）在真实微信设备上完成 P0 只读链路：登录、患者选择、预约历史和门诊费用；
