...
> 本文记录的是 `6d58c9c` 发布前的只读审计窗口：当时线上仍为 `131fb5a`、schema marker/index 尚未应用。后续 migration、postcondition、候选切换和公网运行结果以当前 [`3ab0a6c-production-acceptance-2026-08-17.md`](3ab0a6c-production-acceptance-2026-08-17.md) 为准；本文中的“尚未应用”均属于发布前历史事实，不代表当前线上状态。
