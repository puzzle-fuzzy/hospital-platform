...
| 项目 | 结果 |
| --- | --- |
| 运行输入来源 | `bab96de9be2ae76e371f09ea7a734d0f078df2a9`（`bab96de9`） |
| 页面数量 | 40 |
| pending 运行文件 | 391 |
| 小程序回归 | `324 pass / 0 fail / 3611 expect()` |
| `runtime:verify:pending` | 通过，40 个页面和根文件完整 |
| 真机证据清单 | [`device-evidence-bab96de9-pending.json`](device-evidence-bab96de9-pending.json)，9 个域均为 `pending` |
