...
> 本文是当前服务端 `5a31427` 与小程序候选 `7a6f4df` 的门禁快照，完整来源为 `7a6f4df34fac5975c6012a30d2c137953a892059`。它用于区分“已有代码骨架”“已注册路由”“具备 Provider 契约”和“真实业务已验收”，不能把其中任一层单独当作迁移完成。旧 Python 服务、旧数据库、旧 Redis 和旧域名本轮均未修改。
