...
> `b0e093565493285e07fe549879f8b87eda649cc7`。本次只更新运行层基线，支付、医保、报告、绑定和 HIS 仍关闭。

> 当前候选：服务端 release `7181e99e3a352244102f5591279528b3b66332c9`（`7181e99e`）；小程序运行包来源 `4e1b2e224964797c103eba832323ee7074c7ad2b`（提交 `4e1b2e2`）。
...
| 项目 | 当前事实 |
| --- | --- |
| 服务端 release | `7181e99e3a352244102f5591279528b3b66332c9`（`7181e99e`） |
| 小程序本地候选 | `4e1b2e224964797c103eba832323ee7074c7ad2b`（`4e1b2e2`），尚未上传线上 |
