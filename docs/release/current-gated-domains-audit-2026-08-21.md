...
> 当前候选：服务端 release `7181e99e3a352244102f5591279528b3b66332c9`（`7181e99e`）；小程序运行包来源 `90fd7832e3ad1031c9c916f118f90cc0f2840aff`（提交 `90fd783`）。

> 当前基线更新：服务端 `7181e99e`；小程序候选 `90fd783`；完整运行包来源 `90fd7832e3ad1031c9c916f118f90cc0f2840aff`。下文更早候选只作历史追溯。

> 本文是前一轮服务端 `9f491cb5` 门禁快照的当前延续，当前服务端 release 已为 `84fac75c`，小程序候选已更新为 `90fd783`，完整来源为 `90fd7832e3ad1031c9c916f118f90cc0f2840aff`。它用于区分“已有代码骨架”“已注册路由”“具备 Provider 契约”和“真实业务已验收”，不能把其中任一层单独当作迁移完成。旧 Python 服务、旧数据库、旧 Redis 和旧域名本轮均未修改。

## 1. 当前基线与公网只读证据

| 项目 | 当前事实 |
| --- | --- |
| 服务端 release | `84fac75ceeb2247b252cf7e160eedbda220378f8`（`84fac75c`） |
| 小程序本地候选 | `90fd7832e3ad1031c9c916f118f90cc0f2840aff`（`90fd783`），尚未上传线上 |
...
| `pnpm release:baseline:audit` | 服务端 `84fac75c` 与小程序候选 `90fd783` 指针一致；当前运行层发布证据见 [`84fac75c-production-acceptance-2026-08-22.md`](84fac75c-production-acceptance-2026-08-22.md) |
