...
> 本文是当前服务端 `5a31427` 与小程序候选 `cde7bc9` 的门禁快照，完整来源为 `cde7bc90a23698398e9474944adf42b36f37982c`。它用于区分“已有代码骨架”“已注册路由”“具备 Provider 契约”和“真实业务已验收”，不能把其中任一层单独当作迁移完成。旧 Python 服务、旧数据库、旧 Redis 和旧域名本轮均未修改。
...
| 小程序本地候选 | `cde7bc90a23698398e9474944adf42b36f37982c`（`cde7bc9`），尚未上传线上 |
...
| `pnpm release:baseline:audit` | 已通过；服务端 `5a31427` 与小程序候选 `cde7bc9` 指针一致 |
