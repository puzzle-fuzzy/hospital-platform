...
> 本文是当前服务端 `5a31427` 与小程序候选 `5c06929` 的门禁快照，完整来源为 `5c069290e8f26f1e4d22742a8c7a4b4ad18ca3d6`。它用于区分“已有代码骨架”“已注册路由”“具备 Provider 契约”和“真实业务已验收”，不能把其中任一层单独当作迁移完成。旧 Python 服务、旧数据库、旧 Redis 和旧域名本轮均未修改。
...
| 小程序本地候选 | `5c069290e8f26f1e4d22742a8c7a4b4ad18ca3d6`（`5c06929`），尚未上传线上 |
