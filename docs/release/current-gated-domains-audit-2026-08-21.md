...
> 本文是当前服务端 `5a31427` 与小程序候选 `acf5a85` 的门禁快照。它用于区分“已有代码骨架”“已注册路由”“具备 Provider 契约”和“真实业务已验收”，不能把其中任一层单独当作迁移完成。旧 Python 服务、旧数据库、旧 Redis 和旧域名本轮均未修改。
...
| 小程序本地候选 | `acf5a8596e70e1fb2b8d220a0b41eb69418ae086`（`acf5a85`），尚未上传线上 |
...
| `pnpm release:baseline:audit` | 通过；服务端 `5a31427` 与小程序候选 `acf5a85` 指针一致 |
