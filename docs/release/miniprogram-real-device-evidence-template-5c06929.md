# 小程序当前候选真机三层证据记录模板（`5c06929`）

> 当前服务端 release 为 `5a31427`；小程序完整运行包来源为 `5c069290e8f26f1e4d22742a8c7a4b4ad18ca3d6`。空白模板不代表真机或业务验收通过。
...
| 服务端 release | `5a31427` |
| 小程序提交 | `5c06929` |
| 完整运行包来源 | `5c069290e8f26f1e4d22742a8c7a4b4ad18ca3d6` |
