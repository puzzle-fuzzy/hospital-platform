...
> 当前服务端发布基线（2026-08-22 18:55 CST）：`0e2a366efcca8da25d7edd4a286781f2d3dfdbec`；小程序来源为 `a64fe023bc34fe6e44f93846c39e202fe02d64a5`。本记录的代码结论已随当前 API 发布，但真实预约 Provider/真机证据仍待补。
...
`a64fe023bc34fe6e44f93846c39e202fe02d64a5`（提交 `a64fe023`）。
