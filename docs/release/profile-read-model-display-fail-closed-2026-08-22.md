...
> 当前服务端 release：`84370077024762d92050cf077c27f3c60302e8f8`；当前小程序候选：`7f09bbb`；完整运行包来源：
> `7f09bbb2cf32d4753795bcbc91fe23ec05eeeee6`。本记录只描述前端错误分流，不代表真实微信或生产资料读写验收已经完成。
