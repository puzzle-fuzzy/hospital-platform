...
> 当前服务端发布基线（2026-08-22 18:55 CST）：`0e2a366efcca8da25d7edd4a286781f2d3dfdbec`；小程序来源为 `a64fe023bc34fe6e44f93846c39e202fe02d64a5`。本记录仍保持资料错误 fail-closed。

> 当前服务端 release：`84370077024762d92050cf077c27f3c60302e8f8`；当前小程序候选：`a64fe023`；完整运行包来源：
> `a64fe023bc34fe6e44f93846c39e202fe02d64a5`。本记录只描述前端错误分流，不代表真实微信或生产资料读写验收已经完成。
