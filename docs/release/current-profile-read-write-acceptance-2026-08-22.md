> 当前服务端与小程序运行包均为 `13f597ea9ee3f65b9be858117826d948339d904a`（提交 `13f597e`）；真实资料读写真机证据仍待。

# 普通资料当前候选读写验收协议（2026-08-22）
> 当前执行基线（2026-08-24）：线上服务端与小程序来源均为 `13f597ea9ee3f65b9be858117826d948339d904a`。本协议仍要求真实微信/真机证据。

> 线上配套服务端 release 与当前小程序运行包来源均为：
