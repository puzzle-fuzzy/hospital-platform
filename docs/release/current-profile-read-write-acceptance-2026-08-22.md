...
> 当前服务端发布基线（2026-08-22）：`0e2a366efcca8da25d7edd4a286781f2d3dfdbec`；小程序来源为 `171a8743185fb4ecc1696851662659c1a0ee7ebf`。本协议仍要求真实微信/真机证据。

> 当前配套服务端 release：`0e2a366efcca8da25d7edd4a286781f2d3dfdbec`；当前小程序运行包来源：
> `171a8743185fb4ecc1696851662659c1a0ee7ebf`（提交 `171a874`）。本协议只适用于重新构建并通过
