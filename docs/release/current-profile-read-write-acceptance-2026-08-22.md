...
> 当前服务端发布基线（2026-08-22）：`0e2a366efcca8da25d7edd4a286781f2d3dfdbec`；小程序来源为 `ba1dd23e0f40191745a60997939b31b4c47795cd`。本协议仍要求真实微信/真机证据。

> 当前配套服务端 release：`0e2a366efcca8da25d7edd4a286781f2d3dfdbec`；当前小程序运行包来源：
> `ba1dd23e0f40191745a60997939b31b4c47795cd`（提交 `ba1dd23`）。本协议只适用于重新构建并通过
