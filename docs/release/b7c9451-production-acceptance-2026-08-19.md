...
当前配套小程序验收候选为 `b55df37`，运行包来源指纹为
`b55df37b48bbe250e4ebefee3db7739d2fd554e2`，尚未上传线上；本文件只记录服务端切换，不能把真机业务写成已验收。
...
| --- | --- |
| 服务端 release | `b7c9451` |
| 小程序客户端 | `69e6cdb`（当前本地候选，未随本次服务端切换上传） |
| 小程序构建来源 | `69e6cdb28f2996095b8647f82b1b90afd061b918` |
