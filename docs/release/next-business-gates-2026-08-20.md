...
> 当前服务端候选为 `0e360d3`，当前本地小程序候选为 `0dccf54`，完整运行包来源为
> `0dccf545ef65a905b58a27f38e787daea250fa54`。小程序尚未上传线上。
>
...
- 当前候选来源：[`candidate-0dccf54-local-build-2026-08-20.md`](candidate-0dccf54-local-build-2026-08-20.md)
