...
> 当前服务端候选为 `0e360d3`，当前本地小程序候选为 `ac238c6`，完整运行包来源为
> `ac238c6156f085fdb56f5806fefac3613e5f85be`。小程序尚未上传线上。
>
...
- 当前候选来源：[`candidate-ac238c6-local-build-2026-08-20.md`](candidate-ac238c6-local-build-2026-08-20.md)
