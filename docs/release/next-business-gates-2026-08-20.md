...
> 当前服务端候选为 `0e360d3`，当前本地小程序候选为 `457d9ae`，完整运行包来源为
> `457d9aee567bc77c33279a9b61db921e3011f1c1`。小程序尚未上传线上。
>
...
- 当前候选来源：[`candidate-457d9ae-local-build-2026-08-20.md`](candidate-457d9ae-local-build-2026-08-20.md)
