...
> 当前执行基线（2026-08-24）：线上服务端 release 为 `8eb51b5f`；小程序运行包来源为
> `13f597ea9ee3f65b9be858117826d948339d904a`（提交 `13f597e`）。历史候选仅作追溯。


> 当前线上候选：服务端 release `8eb51b5ffe85b0b8f8a032783f893117d3df549d`；小程序运行包来源为 `13f597ea9ee3f65b9be858117826d948339d904a`（`13f597e`）。预约历史修正已进入当前线上服务，真实真机三层证据仍待。

> 本文是新会话继续工作的短入口，不替代各业务域的详细 contract、代码测试或真实验收记录。
> 当前线上服务端为 `8eb51b5ffe85b0b8f8a032783f893117d3df549d`，当前小程序运行包来源为 `13f597ea9ee3f65b9be858117826d948339d904a`。服务端和小程序已分别通过发布/运行包门禁，等待从当前项目重新生成二维码并扫码。
>
...
当前验收基线为服务端 `90d8910bdc54d48dde66c4ff03a7434c182ebd92`、小程序候选 `90d8910b`（完整来源 `90d8910bdc54d48dde66c4ff03a7434c182ebd92`）；
