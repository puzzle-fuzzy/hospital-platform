...
> `935410473e5a7c1be125a85834f957f53a833d8f`（`9354104`），线上微信小程序仍为历史 `13f597e`。
...
> 当前线上服务端为 `5738a71e0bcddaa8849106754baf5b296427bed7`，当前本地小程序运行包来源为 `935410473e5a7c1be125a85834f957f53a833d8f`。服务端和小程序已分别通过发布/运行包门禁，等待从当前项目重新生成二维码并扫码。
>
...
当前验收基线为服务端 `5738a71e0bcddaa8849106754baf5b296427bed7`、小程序候选 `9354104`（完整来源 `935410473e5a7c1be125a85834f957f53a833d8f`）；
...
> 当前统一发布基线（2026-08-27）：服务端 release 为 `5738a71e0bcddaa8849106754baf5b296427bed7`；小程序本地 live 运行包来源为 `935410473e5a7c1be125a85834f957f53a833d8f`，共 38 个页面。本文更早版本仅作历史追溯，真机证据仍为 pending；旧 Python `8001` 未修改。
