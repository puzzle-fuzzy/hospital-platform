...
> `413cbea13f022831f63e9c750661eeabbffc68d5`（`413cbea`），线上微信小程序仍为历史 `13f597e`。
...
> 当前线上服务端为 `b44421cd321ff9ff23eeb49b12641d1772d2bdc1`，当前本地小程序运行包来源为 `413cbea13f022831f63e9c750661eeabbffc68d5`。服务端和小程序已分别通过发布/运行包门禁，等待从当前项目重新生成二维码并扫码。
>
...
当前验收基线为服务端 `b44421cd321ff9ff23eeb49b12641d1772d2bdc1`、小程序候选 `805c54e`（完整来源 `805c54ea9fa943385ad6feebed1401d521fbad3c`）；
...
> 当前统一发布基线（2026-08-27）：服务端 release 为 `b44421cd321ff9ff23eeb49b12641d1772d2bdc1`；小程序本地 live 运行包来源为 `413cbea13f022831f63e9c750661eeabbffc68d5`，共 40 个页面。本文更早版本仅作历史追溯，真机证据仍为 pending；旧 Python `8001` 未修改。
