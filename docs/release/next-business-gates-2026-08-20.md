...
> `62cdb8f82b4169dd1b9a6ed3403e3be2f7422328`（`62cdb8f`），线上微信小程序仍为历史 `13f597e`。
...
> 当前线上服务端为 `1bc8b0a85f21cb58205a99ce4de0de6afe9bf240`，当前本地小程序运行包来源为 `62cdb8f82b4169dd1b9a6ed3403e3be2f7422328`。服务端和小程序已分别通过发布/运行包门禁，等待从当前项目重新生成二维码并扫码。
>
...
当前验收基线为服务端 `1bc8b0a85f21cb58205a99ce4de0de6afe9bf240`、小程序候选 `62cdb8f`（完整来源 `62cdb8f82b4169dd1b9a6ed3403e3be2f7422328`）；
...
> 当前统一发布基线（2026-08-27）：服务端 release 为 `1bc8b0a85f21cb58205a99ce4de0de6afe9bf240`；小程序本地 live 运行包来源为 `62cdb8f82b4169dd1b9a6ed3403e3be2f7422328`，共 40 个页面。本文更早版本仅作历史追溯，真机证据仍为 pending；旧 Python `8001` 未修改。
