...
> 当前服务端候选为 `5a31427`，当前本地小程序候选为 `8d33a27`，完整运行包来源为
> `8d33a27e5aa4c5808449116bd3c3740d7a823e80`。小程序尚未上传线上。
>
...
本次代码复核基于服务端 `5a31427`、小程序候选 `8d33a27`（完整来源 `8d33a27e5aa4c5808449116bd3c3740d7a823e80`）；本节只检查代码、领域 contract、adapter、页面状态机和本地测试，
