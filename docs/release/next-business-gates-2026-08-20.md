...
> 当前服务端候选为 `1e58bb66`，当前小程序候选为 `7f09bbb`，完整运行包来源为
...
当前验收基线为服务端 `1e58bb66bf24021d2b680eb5fd03abfec467989a`、小程序候选 `7f09bbb`（完整来源 `7f09bbb2cf32d4753795bcbc91fe23ec05eeeee6`）；
