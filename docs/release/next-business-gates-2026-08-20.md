...
> `ce1c2179b57fe2783066b51f8621220224982928`（`ce1c217`），线上微信小程序仍为历史 `13f597e`。
...
> 当前线上服务端为 `5738a71e0bcddaa8849106754baf5b296427bed7`，当前本地小程序运行包来源为 `ce1c2179b57fe2783066b51f8621220224982928`。服务端和小程序已分别通过发布/运行包门禁，等待从当前项目重新生成二维码并扫码。
>
...
当前验收基线为服务端 `5738a71e0bcddaa8849106754baf5b296427bed7`、小程序候选 `ce1c217`（完整来源 `ce1c2179b57fe2783066b51f8621220224982928`）；
...
> 当前统一发布基线（2026-08-27）：服务端 release 为 `5738a71e0bcddaa8849106754baf5b296427bed7`；小程序本地 live 运行包来源为 `ce1c2179b57fe2783066b51f8621220224982928`，共 38 个页面。本文更早版本仅作历史追溯，真机证据仍为 pending；旧 Python `8001` 未修改。


> 当前发布基线补充（2026-08-27）：服务端线上 release 为 5738a71e0bcddaa8849106754baf5b296427bed7；本地 live 小程序构建来源为 ce1c2179b57fe2783066b51f8621220224982928。本行只同步当前运行层指纹，文档中的历史发布记录仍保留用于追溯。
