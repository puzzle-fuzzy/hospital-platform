...
> `99d9f60f6291b7f8d08d779cec059892f054d80e`（`99d9f60`），线上微信小程序仍为历史 `13f597e`。
...
> 当前线上服务端为 `1bc8b0a85f21cb58205a99ce4de0de6afe9bf240`，当前本地小程序运行包来源为 `99d9f60f6291b7f8d08d779cec059892f054d80e`。服务端和小程序已分别通过发布/运行包门禁，等待从当前项目重新生成二维码并扫码。
>
...
当前验收基线为服务端 `1bc8b0a85f21cb58205a99ce4de0de6afe9bf240`、小程序候选 `99d9f60`（完整来源 `99d9f60f6291b7f8d08d779cec059892f054d80e`）；
...
> 当前服务端发布基线（2026-08-27）：`1bc8b0a85f21cb58205a99ce4de0de6afe9bf240`；本执行板禁止使用历史 release 作为当前验收依据。
> 当前小程序配套运行包来源（2026-08-27）：`99d9f60f6291b7f8d08d779cec059892f054d80e`（`99d9f60`）；本文中更早候选和真机窗口仅作历史追溯，当前无真机/开发者工具会话。
> 当前统一发布基线（2026-08-27）：服务端 release 为 `1bc8b0a85f21cb58205a99ce4de0de6afe9bf240`；小程序本地 live 运行包来源为 `99d9f60f6291b7f8d08d779cec059892f054d80e`，共 40 个页面。本文更早版本仅作历史追溯，真机证据仍为 pending；旧 Python `8001` 未修改。
