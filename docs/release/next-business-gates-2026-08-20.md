...
> 当前服务端候选为 `0e360d3`，当前本地小程序候选为 `767ed9c`，完整运行包来源为
> `767ed9c225bf4d329761f6abed7668015a2626b2`。小程序尚未上传线上。
>
...
- 当前候选来源：[`candidate-767ed9c-local-build-2026-08-20.md`](candidate-767ed9c-local-build-2026-08-20.md)
