> 当前执行基线（2026-08-24）：线上服务端 release 为 `13f597ea9ee3f65b9be858117826d948339d904a`；同源小程序运行包来源为
> `13f597ea9ee3f65b9be858117826d948339d904a`（提交 `13f597e`）。候选已切换，真实真机证据仍待。

# 下一阶段业务门禁执行板（2026-08-20）
> 当前执行基线（2026-08-24）：线上服务端 release 为 `13f597ea`；同源小程序运行包来源为
> `13f597ea9ee3f65b9be858117826d948339d904a`（提交 `13f597e`）。历史候选仅作追溯。


> 当前线上候选：服务端 release `13f597ea9ee3f65b9be858117826d948339d904a`；小程序运行包来源为同一提交（`13f597e`）。预约历史修正已进入当前线上服务，真实真机三层证据仍待。

> 本文是新会话继续工作的短入口，不替代各业务域的详细 contract、代码测试或真实验收记录。
> 当前线上服务端为 `13f597ea9ee3f65b9be858117826d948339d904a`，当前小程序运行包来源为同一提交。服务端和小程序已通过构建/运行包门禁并完成同源配套，等待从当前项目重新生成二维码并扫码。
>
...
当前验收基线为服务端 `13f597ea9ee3f65b9be858117826d948339d904a`、小程序候选 `13f597e`（完整来源 `13f597ea9ee3f65b9be858117826d948339d904a`）；
