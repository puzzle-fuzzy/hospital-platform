...
> 当前候选：服务端 release `1e58bb66bf24021d2b680eb5fd03abfec467989a`；小程序运行包来源 `41c708e1adf864ef6fef1f788e97aa8fb4371227`（提交 `41c708e1`）。

> 本文是新会话继续工作的短入口，不替代各业务域的详细 contract、代码测试或真实验收记录。
> 当前服务端候选为 `1e58bb66`，当前小程序候选为 `41c708e1`，完整运行包来源为
> `41c708e1adf864ef6fef1f788e97aa8fb4371227`。服务端已切换；小程序已从正确项目普通编译并生成二维码，当前等待扫码。
>
...
该窗口发生在 `9f479c9a` 切换前，下面的旧候选只作为历史观察；当前下一步必须使用顶部声明的 `41c708e1` 候选重新扫码，取得同一会话的页面、客户端请求和服务端日志三层证据。
...
当前验收基线为服务端 `1e58bb66bf24021d2b680eb5fd03abfec467989a`、小程序候选 `41c708e1`（完整来源 `41c708e1adf864ef6fef1f788e97aa8fb4371227`）；
...
- 当前候选证据记录模板：[`miniprogram-real-device-evidence-template-41c708e.md`](miniprogram-real-device-evidence-template-41c708e.md)
- 只读业务不变量：[`readonly-business-chain-audit-2026-08-21.md`](readonly-business-chain-audit-2026-08-21.md)
- 当前候选来源：[`candidate-41c708e-local-build-2026-08-22.md`](candidate-41c708e-local-build-2026-08-22.md)
