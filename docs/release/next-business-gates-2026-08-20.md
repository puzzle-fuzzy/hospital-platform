...
> `1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`（`1bc5bf6`），线上微信小程序仍为历史 `13f597e`。
...
> 当前线上服务端为 `5738a71e0bcddaa8849106754baf5b296427bed7`，当前本地小程序运行包来源为 `1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`。服务端和小程序已分别通过发布/运行包门禁，等待从当前项目重新生成二维码并扫码。
>
...
当前验收基线为服务端 `5738a71e0bcddaa8849106754baf5b296427bed7`、小程序候选 `1bc5bf6`（完整来源 `1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`）；
...
> 当前服务端发布基线（2026-08-27）：`5738a71e0bcddaa8849106754baf5b296427bed7`；本执行板禁止使用历史 release 作为当前验收依据。
> 当前小程序配套运行包来源（2026-08-28）：`1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`（`1bc5bf6`）；本文中更早候选和真机窗口仅作历史追溯，当前无真机/开发者工具会话。
> 当前统一发布基线（2026-08-27）：服务端 release 为 `5738a71e0bcddaa8849106754baf5b296427bed7`；小程序本地 live 运行包来源为 `1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916`，共 38 个页面。本文更早版本仅作历史追溯，真机证据仍为 pending；旧 Python `8001` 未修改。


> 当前发布基线补充（2026-08-27）：服务端线上 release 为 5738a71e0bcddaa8849106754baf5b296427bed7；本地 live 小程序构建来源为 1bc5bf6f7cc4d38fad29fbf7e8aca3f65c46b916。本行只同步当前运行层指纹，文档中的历史发布记录仍保留用于追溯。
