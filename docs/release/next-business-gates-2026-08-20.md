...
> 当前服务端候选为 `002acc1be5cdd1b16c2c249f5dbbf9f7c65dbd10`，当前本地小程序候选为 `f307424`，完整运行包来源为
> `f3074243e136621d64f296a687c0fb2ca8230991`。小程序尚未上传线上。
>
...
该窗口发生在 `9f491cb5` 切换前，下面的旧候选只作为历史观察；当前下一步必须使用顶部声明的 `f307424` 候选重新扫码，取得同一会话的页面、客户端请求和服务端日志三层证据。
...
本次代码复核基于服务端 `9f491cb5ac813acf89ed1f2f4afb361517e82324`、小程序候选 `f307424`（完整来源 `f3074243e136621d64f296a687c0fb2ca8230991`）；本节只检查代码、领域 contract、adapter、页面状态机和本地测试，
