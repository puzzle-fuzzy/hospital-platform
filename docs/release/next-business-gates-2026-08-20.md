...
> 当前服务端候选为 `1e58bb66`，当前小程序候选为 `5e43aed`，完整运行包来源为
> `5e43aed0e026cd48d980d58c468223b9a5ee8744`。服务端已切换；小程序已从正确项目普通编译并生成二维码，当前等待扫码。
>
...
该窗口发生在 `9f479c9a` 切换前，下面的旧候选只作为历史观察；当前下一步必须使用顶部声明的 `5e43aed` 候选重新扫码，取得同一会话的页面、客户端请求和服务端日志三层证据。
...
当前验收基线为服务端 `1e58bb66bf24021d2b680eb5fd03abfec467989a`、小程序候选 `5e43aed`（完整来源 `5e43aed0e026cd48d980d58c468223b9a5ee8744`）；
...
- 当前候选证据记录模板：[`miniprogram-real-device-evidence-template-5e43aed.md`](miniprogram-real-device-evidence-template-5e43aed.md)
- 只读业务不变量：[`readonly-business-chain-audit-2026-08-21.md`](readonly-business-chain-audit-2026-08-21.md)
- 当前候选来源：[`candidate-5e43aed-local-build-2026-08-22.md`](candidate-5e43aed-local-build-2026-08-22.md)
