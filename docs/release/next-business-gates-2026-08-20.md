...
> 当前服务端候选为 `9f479c9a`，当前小程序候选为 `937bb2ad`，完整运行包来源为
> `937bb2ad2c71a2e83fac679939d31ed6bb3f0996`。服务端已切换；小程序仍需从正确项目普通编译并生成二维码。
>
...
该窗口发生在 `9f479c9a` 切换前，下面的旧候选只作为历史观察；当前下一步必须使用顶部声明的 `937bb2ad` 候选重新扫码，取得同一会话的页面、客户端请求和服务端日志三层证据。
...
- 当前候选证据记录模板：[`miniprogram-real-device-evidence-template-937bb2a.md`](miniprogram-real-device-evidence-template-937bb2a.md)
- 只读业务不变量：[`readonly-business-chain-audit-2026-08-21.md`](readonly-business-chain-audit-2026-08-21.md)
- 当前候选来源：[`candidate-1b621f0-local-build-2026-08-22.md`](candidate-1b621f0-local-build-2026-08-22.md)
