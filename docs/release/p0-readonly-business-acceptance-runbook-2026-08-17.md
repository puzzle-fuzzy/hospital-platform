...
> `29029175a5064aa4480359255e74d73dc010b3cd`。它覆盖微信登录、普通资料、患者上下文、预约历史、爽约记录和门诊费用只读查询；不包含预约下单、微信支付、医保结算、退款或 HIS 写入。
>
...
1. 当前服务端基线为 `c26e696`，当前本地真机候选为
   `29029175a5064aa4480359255e74d73dc010b3cd`；截至本记录，公网 live/ready 和未登录 401 已复核，
