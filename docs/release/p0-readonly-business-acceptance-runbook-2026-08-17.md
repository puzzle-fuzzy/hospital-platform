...
> `767ed9c225bf4d329761f6abed7668015a2626b2`（当前本地候选 `767ed9c`，尚未上传线上）。它覆盖微信登录、普通资料、患者上下文、预约目录/历史、报告目录/LIS 详情、爽约记录和门诊费用只读查询；不包含预约下单、微信支付、医保结算、退款或 HIS 写入，也不开放二维码协议。
>
...
1. 当前服务端基线为 `0e360d3`，当前本地真机候选来源为
   `767ed9c225bf4d329761f6abed7668015a2626b2`（提交 `767ed9c`）；截至本记录，公网 live/ready 和未登录 401 已复核，
