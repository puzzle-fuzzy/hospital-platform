...
> `6252ea41a40a22a6264276b6590750e4bf0ef5bc`（当前本地候选 `6252ea4`，尚未上传线上）。它覆盖微信登录、普通资料、患者上下文、预约目录/历史、报告目录/LIS 详情、爽约记录和门诊费用只读查询；不包含预约下单、微信支付、医保结算、退款或 HIS 写入，也不开放二维码协议。
>
...
1. 当前服务端基线为 `0e360d3`，当前本地真机候选来源为
   `6252ea41a40a22a6264276b6590750e4bf0ef5bc`（提交 `6252ea4`）；截至本记录，公网 live/ready 和未登录 401 已复核，
