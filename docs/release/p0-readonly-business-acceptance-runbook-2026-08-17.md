...
1. 当前 release 切换后截至 2026-08-17 15:21 CST，仍没有新的真实微信登录、患者同步、预约历史或门诊费用事件，
   因此本手册的结果尚待真机操作填充；切换前历史日志不得归入 `daee96d`。切换后复核详见
   [`daee96d-production-acceptance-2026-08-17.md`](daee96d-production-acceptance-2026-08-17.md) 第 8 节。
