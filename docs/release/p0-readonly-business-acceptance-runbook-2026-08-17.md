...
> `65657a0bb289fb25f17f14c0b8fec22270f964b2`（当前本地候选 `65657a0`，尚未上传线上）。它覆盖微信登录、普通资料、患者上下文、预约历史、爽约记录和门诊费用只读查询；不包含预约下单、微信支付、医保结算、退款或 HIS 写入。
>
...
1. 当前服务端基线为 `b7c9451`，当前本地真机候选为
   `65657a0bb289fb25f17f14c0b8fec22270f964b2`；截至本记录，公网 live/ready 和未登录 401 已复核，
