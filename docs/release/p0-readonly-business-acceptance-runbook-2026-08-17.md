> 当前服务端配套发布更新（2026-08-26）：线上服务端 release 为 `8eb51b5ffe85b0b8f8a032783f893117d3df549d`；当前线上小程序运行包来源为 `13f597ea9ee3f65b9be858117826d948339d904a`（提交 `13f597e`）。本地 `d204425` 仍是未发布 pending 候选，下方历史候选仅供追溯，本行优先。
