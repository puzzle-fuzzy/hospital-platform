...
> 本手册用于当前 `9833a01` 生产版本的真实微信小程序验收。它只覆盖微信登录、患者上下文、预约历史、爽约记录和门诊费用只读查询；不包含预约下单、微信支付、医保结算、退款或 HIS 写入。
>
...
1. 当前 release 切换后截至 2026-08-17 15:21 CST，仍没有新的真实微信登录、患者同步、预约历史或门诊费用事件，
   因此本手册的结果尚待真机操作填充；切换前历史日志不得归入 `9833a01`。切换后复核详见
   [`9833a01-production-acceptance-2026-08-17.md`](9833a01-production-acceptance-2026-08-17.md) 第 7 节。
