...
> 本手册用于当前 `c26e696` 服务端与配套小程序候选的真实微信小程序验收。小程序运行包来源指纹必须为
> `a45d35edd91aab1a3a83c77301c9984402686145`。它覆盖微信登录、普通资料、患者上下文、预约历史、爽约记录和门诊费用只读查询；不包含预约下单、微信支付、医保结算、退款或 HIS 写入。
>
...
1. 当前服务端基线为 `c26e696`，当前本地真机候选为
   `a45d35edd91aab1a3a83c77301c9984402686145`；截至本记录，公网 live/ready 和未登录 401 已复核，
