> 当前发布基线：线上服务端 release 为 `28a5c0c131794ce9dcc5f94bd3809402188ac87a`；当前小程序运行包来源为 `13f597ea9ee3f65b9be858117826d948339d904a`（提交 `13f597e`）。本记录只描述小程序运行包，不代表真机业务已验收。

# 小程序候选 `13f597e` 当前运行包记录（2026-08-24）

> 本文是当前真机验收唯一使用的小程序运行包记录；它与线上服务端 `28a5c0c1` 形成有意分层配套，不要求服务端和小程序来自同一份 Git 提交。
