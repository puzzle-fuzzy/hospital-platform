...
`7181e99e3a352244102f5591279528b3b66332c9`，只重启 `hospital-platform-api-v2.service`。
切换后内网/公网 live、ready、system-ping 和未登录认证边界通过；新 API `18081` 与旧 Python
...
`84fac75ceeb2247b252cf7e160eedbda220378f8`，只重启 `hospital-platform-api-v2.service`。
